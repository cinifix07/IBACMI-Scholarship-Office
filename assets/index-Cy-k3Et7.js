...
`,mr={quickActions:{table:`quickActions`,source:`all-grantee-information-header`,defaultStatus:`new`,fields:{email:{label:`Email account`,type:`email`,required:!0,placeholder:`name@example.com`},question:{label:`Question`,type:`textarea`,required:!0,placeholder:`Type your question or request here...`}}}};function hr(e){let t=(0,An.c)(4),{status:n,tone:r}=e,i=`status-badge status-badge--${r}`,a;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(a=(0,H.jsx)(`span`,{className:`status-badge__dot`}),t[0]=a):a=t[0];let o;return t[1]!==n||t[2]!==i?(o=(0,H.jsxs)(`span`,{className:i,children:[a,n]}),t[1]=n,t[2]=i,t[3]=o):o=t[3],o}function gr(e=``){let t=e.toLowerCase();return t.includes(`grantee`)||t.includes(`valid`)||t.includes(`complete`)||t.includes(`resolved`)||t.includes(`approved`)?`validated`:t.includes(`reject`)||t.includes(`decline`)?`rejected`:`pending`}function _r(e,t){let n=[];if(t<=5){for(let e=1;e<=t;e+=1)n.push(e);return n}n.push(1),e>3&&n.push(`left-ellipsis`);let r=Math.max(2,e-1),i=Math.min(t-1,e+1);for(let e=r;e<=i;e+=1)n.push(e);return e<t-2&&n.push(`right-ellipsis`),n.push(t),n}function vr(e){return/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/i.test(e)}function yr(e){return/^[A-Za-z0-9-]{4,30}$/.test(e)}function br(e){return e.replace(/[\s-]/g,``).trim()}function xr(e){return e.replace(/[^\d+]/g,``).replace(/(?!^)\+/g,``)}function Sr(e){return e.replace(/[\r\n]+/g,` `).replace(/\s{2,}/g,` `)}function Cr(e){let t=br(e);return/^09\d{9}$/.test(t)||/^\+639\d{9}$/.test(t)}var wr=5*1024*1024;function Tr(e){return e?e.type===`application/pdf`||/\.pdf$/i.test(e.name):!1}function Er(e){if(!e)return``;let t=e/(1024*1024);return`${t.toFixed(t>=10?0:1)} MB`}function Dr(e){return e.length>=6}function Or(e,t,n){let r,i=new Promise((e,i)=>{r=setTimeout(()=>i(Error(n)),t)});return Promise.race([e,i]).finally(()=>clearTimeout(r))}var kr=[{label:`Student ID`,name:`studentId`,autoComplete:`off`,required:!0},{label:`Last Name`,name:`lastName`,autoComplete:`family-name`,required:!0},{label:`First Name`,name:`firstName`,autoComplete:`given-name`,required:!0},{label:`Ext Name (JR)`,name:`extensionName`,autoComplete:`honorific-suffix`},{label:`Middle Name`,name:`middleName`,autoComplete:`additional-name`}],Ar=[{label:`Last Name`,name:`fatherLastName`,autoComplete:`family-name`},{label:`First Name`,name:`fatherFirstName`,autoComplete:`given-name`},{label:`Middle Name`,name:`fatherMiddleName`,autoComplete:`additional-name`}],jr=[{label:`Last Name`,name:`motherLastName`,autoComplete:`family-name`},{label:`First Name`,name:`motherFirstName`,autoComplete:`given-name`},{label:`Middle Name`,name:`motherMiddleName`,autoComplete:`additional-name`}],Mr=[`BACHELOR OF SCIENCE IN INFORMATION TECHNOLOGY`,`BACHELOR OF SCIENCE IN ENTREPRENEURSHIP`,`BACHELOR OF SCIENCE IN CRIMINOLOGY`,`BACHELOR OF ELEMENTARY EDUCATION`,`BACHELOR OF EARLY CHILDHOOD EDUCATION`,`BACHELOR OF SCIENCE IN HOSPITALITY MANAGEMENT`,`BACHELOR OF PUBLIC ADMINISTRATION`],Nr=[{label:`Address`,name:`address`,autoComplete:`street-address`,className:`portal-full-field`,required:!0},{label:`Zip Code`,name:`zipCode`,autoComplete:`postal-code`,inputMode:`numeric`},{label:`PWD ID`,name:`pwdId`,autoComplete:`off`},{label:`Mobile No.`,name:`mobileNumber`,autoComplete:`tel`,inputMode:`tel`,type:`tel`,pattern:`\\+?[0-9]*`,required:!0},{label:`Email Address`,name:`emailAddress`,autoComplete:`email`,inputMode:`email`,type:`email`,required:!0}];function Pr({onAdminLoginSuccess:e,onStudentRegistrationSuccess:t}){let n=(0,B.useRef)(null),[r,i]=(0,B.useState)(0),[a,o]=(0,B.useState)(!1),[s,c]=(0,B.useState)(!1),[l,u]=(0,B.useState)(!1),[d,f]=(0,B.useState)(!1),[p,m]=(0,B.useState)(!1),[h,g]=(0,B.useState)(!1),[_,v]=(0,B.useState)(``),[y,b]=(0,B.useState)(``),[x,S]=(0,B.useState)(``),[C,w]=(0,B.useState)(``),[ee,T]=(0,B.useState)(``),[E,te]=(0,B.useState)(``),[D,ne]=(0,B.useState)({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),[O,re]=(0,B.useState)(null),[ie,k]=(0,B.useState)(!1),[A,ae]=(0,B.useState)(!1),[j,M]=(0,B.useState)(!1),[N,P]=(0,B.useState)(!1),[F,oe]=(0,B.useState)(1),[se,ce]=(0,B.useState)(``),[le,ue]=(0,B.useState)(``),[de,fe]=(0,B.useState)(``),[pe,me]=(0,B.useState)(``),[he,ge]=(0,B.useState)(``),[_e,ve]=(0,B.useState)(``),[ye,be]=(0,B.useState)(``),[xe,Se]=(0,B.useState)(``),[Ce,we]=(0,B.useState)(``),[Te,I]=(0,B.useState)(``),[Ee,De]=(0,B.useState)(``),[Oe,ke]=(0,B.useState)(null),[Ae,je]=(0,B.useState)(``),[Me,Ne]=(0,B.useState)(``),[Pe,Fe]=(0,B.useState)(``),[Ie,Le]=(0,B.useState)(``),[Re,ze]=(0,B.useState)(``),[Be,Ve]=(0,B.useState)(``),[He,L]=(0,B.useState)(``),[Ue,We]=(0,B.useState)(``),[Ge,Ke]=(0,B.useState)(!1),[qe,Je]=(0,B.useState)(!1),[Ye,Xe]=(0,B.useState)(!1),Ze=fn(V.applicants.create),Qe=fn(V.applicants.generateUploadUrl),$e=fn(V.quickActions.create),et=fn(V.adminAuth.login),tt=fn(V.adminAuth.register),nt=fn(V.adminAuth.requestPasswordResetOtp),rt=fn(V.adminAuth.changePasswordWithOtp),it=dn(V.allinfo.list),R=dn(V.applicantPortal.get),at=(0,B.useMemo)(()=>it??[],[it]),ot=se.trim().length>0,st=R===void 0,ct=R?.isReceivingApplicants===!0,lt=(0,B.useMemo)(()=>{let e=se.trim().toLowerCase();return e?at.filter(t=>{let n=String(t.studentId??``).trim().toLowerCase(),r=String(t.batchId??``).trim().toLowerCase(),i=String(t.lastName??``).trim().toLowerCase(),a=String(t.firstName??``).trim().toLowerCase(),o=String(t.middleName??t.middleInitial??``).trim().toLowerCase(),s=[i,a,o].filter(Boolean).join(` `);return n===e||r===e||i.includes(e)||a.includes(e)||o.includes(e)||s.includes(e)}):[]},[at,se]),ut=lt.length,dt=Math.max(1,Math.ceil(ut/6)),ft=(F-1)*6,pt=Math.min(ft+6,ut),mt=(0,B.useMemo)(()=>lt.slice(ft,pt),[lt,ft,pt]),ht=(0,B.useMemo)(()=>_r(F,dt),[F,dt]),gt=e=>{let t=e.trim().toLowerCase();return at.some(e=>String(e.studentId??``).trim().toLowerCase()===t)},_t=(0,B.useCallback)(()=>{De(``),ke(null),ge(``),ve(``),Se(``),we(``),typeof t==`function`&&t(Oe)},[t,Oe]);(0,B.useEffect)(()=>{let e=()=>{let e=document.documentElement.scrollTop||document.body.scrollTop,t=document.documentElement.scrollHeight-document.documentElement.clientHeight;i(t>0?e/t:0)};return e(),window.addEventListener(`scroll`,e,{passive:!0}),()=>window.removeEventListener(`scroll`,e)},[]),(0,B.useEffect)(()=>{if(!a&&!s&&!l&&!d&&!p&&!h&&!E&&!Ee&&!x)return;let e=e=>{e.key===`Escape`&&(o(!1),c(!1),w(``),T(``),re(null),ne({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),u(!1),k(!1),f(!1),m(!1),g(!1),te(``),Ee&&_t(),S(``))};return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),()=>{document.body.style.overflow=``,window.removeEventListener(`keydown`,e)}},[a,s,l,d,p,h,E,Ee,x,_t]);let vt=()=>{S(``),b(``),o(!0)},z=()=>{o(!1),b(``)},yt=()=>{if(R===void 0){te(`Please wait while the UNIFAST portal status is loading.`);return}if(!R.isReceivingApplicants){te(`The UNIFAST portal is not receiving applicants right now. Please wait for the administrator to open applications.`);return}w(``),T(``),c(!0)},bt=()=>{j||(c(!1),w(``),T(``),ne({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),re(null))},xt=async e=>{let t=await Qe(),n=await fetch(t,{body:e,headers:{"Content-Type":e.type||`application/pdf`},method:`POST`});if(!n.ok)throw Error(`Unable to upload ${e.name}.`);let{storageId:r}=await n.json();return r},St=e=>{let{files:t,name:n}=e.target,r=t?.[0]??null;if(w(``),T(``),re(null),!r){ne(e=>({...e,[n]:null}));return}if(!Tr(r)){e.target.value=``,ne(e=>({...e,[n]:null})),w(`Please upload PDF files only for all document requirements.`);return}if(r.size>wr){e.target.value=``,ne(e=>({...e,[n]:null})),w(`Each uploaded PDF must be 5MB or smaller.`);return}ne(e=>({...e,[n]:r}))},Ct=async e=>{e.preventDefault();let t=e.currentTarget,n=new FormData(t),r=br(String(n.get(`mobileNumber`)||``)),i=String(n.get(`emailAddress`)||``).trim().toLowerCase(),a=n.get(`psaFile`),o=n.get(`schoolIdFile`),s=n.get(`pwdIdFile`),c=n.get(`fourPsFile`);if(w(``),T(``),!R?.isReceivingApplicants){w(`The UNIFAST portal is closed for applicants right now.`);return}if(!Cr(r)){w(`Please enter a valid mobile number. Example: 09123456789 or +639123456789.`);return}if(!vr(i)){w(`Please enter a valid email address.`);return}if(!(a instanceof File)||!a.name||!Tr(a)){w(`Please upload your PSA as a PDF file.`);return}if(!(o instanceof File)||!o.name||!Tr(o)){w(`Please upload your colored School ID photocopy as a PDF file.`);return}if(a.size>wr||o.size>wr){w(`Each uploaded PDF must be 5MB or smaller.`);return}let l=[s,c].filter(e=>e instanceof File&&e.name);if(l.some(e=>!Tr(e))){w(`Optional PWD ID and 4Ps ID documents must be PDF files.`);return}if(l.some(e=>e.size>wr)){w(`Each uploaded PDF must be 5MB or smaller.`);return}re({studentId:String(n.get(`studentId`)||``).trim(),lastName:String(n.get(`lastName`)||``).trim(),firstName:String(n.get(`firstName`)||``).trim(),extensionName:String(n.get(`extensionName`)||``).trim(),middleName:String(n.get(`middleName`)||``).trim(),gender:String(n.get(`gender`)||``),birthDate:String(n.get(`birthDate`)||``),course:String(n.get(`course`)||``),year:String(n.get(`year`)||``),fatherLastName:String(n.get(`fatherLastName`)||``).trim(),fatherFirstName:String(n.get(`fatherFirstName`)||``).trim(),fatherMiddleName:String(n.get(`fatherMiddleName`)||``).trim(),motherLastName:String(n.get(`motherLastName`)||``).trim(),motherFirstName:String(n.get(`motherFirstName`)||``).trim(),motherMiddleName:String(n.get(`motherMiddleName`)||``).trim(),address:String(n.get(`address`)||``).trim(),zipCode:String(n.get(`zipCode`)||``).trim(),pwdId:String(n.get(`pwdId`)||``).trim(),mobileNumber:r,emailAddress:i,psaFile:a,schoolIdFile:o,pwdIdFile:l.includes(s)?s:null,fourPsFile:l.includes(c)?c:null})},wt=()=>{w(``),T(``),re(null)},Tt=async()=>{if(O){if(w(``),T(``),!R?.isReceivingApplicants){w(`The UNIFAST portal is closed for applicants right now.`);return}M(!0);try{let[e,t,r,i]=await Promise.all([xt(O.psaFile),xt(O.schoolIdFile),O.pwdIdFile?xt(O.pwdIdFile):Promise.resolve(void 0),O.fourPsFile?xt(O.fourPsFile):Promise.resolve(void 0)]),a={studentId:O.studentId,lastName:O.lastName,firstName:O.firstName,extensionName:O.extensionName,middleName:O.middleName,gender:O.gender,birthDate:O.birthDate,course:O.course,year:O.year,fatherLastName:O.fatherLastName,fatherFirstName:O.fatherFirstName,fatherMiddleName:O.fatherMiddleName,motherLastName:O.motherLastName,motherFirstName:O.motherFirstName,motherMiddleName:O.motherMiddleName,address:O.address,zipCode:O.zipCode,pwdId:O.pwdId,mobileNumber:O.mobileNumber,emailAddress:O.emailAddress,psaFileStorageId:e,psaFileName:O.psaFile.name,schoolIdFileStorageId:t,schoolIdFileName:O.schoolIdFile.name};r&&O.pwdIdFile&&(a.pwdIdFileStorageId=r,a.pwdIdFileName=O.pwdIdFile.name),i&&O.fourPsFile&&(a.fourPsFileStorageId=i,a.fourPsFileName=O.fourPsFile.name);let o=await Ze(a);if(!o.success){w(o.message||`Unable to submit applicant information.`);return}n.current?.reset(),ne({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),re(null),T(o.message||`Applicant information submitted successfully.`),window.setTimeout(()=>{T(``),c(!1)},900)}catch(e){w(e instanceof Error?e.message:`Unable to submit applicant information right now.`)}finally{M(!1)}}},Et=()=>{v(``),ue(``),fe(``),me(``),u(!0)},Dt=()=>{u(!1),k(!1),v(``),ue(``),fe(``),me(``)},Ot=()=>{u(!1),m(!0),I(``),De(``),ge(le),ve(de),Se(``),we(``)},kt=()=>{m(!1),I(``),De(``),ge(``),ve(``),be(``),Se(``),we(``)},At=()=>{m(!1),I(``),De(``),ke(null),ue(he),fe(_e),me(``),u(!0)},jt=()=>{g(!1),m(!0)},Mt=()=>{u(!1),f(!0),L(``),We(``),Ke(!1),je(le),Ne(de),Fe(``),Le(``),ze(``),Ve(``)},Nt=()=>{f(!1),L(``),We(``),Ke(!1),je(``),Ne(``),Fe(``),Le(``),ze(``),Ve(``)},Pt=()=>{oe(e=>Math.max(e-1,1))},Ft=()=>{oe(e=>Math.min(e+1,dt))},It=()=>{ce(``),oe(1)},Lt=e=>{ce(e.target.value),oe(1)},Rt=e=>{e.target.value=xr(e.target.value)},zt=()=>{Ke(!1),We(``),Le(``),ze(``),Ve(``)},Bt=e=>{let t=e.target.value;je(t),t.trim()&&Ne(``),zt()},Vt=e=>{let t=e.target.value;Ne(t),t.trim()&&je(``),zt()},Ht=e=>{Fe(xr(e.target.value)),zt()},Ut=()=>{let e=Ae.trim().toLowerCase(),t=Me.trim(),n=br(Pe);return!e&&!t?`Email address or School ID is required.`:e&&t?`Use either email address or School ID, not both.`:e&&!vr(e)?`Please enter a valid email address.`:t&&!yr(t)?`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`:n?Cr(n)?``:`Please enter a valid phone number. Example: 09123456789 or +639123456789.`:`Phone number is required.`};return(0,H.jsxs)(`div`,{className:`landing-page`,children:[(0,H.jsx)(`style`,{children:Fr}),(0,H.jsxs)(`header`,{className:`landing-header`,children:[(0,H.jsxs)(`div`,{className:`brand-lockup`,children:[(0,H.jsx)(`div`,{className:`brand-mark`,children:(0,H.jsx)(`img`,{alt:`IBACMI`,className:`brand-mark__image`,src:jn})}),(0,H.jsx)(`div`,{className:`brand-copy`,children:(0,H.jsx)(`p`,{className:`brand-title`,children:`IBACMI - Scholarship Office`})})]}),(0,H.jsxs)(`div`,{className:`header-actions`,children:[(0,H.jsx)(`button`,{className:`button button--compact`,onClick:vt,type:`button`,children:`SUPPORT`}),(0,H.jsx)(`button`,{className:`button button--compact button--admin`,onClick:Et,type:`button`,children:`SIGN IN`})]})]}),(0,H.jsx)(`main`,{className:`landing-main`,children:(0,H.jsxs)(`div`,{className:`landing-container`,children:[(0,H.jsx)(`section`,{className:`page-heading`,children:(0,H.jsxs)(`div`,{className:`page-heading__copy`,children:[(0,H.jsx)(`span`,{className:`eyebrow`,children:`Grantee Records`}),(0,H.jsxs)(`h2`,{className:`landing-office-title`,children:[(0,H.jsx)(`span`,{className:`landing-office-title__school`,children:`IBACMI`}),(0,H.jsx)(`span`,{className:`landing-office-title__separator`,"aria-hidden":`true`,children:`—`}),(0,H.jsx)(`span`,{className:`landing-office-title__office`,children:`Scholarship Office`})]})]})}),(0,H.jsxs)(`section`,{className:`filter-panel`,"aria-label":`Grantee filters`,children:[(0,H.jsxs)(`div`,{className:`search-field`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`search`}),(0,H.jsx)(`input`,{placeholder:`Enter School ID, Either Batch No., or Last Name...`,type:`text`,value:se,onChange:Lt})]}),(0,H.jsxs)(`button`,{className:`icon-button filter-button`,type:`button`,"aria-label":`Clear search`,title:`Clear search`,onClick:It,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`restart_alt`}),(0,H.jsx)(`span`,{className:`filter-button__text`,children:`Reset`})]})]}),!ot&&(0,H.jsxs)(`section`,{className:`scholarship-showcase`,"aria-labelledby":`scholarship-showcase-title`,children:[(0,H.jsxs)(`div`,{className:`scholarship-showcase__heading`,children:[(0,H.jsx)(`div`,{children:(0,H.jsx)(`span`,{className:`eyebrow`,children:`Scholarship Office`})}),(0,H.jsxs)(`span`,{className:`scholarship-showcase__status`,children:[(0,H.jsx)(`span`,{"aria-hidden":`true`}),`Official Information`]})]}),(0,H.jsxs)(`a`,{className:`scholarship-showcase__image-link`,href:`/IBACMI-Scholarship-Office/assets/desktop-Di8cTPxJ.png`,rel:`noreferrer`,target:`_blank`,title:`Open the Scholarship Office banner in full size`,children:[(0,H.jsx)(`img`,{alt:`IBACMI Scholarship Office banner featuring the scholarship coordinator and students assistant`,decoding:`async`,src:`/IBACMI-Scholarship-Office/assets/desktop-Di8cTPxJ.png`}),(0,H.jsxs)(`span`,{className:`scholarship-showcase__view`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,"aria-hidden":`true`,children:`open_in_full`}),`View full banner`]})]})]}),ot&&(0,H.jsxs)(`section`,{className:`table-card`,"aria-label":`Filtered grantee records`,children:[(0,H.jsx)(`div`,{className:`table-scroll`,children:(0,H.jsxs)(`table`,{children:[(0,H.jsx)(`thead`,{children:(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`th`,{children:`No.`}),(0,H.jsx)(`th`,{children:`TES Award Number`}),(0,H.jsx)(`th`,{children:`Student ID`}),(0,H.jsx)(`th`,{children:`Last Name`}),(0,H.jsx)(`th`,{children:`First Name`}),(0,H.jsx)(`th`,{children:`Middle Name`}),(0,H.jsx)(`th`,{children:`Batch No.`}),(0,H.jsx)(`th`,{children:`Status`}),(0,H.jsx)(`th`,{children:`Semester`}),(0,H.jsx)(`th`,{children:`School Year`})]})}),(0,H.jsxs)(`tbody`,{children:[it===void 0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`empty-state`,colSpan:10,children:`Searching grantee record...`})}),it&&lt.length===0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`empty-state`,colSpan:10,children:`No matching School ID, Batch No./ID, or name found.`})}),mt.map((e,t)=>(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`td`,{"data-label":`No.`,children:e.no||ft+t+1}),(0,H.jsx)(`td`,{className:`award-cell`,"data-label":`TES Award Number`,children:e.tesAwardNumber}),(0,H.jsx)(`td`,{"data-label":`Student ID`,children:e.studentId}),(0,H.jsx)(`td`,{"data-label":`Last Name`,children:e.lastName||`â€”`}),(0,H.jsx)(`td`,{"data-label":`First Name`,children:e.firstName||`â€”`}),(0,H.jsx)(`td`,{"data-label":`Middle Name`,children:e.middleName||e.middleInitial||`â€”`}),(0,H.jsx)(`td`,{className:`batch-cell`,"data-label":`Batch ID`,children:e.batchId}),(0,H.jsx)(`td`,{"data-label":`Status`,children:(0,H.jsx)(hr,{status:e.status,tone:gr(e.status)})}),(0,H.jsx)(`td`,{"data-label":`Semester`,children:e.semester||`—`}),(0,H.jsx)(`td`,{"data-label":`School Year`,children:e.schoolYear||`—`})]},e._id))]})]})}),(0,H.jsxs)(`div`,{className:`table-footer`,children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:ut===0?0:ft+1}),` to`,` `,(0,H.jsx)(`strong`,{children:pt}),` of `,(0,H.jsx)(`strong`,{children:ut}),` result`,ut===1?``:`s`]}),(0,H.jsxs)(`div`,{className:`pagination`,children:[(0,H.jsx)(`button`,{className:`page-button`,disabled:F===1||ut===0,onClick:Pt,type:`button`,"aria-label":`Previous page`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),ht.map(e=>typeof e==`string`?(0,H.jsx)(`span`,{className:`pagination__ellipsis`,children:`...`},e):(0,H.jsx)(`button`,{className:`page-button ${F===e?`page-button--active`:``}`,disabled:ut===0,onClick:()=>oe(e),type:`button`,children:e},e)),(0,H.jsx)(`button`,{className:`page-button`,disabled:F===dt||ut===0,onClick:Ft,type:`button`,"aria-label":`Next page`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]})]}),(0,H.jsxs)(`section`,{className:`portal-cta`,"aria-labelledby":`portal-cta-title`,children:[(0,H.jsx)(`div`,{className:`portal-cta__icon`,"aria-hidden":`true`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`assignment`})}),(0,H.jsxs)(`div`,{className:`portal-cta__copy`,children:[(0,H.jsx)(`span`,{className:`eyebrow`,children:`Unified Student Financial Assistance System for Tertiary Education`}),(0,H.jsx)(`h3`,{id:`portal-cta-title`,children:`UNIFAST APPLICATION`}),(0,H.jsx)(`p`,{children:`Complete the student, parent, address, and contact information form for UNIFAST applicant processing.`})]}),(0,H.jsxs)(`button`,{"aria-label":st?`Checking UNIFAST portal status`:ct?`UNIFAST portal is open. Open application form`:`UNIFAST portal is closed`,className:`button button--portal ${st?`button--portal-loading`:ct?`button--portal-open`:`button--portal-closed`}`,disabled:st,onClick:yt,type:`button`,children:[(0,H.jsx)(`span`,{className:`portal-status-dot`,"aria-hidden":`true`}),st?`CHECKING PORTAL`:ct?`PORTAL OPEN`:`PORTAL IS CLOSED`]})]})]})}),(0,H.jsx)(`footer`,{className:`landing-footer`,children:(0,H.jsx)(`p`,{children:`Copyright 2026 | All Rights Reserved IBACMI - Scholarship Office | Developed By CINIFIX`})}),s&&(0,H.jsxs)(`div`,{"aria-labelledby":`unifast-portal-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close UNIFAST portal modal`,className:`modal-backdrop-button`,onClick:bt,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card portal-modal-card`,ref:n,onSubmit:Ct,children:[(0,H.jsx)(`div`,{className:`modal-header portal-modal-header`,children:(0,H.jsxs)(`div`,{className:`modal-title-row`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`modal-kicker`,children:`UNIFAST Portal`}),(0,H.jsx)(`h3`,{id:`unifast-portal-title`,children:`Student Information Form`}),(0,H.jsxs)(`p`,{children:[`Complete the student, parent, and contact information fields below`,R?.applicationYear?` for ${R.applicationYear}.`:`.`]})]}),(0,H.jsx)(`button`,{"aria-label":`Close UNIFAST portal`,className:`icon-button modal-close`,onClick:bt,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]})}),(0,H.jsxs)(`div`,{className:`modal-body portal-form${O?` portal-form--hidden`:``}`,children:[(0,H.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-student-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-student-heading`,children:`Student Information`}),(0,H.jsxs)(`div`,{className:`portal-grid`,children:[kr.map(e=>(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:e.label}),(0,H.jsx)(`input`,{autoComplete:e.autoComplete,name:e.name,placeholder:`Enter ${e.label.toLowerCase()}`,required:e.required,type:`text`})]},e.name)),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Gender`}),(0,H.jsxs)(`select`,{name:`gender`,defaultValue:``,required:!0,children:[(0,H.jsx)(`option`,{value:``,disabled:!0,children:`Select gender`}),(0,H.jsx)(`option`,{value:`Female`,children:`Female`}),(0,H.jsx)(`option`,{value:`Male`,children:`Male`}),(0,H.jsx)(`option`,{value:`Prefer not to say`,children:`Prefer not to say`})]})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Birth Date`}),(0,H.jsx)(`input`,{name:`birthDate`,required:!0,type:`date`})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Year`}),(0,H.jsxs)(`select`,{name:`year`,defaultValue:``,required:!0,children:[(0,H.jsx)(`option`,{value:``,disabled:!0,children:`Select year`}),(0,H.jsx)(`option`,{value:`1st Year`,children:`1st Year`}),(0,H.jsx)(`option`,{value:`2nd Year`,children:`2nd Year`}),(0,H.jsx)(`option`,{value:`3rd Year`,children:`3rd Year`}),(0,H.jsx)(`option`,{value:`4th Year`,children:`4th Year`}),(0,H.jsx)(`option`,{value:`5th Year`,children:`5th Year`})]})]}),(0,H.jsxs)(`fieldset`,{className:`portal-course-list`,children:[(0,H.jsx)(`legend`,{children:`Course`}),Mr.map(e=>(0,H.jsxs)(`label`,{className:`portal-course-option`,children:[(0,H.jsx)(`input`,{name:`course`,required:!0,type:`radio`,value:e}),(0,H.jsx)(`span`,{children:e})]},e))]})]})]}),(0,H.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-parents-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-parents-heading`,children:`Parents Information`}),(0,H.jsxs)(`div`,{className:`portal-parent-group`,children:[(0,H.jsx)(`p`,{children:`Father Information`}),(0,H.jsx)(`div`,{className:`portal-grid portal-grid--three`,children:Ar.map(e=>(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:e.label}),(0,H.jsx)(`input`,{autoComplete:e.autoComplete,name:e.name,placeholder:`Enter father's ${e.label.toLowerCase()}`,type:`text`})]},e.name))})]}),(0,H.jsxs)(`div`,{className:`portal-parent-group`,children:[(0,H.jsx)(`p`,{children:`Mother Information`}),(0,H.jsx)(`div`,{className:`portal-grid portal-grid--three`,children:jr.map(e=>(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:e.label}),(0,H.jsx)(`input`,{autoComplete:e.autoComplete,name:e.name,placeholder:`Enter mother's ${e.label.toLowerCase()}`,type:`text`})]},e.name))})]})]}),(0,H.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-contact-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-contact-heading`,children:`Address and Contact Information`}),(0,H.jsx)(`div`,{className:`portal-grid`,children:Nr.map(e=>(0,H.jsxs)(`label`,{className:`form-field ${e.className??``}`.trim(),children:[(0,H.jsx)(`span`,{children:e.label}),(0,H.jsx)(`input`,{autoComplete:e.autoComplete,inputMode:e.inputMode,name:e.name,onInput:e.name===`mobileNumber`?Rt:void 0,pattern:e.pattern,placeholder:`Enter ${e.label.toLowerCase()}`,required:e.required,type:e.type??`text`})]},e.name))})]}),(0,H.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-documents-heading`,children:[(0,H.jsxs)(`div`,{className:`portal-section-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-documents-heading`,children:`Document Requirements`}),(0,H.jsx)(`p`,{children:`Upload clear PDF copies up to 5MB each. Required and optional documents are labeled below.`})]}),(0,H.jsxs)(`div`,{className:`portal-document-grid`,children:[(0,H.jsxs)(`label`,{className:`portal-document-upload${D.psaFile?` portal-document-upload--selected`:``}`,children:[(0,H.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`psaFile`,onChange:St,required:!0,type:`file`}),(0,H.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`picture_as_pdf`})}),(0,H.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,H.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,H.jsx)(`strong`,{children:`PSA Birth Certificate`}),(0,H.jsx)(`span`,{className:`portal-document-badge portal-document-badge--required`,children:`Required`})]}),(0,H.jsx)(`span`,{children:D.psaFile?`${D.psaFile.name} (${Er(D.psaFile.size)})`:`Select PSA PDF file`})]})]}),(0,H.jsxs)(`label`,{className:`portal-document-upload${D.schoolIdFile?` portal-document-upload--selected`:``}`,children:[(0,H.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`schoolIdFile`,onChange:St,required:!0,type:`file`}),(0,H.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`badge`})}),(0,H.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,H.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,H.jsx)(`strong`,{children:`Colored School ID Photocopy`}),(0,H.jsx)(`span`,{className:`portal-document-badge portal-document-badge--required`,children:`Required`})]}),(0,H.jsx)(`span`,{children:D.schoolIdFile?`${D.schoolIdFile.name} (${Er(D.schoolIdFile.size)})`:`Select colored School ID photocopy PDF`})]})]}),(0,H.jsxs)(`label`,{className:`portal-document-upload portal-document-upload--optional${D.pwdIdFile?` portal-document-upload--selected`:``}`,children:[(0,H.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`pwdIdFile`,onChange:St,type:`file`}),(0,H.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`accessible`})}),(0,H.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,H.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,H.jsx)(`strong`,{children:`PWD ID`}),(0,H.jsx)(`span`,{className:`portal-document-badge`,children:`Optional`})]}),(0,H.jsx)(`span`,{children:D.pwdIdFile?`${D.pwdIdFile.name} (${Er(D.pwdIdFile.size)})`:`Attach a clear PWD ID PDF, if applicable`})]})]}),(0,H.jsxs)(`label`,{className:`portal-document-upload portal-document-upload--optional${D.fourPsFile?` portal-document-upload--selected`:``}`,children:[(0,H.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`fourPsFile`,onChange:St,type:`file`}),(0,H.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`family_restroom`})}),(0,H.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,H.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,H.jsx)(`strong`,{children:`4Ps ID`}),(0,H.jsx)(`span`,{className:`portal-document-badge`,children:`Optional`})]}),(0,H.jsx)(`span`,{children:D.fourPsFile?`${D.fourPsFile.name} (${Er(D.fourPsFile.size)})`:`Attach a clear 4Ps ID PDF, if applicable`})]})]})]})]})]}),O&&(0,H.jsx)(`div`,{className:`modal-body portal-review`,children:(0,H.jsxs)(`section`,{className:`portal-review-card`,"aria-labelledby":`portal-review-heading`,children:[(0,H.jsxs)(`div`,{className:`portal-section-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-review-heading`,children:`Review Information`}),(0,H.jsx)(`p`,{children:`Please check every detail before final submission.`})]}),(0,H.jsxs)(`div`,{className:`portal-review-grid`,children:[(0,H.jsxs)(`div`,{className:`portal-review-group`,children:[(0,H.jsx)(`h5`,{children:`Student Information`}),(0,H.jsxs)(`dl`,{children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Student ID`}),(0,H.jsx)(`dd`,{children:O.studentId})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Full Name`}),(0,H.jsx)(`dd`,{children:[O.firstName,O.middleName,O.lastName,O.extensionName].filter(Boolean).join(` `)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Gender`}),(0,H.jsx)(`dd`,{children:O.gender})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Birth Date`}),(0,H.jsx)(`dd`,{children:O.birthDate})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Year`}),(0,H.jsx)(`dd`,{children:O.year})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Course`}),(0,H.jsx)(`dd`,{children:O.course})]})]})]}),(0,H.jsxs)(`div`,{className:`portal-review-group`,children:[(0,H.jsx)(`h5`,{children:`Parents Information`}),(0,H.jsxs)(`dl`,{children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Father`}),(0,H.jsx)(`dd`,{children:[O.fatherFirstName,O.fatherMiddleName,O.fatherLastName].filter(Boolean).join(` `)||`Not provided`})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Mother`}),(0,H.jsx)(`dd`,{children:[O.motherFirstName,O.motherMiddleName,O.motherLastName].filter(Boolean).join(` `)||`Not provided`})]})]})]}),(0,H.jsxs)(`div`,{className:`portal-review-group`,children:[(0,H.jsx)(`h5`,{children:`Address and Contact`}),(0,H.jsxs)(`dl`,{children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Address`}),(0,H.jsx)(`dd`,{children:O.address})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Zip Code`}),(0,H.jsx)(`dd`,{children:O.zipCode||`Not provided`})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`PWD ID`}),(0,H.jsx)(`dd`,{children:O.pwdId||`Not provided`})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Mobile No.`}),(0,H.jsx)(`dd`,{children:O.mobileNumber})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Email Address`}),(0,H.jsx)(`dd`,{children:O.emailAddress})]})]})]}),(0,H.jsxs)(`div`,{className:`portal-review-group`,children:[(0,H.jsx)(`h5`,{children:`Documents`}),(0,H.jsxs)(`dl`,{children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`PSA Birth Certificate`}),(0,H.jsxs)(`dd`,{children:[O.psaFile.name,` (`,Er(O.psaFile.size),`)`]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`School ID Photocopy`}),(0,H.jsxs)(`dd`,{children:[O.schoolIdFile.name,` (`,Er(O.schoolIdFile.size),`)`]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`PWD ID (Optional)`}),(0,H.jsx)(`dd`,{children:O.pwdIdFile?`${O.pwdIdFile.name} (${Er(O.pwdIdFile.size)})`:`Not provided`})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`4Ps ID (Optional)`}),(0,H.jsx)(`dd`,{children:O.fourPsFile?`${O.fourPsFile.name} (${Er(O.fourPsFile.size)})`:`Not provided`})]})]})]})]})]})}),(C||ee)&&(0,H.jsxs)(`div`,{className:`portal-message-row`,children:[C&&(0,H.jsx)(`p`,{className:`form-error`,children:C}),ee&&(0,H.jsx)(`p`,{className:`form-success`,children:ee})]}),(0,H.jsx)(`div`,{className:`modal-actions portal-actions`,children:O?(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:j,onClick:wt,type:`button`,children:`Edit Information`}),(0,H.jsx)(`button`,{className:`button`,disabled:j,onClick:Tt,type:`button`,children:j?`Submitting...`:`Submit Information`})]}):(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:j,onClick:bt,type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`button`,disabled:j,type:`submit`,children:`Review Information`})]})})]})]}),E&&(0,H.jsxs)(`div`,{"aria-labelledby":`portal-status-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close portal status modal`,className:`modal-backdrop-button`,onClick:()=>te(``),type:`button`}),(0,H.jsxs)(`section`,{className:`modal-card portal-status-card`,children:[(0,H.jsx)(`div`,{className:`modal-header portal-modal-header`,children:(0,H.jsxs)(`div`,{className:`modal-title-row`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{id:`portal-status-title`,children:`Portal Status`}),(0,H.jsx)(`p`,{children:E})]}),(0,H.jsx)(`button`,{"aria-label":`Close portal status`,className:`icon-button modal-close`,onClick:()=>te(``),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]})}),(0,H.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,H.jsx)(`button`,{className:`button`,onClick:()=>te(``),type:`button`,children:`OK`})})]})]}),a&&(0,H.jsxs)(`div`,{"aria-labelledby":`quick-actions-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close quick actions modal`,className:`modal-backdrop-button`,onClick:z,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card modal-card--wide auth-modal-card`,onSubmit:async e=>{e.preventDefault();let t=e.currentTarget,n=new FormData(t),r=String(n.get(`email`)||``).trim().toLowerCase(),i=String(n.get(`studentId`)||``).trim(),a=String(n.get(`lastName`)||``).trim(),s=String(n.get(`firstName`)||``).trim(),c=String(n.get(`middleInitial`)||``).trim(),l=Sr(String(n.get(`question`)||``)).trim();b(``),S(``),ae(!0);try{if(!vr(r))throw Error(`Please enter a valid email account.`);if(!yr(i))throw Error(`Please enter a valid Student ID.`);if(!a||!s)throw Error(`Last name and first name are required.`);if(c&&!/^[A-Za-z. -]{1,10}$/.test(c))throw Error(`Please enter a valid middle initial.`);if(!l)throw Error(`Please enter your question or request.`);if(l.length>500)throw Error(`Your question must be 500 characters or fewer.`);await $e({email:r,studentId:i,lastName:a,firstName:s,middleInitial:c,question:l,source:mr.quickActions.source,status:mr.quickActions.defaultStatus}),t.reset(),o(!1),S(`Your request has been submitted.`)}catch(e){b(e instanceof Error?e.message:`Unable to submit your request right now.`)}finally{ae(!1)}},children:[(0,H.jsxs)(`div`,{className:`modal-header`,children:[(0,H.jsxs)(`div`,{className:`modal-title-row`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`modal-kicker`,children:`Quick Actions`}),(0,H.jsx)(`h3`,{id:`quick-actions-title`,children:`Submit a Request`})]}),(0,H.jsx)(`button`,{"aria-label":`Close modal`,className:`icon-button modal-close`,onClick:z,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsx)(`p`,{children:`Send a question or request to the scholarship office for review.`})]}),(0,H.jsxs)(`div`,{className:`modal-body quick-action-form-grid`,children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Student ID`}),(0,H.jsx)(`input`,{autoComplete:`off`,name:`studentId`,placeholder:`Enter Student ID`,required:!0})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Email account`}),(0,H.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`email`,placeholder:mr.quickActions.fields.email.placeholder,required:!0,type:`email`})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Last name`}),(0,H.jsx)(`input`,{autoComplete:`family-name`,name:`lastName`,placeholder:`Enter last name`,required:!0})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`First name`}),(0,H.jsx)(`input`,{autoComplete:`given-name`,name:`firstName`,placeholder:`Enter first name`,required:!0})]}),(0,H.jsxs)(`label`,{className:`form-field quick-action-mi-field`,children:[(0,H.jsx)(`span`,{children:`MI`}),(0,H.jsx)(`input`,{autoComplete:`additional-name`,maxLength:10,name:`middleInitial`,placeholder:`M`})]}),(0,H.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,H.jsx)(`span`,{children:`Question`}),(0,H.jsx)(`textarea`,{"aria-describedby":`quick-action-question-help`,maxLength:500,name:`question`,onInput:e=>{e.currentTarget.value=Sr(e.currentTarget.value)},placeholder:mr.quickActions.fields.question.placeholder,required:!0,rows:4}),(0,H.jsx)(`small`,{className:`form-field__help`,id:`quick-action-question-help`,children:`One paragraph only, up to 500 characters.`})]}),y&&(0,H.jsx)(`p`,{className:`form-error auth-full-field`,children:y})]}),(0,H.jsxs)(`div`,{className:`modal-actions`,children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:A,onClick:z,type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`button`,disabled:A,type:`submit`,children:A?`Submitting...`:`Submit`})]})]})]}),l&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-login-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close admin login modal`,className:`modal-backdrop-button`,onClick:Dt,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card modal-card--admin auth-modal-card`,onSubmit:async t=>{t.preventDefault();let n=le.trim().toLowerCase(),r=de.trim(),i=pe,a=n.length>0,o=r.length>0;if(v(``),!a&&!o){v(`Enter either your valid email address or your School ID.`);return}if(a&&!vr(n)){v(`Please enter a valid email address.`);return}if(o&&!yr(r)){v(`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`);return}if(!i){v(`Password is required.`);return}if(!Dr(i)){v(`Password must be at least 6 characters.`);return}let s={password:i,...a?{email:n}:{},...o?{schoolId:r}:{}};k(!0);try{let t=await Or(et(s),15e3,`Login is taking too long. Please check your internet connection is running, then try again.`);if(!t.success){v(t.message||`Invalid admin credentials.`);return}u(!1),typeof e==`function`&&e(t.admin)}catch(e){v(e instanceof Error?e.message:`Unable to login right now.`)}finally{k(!1)}},children:[(0,H.jsxs)(`div`,{className:`admin-login-hero auth-modal-hero`,children:[(0,H.jsx)(`div`,{className:`admin-login-brand`,children:(0,H.jsx)(`img`,{alt:`IBACMI`,src:`/IBACMI-Scholarship-Office/assets/IBACMI-DvrUkuyb.png`})}),(0,H.jsx)(`button`,{"aria-label":`Close admin login`,className:`icon-button modal-close admin-login-close`,onClick:Dt,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})}),(0,H.jsx)(`p`,{className:`modal-kicker`,children:`UNIFAST Portal`}),(0,H.jsx)(`h3`,{id:`admin-login-title`,children:`Sign in `})]}),(0,H.jsxs)(`div`,{className:`modal-body admin-login-body auth-form-grid`,children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Valid Email address`}),(0,H.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`adminEmail`,placeholder:`Enter email address`,type:`email`,disabled:de.trim().length>0,value:le,onChange:e=>ue(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`School ID`}),(0,H.jsx)(`input`,{autoComplete:`off`,name:`adminSchoolId`,placeholder:`Enter School ID`,type:`text`,minLength:4,maxLength:30,pattern:`[A-Za-z0-9-]{4,30}`,title:`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`,disabled:le.trim().length>0,value:de,onChange:e=>fe(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,H.jsx)(`span`,{children:`Password`}),(0,H.jsx)(`input`,{autoComplete:`current-password`,name:`adminPassword`,placeholder:`Enter password`,required:!0,type:`password`,minLength:6,value:pe,onChange:e=>me(e.target.value)})]}),(0,H.jsxs)(`div`,{className:`auth-note-box auth-full-field`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`info`}),(0,H.jsx)(`p`,{children:`You may sign in using either your registered email address or your School ID. Password is still required.`})]}),(0,H.jsxs)(`div`,{className:`auth-link-row auth-full-field`,children:[(0,H.jsx)(`button`,{className:`auth-text-button`,disabled:ie,onClick:Mt,type:`button`,children:`Forgot Password?`}),(0,H.jsx)(`button`,{className:`auth-text-button auth-text-button--strong`,disabled:ie,onClick:Ot,type:`button`,children:`Create Account`})]}),_&&(0,H.jsx)(`p`,{className:`form-error auth-full-field`,children:_})]}),(0,H.jsxs)(`div`,{className:`modal-actions admin-login-actions auth-actions`,children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:ie,onClick:Dt,type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`button`,disabled:ie,type:`submit`,children:ie?`Logging in...`:`Login`})]})]})]}),p&&(0,H.jsxs)(`div`,{"aria-labelledby":`sign-up-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close sign up modal`,className:`modal-backdrop-button`,onClick:kt,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card modal-card--admin auth-modal-card auth-modal-card--large`,onSubmit:async e=>{e.preventDefault();let t=he.trim().toLowerCase(),n=_e.trim(),r=br(ye),i=xe,a=Ce;if(I(``),De(``),!t){I(`Email account is required.`);return}if(!vr(t)){I(`Please enter a valid email account.`);return}if(!n){I(`School ID is required.`);return}if(!yr(n)){I(`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`);return}if(it===void 0){I(`Please wait while we verify the School ID.`);return}if(!gt(n)){m(!1),g(!0);return}if(!r){I(`Phone number is required.`);return}if(!Cr(r)){I(`Please enter a valid phone number. Example: 09123456789 or +639123456789.`);return}if(!i){I(`Password is required.`);return}if(!Dr(i)){I(`Password must be at least 6 characters.`);return}if(!a){I(`Confirm password is required.`);return}if(i!==a){I(`Password and confirm password do not match.`);return}P(!0);try{let e=await tt({email:t,schoolId:n,phoneNumber:r,password:i});if(!e.success){if(e.reason===`schoolIdNotFound`){m(!1),g(!0);return}I(e.message||`Unable to register account.`);return}m(!1),ke(e.admin??{email:t,schoolId:n,role:`student`}),De(`Your account has been registered successfully.`),ue(t),fe(n),me(``),be(``),Se(``),we(``)}catch(e){I(e instanceof Error?e.message:`Unable to register account.`)}finally{P(!1)}},children:[(0,H.jsxs)(`div`,{className:`admin-login-hero auth-modal-hero`,children:[(0,H.jsx)(`div`,{className:`admin-login-brand`,children:(0,H.jsx)(`img`,{alt:`IBACMI`,src:`/IBACMI-Scholarship-Office/assets/IBACMI-DvrUkuyb.png`})}),(0,H.jsx)(`button`,{"aria-label":`Close sign up`,className:`icon-button modal-close admin-login-close`,onClick:kt,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})}),(0,H.jsx)(`p`,{className:`modal-kicker`,children:`Account Registration`}),(0,H.jsx)(`h3`,{id:`sign-up-title`,children:`Create Account`}),(0,H.jsx)(`p`,{children:`Registration is only available for verified School IDs listed in the IBACMI Scholarship Office records.`})]}),(0,H.jsxs)(`div`,{className:`modal-body admin-login-body auth-form-grid`,children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Email account`}),(0,H.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`signUpEmail`,placeholder:`Enter email account`,required:!0,type:`email`,value:he,onChange:e=>ge(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`School ID`}),(0,H.jsx)(`input`,{autoComplete:`off`,name:`signUpSchoolId`,placeholder:`Enter School ID`,required:!0,type:`text`,minLength:4,maxLength:30,pattern:`[A-Za-z0-9-]{4,30}`,value:_e,onChange:e=>ve(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Phone Number`}),(0,H.jsx)(`input`,{autoComplete:`tel`,inputMode:`tel`,name:`signUpPhoneNumber`,pattern:`\\+?[0-9]*`,placeholder:`e.g. 09123456789`,required:!0,type:`tel`,value:ye,onChange:e=>be(xr(e.target.value))})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Password`}),(0,H.jsx)(`input`,{autoComplete:`new-password`,name:`signUpPassword`,placeholder:`Create password`,required:!0,type:`password`,minLength:6,value:xe,onChange:e=>Se(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Confirm Password`}),(0,H.jsx)(`input`,{autoComplete:`new-password`,name:`signUpConfirmPassword`,placeholder:`Confirm password`,required:!0,type:`password`,minLength:6,value:Ce,onChange:e=>we(e.target.value)})]}),(0,H.jsxs)(`div`,{className:`auth-note-box auth-full-field`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`verified_user`}),(0,H.jsx)(`p`,{children:`Your School ID will be checked against the official grantee information record before account creation.`})]}),Te&&(0,H.jsx)(`p`,{className:`form-error auth-full-field`,children:Te}),Ee&&(0,H.jsx)(`p`,{className:`form-success auth-full-field`,children:Ee})]}),(0,H.jsxs)(`div`,{className:`modal-actions admin-login-actions auth-actions`,children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:N,onClick:At,type:`button`,children:`Back to Login`}),(0,H.jsx)(`button`,{className:`button`,disabled:N,type:`submit`,children:N?`Registering...`:`Register Now`})]})]})]}),h&&(0,H.jsxs)(`div`,{"aria-labelledby":`sign-up-denied-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close sign up denied modal`,className:`modal-backdrop-button`,onClick:jt,type:`button`}),(0,H.jsxs)(`section`,{className:`modal-card modal-card--success auth-modal-card auth-denied-card`,children:[(0,H.jsxs)(`div`,{className:`success-modal-body auth-denied-body`,children:[(0,H.jsx)(`div`,{className:`auth-denied-icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`error`})}),(0,H.jsx)(`h3`,{id:`sign-up-denied-title`,children:`Account Registration Not Approved`}),(0,H.jsx)(`p`,{children:`Sorry, you cannot proceed. Your School ID was not found in the official records. Please contact the IBACMI | Scholarship Office for assistance.`})]}),(0,H.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,H.jsx)(`button`,{className:`button`,onClick:jt,type:`button`,children:`Back to Sign Up`})})]})]}),Ee&&(0,H.jsxs)(`div`,{"aria-labelledby":`sign-up-success-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Continue to student page`,className:`modal-backdrop-button`,onClick:_t,type:`button`}),(0,H.jsxs)(`section`,{className:`modal-card modal-card--success auth-modal-card`,children:[(0,H.jsxs)(`div`,{className:`success-modal-body`,children:[(0,H.jsx)(`div`,{className:`success-icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`check_circle`})}),(0,H.jsx)(`h3`,{id:`sign-up-success-title`,children:`Successfully Registered`}),(0,H.jsxs)(`p`,{children:[Ee,` You can now continue to the student information page.`]})]}),(0,H.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,H.jsx)(`button`,{className:`button`,onClick:_t,type:`button`,children:`Continue`})})]})]}),d&&(0,H.jsxs)(`div`,{"aria-labelledby":`forgot-password-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close forgot password modal`,className:`modal-backdrop-button`,onClick:Nt,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card modal-card--admin auth-modal-card auth-modal-card--large`,onSubmit:async e=>{e.preventDefault();let t=Ut(),n=Ae.trim().toLowerCase(),r=Me.trim(),i=br(Pe),a=Ie.trim(),o=Re,s=Be;if(L(``),We(``),t){L(t);return}if(!Ge){L(`Please request an OTP first.`);return}if(!a){L(`OTP is required.`);return}if(!/^\d{4,8}$/.test(a)){L(`OTP must be 4 to 8 digits.`);return}if(!o){L(`New password is required.`);return}if(!Dr(o)){L(`New password must be at least 6 characters.`);return}if(!s){L(`Confirm password is required.`);return}if(o!==s){L(`New password and confirm password do not match.`);return}Xe(!0);try{let e=await rt({email:n||void 0,schoolId:r||void 0,phoneNumber:i,otp:a,newPassword:o});if(!e.success){L(e.message||`Unable to change password.`);return}We(e.message||`Password changed successfully.`),Le(``),ze(``),Ve(``),Ke(!1),ue(n),fe(r),me(``)}catch(e){L(e instanceof Error?e.message:`Unable to change password right now.`)}finally{Xe(!1)}},children:[(0,H.jsxs)(`div`,{className:`admin-login-hero auth-modal-hero`,children:[(0,H.jsx)(`div`,{className:`admin-login-brand`,children:(0,H.jsx)(`img`,{alt:`IBACMI`,src:`/IBACMI-Scholarship-Office/assets/IBACMI-DvrUkuyb.png`})}),(0,H.jsx)(`button`,{"aria-label":`Close forgot password`,className:`icon-button modal-close admin-login-close`,onClick:Nt,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})}),(0,H.jsx)(`p`,{className:`modal-kicker`,children:`Account Recovery`}),(0,H.jsx)(`h3`,{id:`forgot-password-title`,children:`Forgot Password`}),(0,H.jsx)(`p`,{children:`Verify your email or School ID with your registered phone number before changing your password.`})]}),(0,H.jsxs)(`div`,{className:`modal-body admin-login-body auth-form-grid`,children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Email address`}),(0,H.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`forgotEmail`,placeholder:`Enter valid email address`,required:!Me.trim(),type:`email`,disabled:Me.trim().length>0||qe||Ye,value:Ae,onChange:Bt})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`School ID`}),(0,H.jsx)(`input`,{autoComplete:`off`,name:`forgotSchoolId`,placeholder:`Enter School ID`,required:!0,type:`text`,minLength:4,maxLength:30,pattern:`[A-Za-z0-9-]{4,30}`,title:`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`,required:!Ae.trim(),disabled:Ae.trim().length>0||qe||Ye,value:Me,onChange:Vt})]}),(0,H.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,H.jsx)(`span`,{children:`Phone number`}),(0,H.jsx)(`input`,{autoComplete:`tel`,inputMode:`tel`,name:`forgotPhoneNumber`,pattern:`\\+?[0-9]*`,placeholder:`09123456789 or +639123456789`,required:!0,type:`tel`,disabled:qe||Ye,value:Pe,onChange:Ht})]}),(0,H.jsx)(`button`,{className:`button button--secondary auth-full-field`,disabled:qe||Ye,onClick:async()=>{let e=Ut();if(L(``),We(``),e){L(e);return}let t=Ae.trim().toLowerCase(),n=Me.trim(),r=br(Pe);Je(!0);try{let e=await nt({email:t||void 0,schoolId:n||void 0,phoneNumber:r});if(!e.success){L(e.message||`Unable to send OTP.`);return}Ke(!0),We(e.message||`OTP generated successfully. Enter it below to change your password.`)}catch(e){L(e instanceof Error?e.message:`Unable to request OTP right now.`)}finally{Je(!1)}},type:`button`,children:qe?`Sending OTP...`:Ge?`Resend OTP`:`Send OTP`}),Ge&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`OTP Code`}),(0,H.jsx)(`input`,{autoComplete:`one-time-code`,inputMode:`numeric`,name:`forgotOtp`,placeholder:`Enter OTP`,required:!0,type:`text`,maxLength:8,value:Ie,onChange:e=>Le(e.target.value.replace(/\D/g,``))})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`New Password`}),(0,H.jsx)(`input`,{autoComplete:`new-password`,name:`forgotNewPassword`,placeholder:`Enter new password`,required:!0,type:`password`,minLength:6,value:Re,onChange:e=>ze(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,H.jsx)(`span`,{children:`Confirm New Password`}),(0,H.jsx)(`input`,{autoComplete:`new-password`,name:`forgotConfirmPassword`,placeholder:`Confirm new password`,required:!0,type:`password`,minLength:6,value:Be,onChange:e=>Ve(e.target.value)})]})]}),He&&(0,H.jsx)(`p`,{className:`form-error auth-full-field`,children:He}),Ue&&(0,H.jsx)(`p`,{className:`form-success auth-full-field`,children:Ue})]}),(0,H.jsxs)(`div`,{className:`modal-actions admin-login-actions auth-actions`,children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:qe||Ye,onClick:Nt,type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`button`,disabled:!Ge||qe||Ye,type:`submit`,children:Ye?`Changing Password...`:`Change Password`})]})]})]}),x&&(0,H.jsxs)(`div`,{"aria-labelledby":`quick-action-success-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close success modal`,className:`modal-backdrop-button`,onClick:()=>S(``),type:`button`}),(0,H.jsxs)(`div`,{className:`modal-card modal-card--success`,children:[(0,H.jsxs)(`div`,{className:`success-modal-body`,children:[(0,H.jsx)(`div`,{className:`success-icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`check_circle`})}),(0,H.jsx)(`h3`,{id:`quick-action-success-title`,children:`Submitted Successfully`}),(0,H.jsxs)(`p`,{children:[x,` The scholarship office can now review your request.`]})]}),(0,H.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,H.jsx)(`button`,{className:`button`,onClick:()=>S(``),type:`button`,children:`Done`})})]})]}),(0,H.jsx)(`div`,{className:`scroll-progress`,style:{"--scroll-progress":r}})]})}var Fr=`
.auth-modal-card {
  width: min(100%, 520px);
...
`,Ir=`/IBACMI-Scholarship-Office/assets/samp-wIlKUzMl.jpg`,Lr=`modulepreload`,Rr=function(e){return`/IBACMI-Scholarship-Office/`+e},zr={},Br=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Rr(t,n),t in zr)return;zr[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:Lr,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Vr={tesAwardNo:``,studentId:``,batchNo:``,status:``,semester:``,schoolYear:``};function Hr(e){return[...new Set(e.filter(Boolean))]}function Ur(e){let t=String(e??``).match(/\d{4}/);return t?Number(t[0]):0}function Wr(){let e=new Date,t=e.getFullYear(),n=e.getMonth()>=5?t:t-1;return`${n}-${n+1}`}function Gr(e){return e.replace(/[\s-]/g,``).trim()}function Kr(e){return e.replace(/[^\d+]/g,``).replace(/(?!^)\+/g,``)}function qr(e){let t=Gr(e);return/^09\d{9}$/.test(t)||/^\+639\d{9}$/.test(t)}function Jr(e){let t=Wr();return e.find(e=>e.schoolYear===t)||[...e].sort((e,t)=>{let n=Ur(t.schoolYear)-Ur(e.schoolYear);return n===0?(t.uploadedAt??0)-(e.uploadedAt??0):n})[0]}function Yr({url:e}){let t=(0,B.useRef)(null),[n,r]=(0,B.useState)(0),[i,a]=(0,B.useState)(``),[o,s]=(0,B.useState)(0);return(0,B.useEffect)(()=>{let e=t.current;if(!e)return;let n=()=>r(Math.floor(e.clientWidth));if(n(),typeof ResizeObserver>`u`)return window.addEventListener(`resize`,n),()=>window.removeEventListener(`resize`,n);let i=new ResizeObserver(n);return i.observe(e),()=>i.disconnect()},[]),(0,B.useEffect)(()=>{let r=t.current;if(!r||!e||!n)return;let i=!1,o,s;return(async()=>{a(``),r.replaceChildren(),r.setAttribute(`aria-busy`,`true`);try{let[{getDocument:t,GlobalWorkerOptions:a},{default:c}]=await Promise.all([Br(()=>import(`./pdf-UByaI6ed.js`),[]),Br(()=>import(`./pdf.worker.min-D7EoebCV.js`),[])]);if(i)return;a.workerSrc=c;let l=await fetch(e,{mode:`cors`});if(!l.ok)throw Error(`Unable to download PDF (${l.status}).`);let u=new Uint8Array(await l.arrayBuffer());if(i)return;if(!u.length)throw Error(`The uploaded PDF is empty.`);o=t({data:u,disableAutoFetch:!0,disableRange:!0,disableStream:!0});let d=await o.promise;for(let e=1;e<=d.numPages;e+=1){if(i)return;let t=await d.getPage(e),a=n/t.getViewport({scale:1}).width,o=t.getViewport({scale:a}),c=Math.min(window.devicePixelRatio||1,2),l=document.createElement(`canvas`);l.className=`student-id-preview__page`,l.setAttribute(`aria-label`,`Uploaded School ID page ${e}`),l.width=Math.floor(o.width*c),l.height=Math.floor(o.height*c),l.style.width=`${Math.floor(o.width)}px`,l.style.height=`${Math.floor(o.height)}px`,r.appendChild(l),s=t.render({canvas:l,transform:c===1?null:[c,0,0,c,0,0],viewport:o}),await s.promise}}catch(e){!i&&e?.name!==`RenderingCancelledException`&&(console.error(`Unable to render uploaded School ID PDF:`,e),r.replaceChildren(),a(`The PDF preview could not load.`))}finally{i||r.removeAttribute(`aria-busy`)}})(),()=>{i=!0,s?.cancel(),o?.destroy()}},[n,o,e]),(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:`student-id-preview__pages`,ref:t,children:(0,H.jsx)(`span`,{className:`student-id-preview__loading`,children:`Loading PDF preview...`})}),i&&(0,H.jsxs)(`div`,{className:`student-id-preview__error`,children:[(0,H.jsx)(`span`,{children:i}),(0,H.jsx)(`button`,{onClick:()=>s(e=>e+1),type:`button`,children:`Retry preview`})]})]})}function Xr({studentSession:e,onLogout:t,onStudentSessionUpdate:n}){let r=dn(V.allinfo.list),i=fn(V.allinfo.generateUploadUrl),a=fn(V.allinfo.saveStudentIdUploads),o=fn(V.adminAuth.updateStudentPhoneNumber),[s,c]=(0,B.useState)(null),[l,u]=(0,B.useState)(``),[d,f]=(0,B.useState)(``),[p,m]=(0,B.useState)(!1),[h,g]=(0,B.useState)(e?.phoneNumber??``),[_,v]=(0,B.useState)(``),[y,b]=(0,B.useState)(``),[x,S]=(0,B.useState)(!1),C=fn(V.adminAuth.updateStudentCurrentAddress),[w,ee]=(0,B.useState)(e?.currentAddress??``),[T,E]=(0,B.useState)(``),[te,D]=(0,B.useState)(``),[ne,O]=(0,B.useState)(!1),re=String(e?.schoolId??``).trim().toLowerCase(),ie=e?.phoneNumber??``,k=Gr(h)!==Gr(ie),A=e?.currentAddress??``,ae=w.trim()!==A.trim(),j=(0,B.useMemo)(()=>!re||!r?null:Jr(r.filter(e=>String(e.studentId??``).trim().toLowerCase()===re))??null,[r,re]),M=j?{tesAwardNo:j.tesAwardNumber??``,studentId:j.studentId??``,lastName:j.lastName??``,firstName:j.firstName??``,middleInitial:j.middleInitial??``,batchNo:j.batchId??``,status:j.status??``,semester:j.semester??``,schoolYear:j.schoolYear??``}:Vr,N=r===void 0,P=!!re,F=!N&&P&&!j,oe=Hr([M.status,`Validated`,`Pending`,`Rejected`]),se=Hr([M.semester,`1st Semester`,`2nd Semester`]),ce=Hr([M.schoolYear,`2023-2024`,`2024-2025`]),le=!!j?.frontIdStorageId,ue=j?.frontIdUrl??``,de=()=>{typeof t==`function`&&t()},fe=e=>{g(Kr(e.target.value)),v(``),b(``)},pe=e=>{ee(e.target.value),E(``),D(``)},me=async()=>{let t=Gr(h);if(v(``),b(``),!re){v(`Please sign in before updating your phone number.`);return}if(!t){v(`Phone number is required.`);return}if(!qr(t)){v(`Please enter a valid phone number. Example: 09123456789 or +639123456789.`);return}if(!k){b(`Phone number is already up to date.`);return}S(!0);try{let r=await o({schoolId:e.schoolId,phoneNumber:t});if(!r.success){v(r.message||`Unable to update phone number.`);return}g(r.admin?.phoneNumber??t),b(r.message||`Phone number updated successfully.`),typeof n==`function`&&n(r.admin)}catch(e){v(e instanceof Error?e.message:`Unable to update phone number.`)}finally{S(!1)}},he=async()=>{let t=w.trim();if(E(``),D(``),!re){E(`Please sign in before updating your current address.`);return}if(!t){E(`Current address is required.`);return}if(t.length<8){E(`Current address must be at least 8 characters.`);return}if(!ae){D(`Current address is already up to date.`);return}O(!0);try{let r=await C({schoolId:e.schoolId,currentAddress:t});if(!r.success){E(r.message||`Unable to update current address.`);return}ee(r.admin?.currentAddress??t),D(r.message||`Current address updated successfully.`),typeof n==`function`&&n(r.admin)}catch(e){E(e instanceof Error?e.message:`Unable to update current address.`)}finally{O(!1)}},ge=e=>t=>{let n=t.target.files?.[0]??null;if(u(``),f(``),n&&n.type!==`application/pdf`&&!/\.pdf$/i.test(n.name)){u(`Only PDF files are allowed.`),t.target.value=``,e(null);return}if(n&&n.size>5*1024*1024){u(`Each file must be 5MB or smaller.`),t.target.value=``,e(null);return}e(n)},_e=async e=>{let t=await i(),n=await fetch(t,{method:`POST`,headers:{"Content-Type":e.type||`application/octet-stream`},body:e});if(!n.ok)throw Error(`Unable to upload ${e.name}.`);let{storageId:r}=await n.json();return r};return(0,H.jsxs)(`div`,{className:`student-page`,children:[(0,H.jsxs)(`header`,{className:`student-topbar`,children:[(0,H.jsx)(`button`,{"aria-label":`Log out and return to landing page`,className:`student-icon-button`,onClick:de,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`arrow_back`})}),(0,H.jsx)(`h1`,{children:`Student Information`})]}),(0,H.jsxs)(`main`,{className:`student-main`,children:[(0,H.jsxs)(`section`,{className:`student-hero`,"aria-labelledby":`student-title`,children:[(0,H.jsx)(`div`,{className:`student-badge`,children:`Academic Year Update`}),(0,H.jsx)(`h2`,{id:`student-title`,children:`Unifast Portal`}),(0,H.jsx)(`p`,{children:`Please ensure all details match your official documents for successful validation.`})]}),!P&&(0,H.jsx)(`div`,{className:`student-state-box`,children:`Please sign in with a student account to view your grantee information.`}),N&&(0,H.jsx)(`div`,{className:`student-state-box`,children:`Loading your grantee information...`}),F&&(0,H.jsxs)(`div`,{className:`student-state-box student-state-box--warning`,children:[`No allinfo record was found for Student ID `,e?.schoolId,`.`]}),(0,H.jsxs)(`form`,{className:`student-form`,id:`student-information-form`,children:[(0,H.jsxs)(`div`,{className:`student-field`,children:[(0,H.jsx)(`label`,{htmlFor:`tes-award-no`,children:`TES Award No.`}),(0,H.jsx)(`input`,{id:`tes-award-no`,placeholder:`e.g. TES-2024-XXXX`,readOnly:!0,type:`text`,value:M.tesAwardNo})]}),(0,H.jsxs)(`div`,{className:`student-field`,children:[(0,H.jsx)(`label`,{htmlFor:`student-id`,children:`Student ID`}),(0,H.jsx)(`input`,{id:`student-id`,placeholder:`Enter your University ID`,readOnly:!0,type:`text`,value:M.studentId})]}),(0,H.jsxs)(`div`,{className:`student-field student-field--with-action`,children:[(0,H.jsx)(`label`,{htmlFor:`phone-number`,children:`Phone No.`}),(0,H.jsxs)(`div`,{className:`student-inline-control`,children:[(0,H.jsx)(`input`,{id:`phone-number`,inputMode:`tel`,pattern:`\\+?[0-9]*`,placeholder:`09123456789 or +639123456789`,type:`tel`,value:h,onChange:fe}),(0,H.jsx)(`button`,{className:`student-inline-button`,disabled:!P||!k||x,onClick:me,type:`button`,children:x?`Saving...`:`Save`})]}),_&&(0,H.jsx)(`p`,{className:`student-upload-message student-upload-message--error`,children:_}),y&&(0,H.jsx)(`p`,{className:`student-upload-message student-upload-message--success`,children:y})]}),(0,H.jsxs)(`div`,{className:`student-field student-field--with-action student-field--full`,children:[(0,H.jsx)(`label`,{htmlFor:`current-address`,children:`Current Address`}),(0,H.jsx)(`textarea`,{id:`current-address`,placeholder:`Enter your current address`,rows:3,value:w,onChange:pe}),(0,H.jsx)(`button`,{className:`student-inline-button student-inline-button--wide`,disabled:!P||!ae||ne,onClick:he,type:`button`,children:ne?`Saving Address...`:`Save Current Address`}),T&&(0,H.jsx)(`p`,{className:`student-upload-message student-upload-message--error`,children:T}),te&&(0,H.jsx)(`p`,{className:`student-upload-message student-upload-message--success`,children:te})]}),(0,H.jsxs)(`div`,{className:`student-field`,children:[(0,H.jsx)(`label`,{htmlFor:`last-name`,children:`Last Name`}),(0,H.jsx)(`input`,{id:`last-name`,placeholder:`Last Name`,readOnly:!0,type:`text`,value:M.lastName})]}),(0,H.jsxs)(`div`,{className:`student-field`,children:[(0,H.jsx)(`label`,{htmlFor:`first-name`,children:`First Name`}),(0,H.jsx)(`input`,{id:`first-name`,placeholder:`First Name`,readOnly:!0,type:`text`,value:M.firstName})]}),(0,H.jsxs)(`div`,{className:`student-field`,children:[(0,H.jsx)(`label`,{htmlFor:`middle-initial`,children:`MI.`}),(0,H.jsx)(`input`,{id:`middle-initial`,placeholder:`MI.`,readOnly:!0,type:`text`,value:M.middleInitial})]}),(0,H.jsxs)(`div`,{className:`student-field`,children:[(0,H.jsx)(`label`,{htmlFor:`batch-no`,children:`Batch No.`}),(0,H.jsx)(`input`,{id:`batch-no`,placeholder:`e.g. Batch 7`,readOnly:!0,type:`text`,value:M.batchNo})]}),(0,H.jsxs)(`div`,{className:`student-select-grid`,children:[(0,H.jsxs)(`div`,{className:`student-field`,children:[(0,H.jsx)(`label`,{htmlFor:`status`,children:`Status`}),(0,H.jsxs)(`div`,{className:`student-select-wrap`,children:[(0,H.jsxs)(`select`,{disabled:!0,id:`status`,value:M.status,children:[(0,H.jsx)(`option`,{disabled:!0,value:``,children:`Select Status`}),oe.map(e=>(0,H.jsx)(`option`,{children:e},e))]}),(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`expand_more`})]})]}),(0,H.jsxs)(`div`,{className:`student-field`,children:[(0,H.jsx)(`label`,{htmlFor:`semester`,children:`Semester`}),(0,H.jsxs)(`div`,{className:`student-select-wrap`,children:[(0,H.jsxs)(`select`,{disabled:!0,id:`semester`,value:M.semester,children:[(0,H.jsx)(`option`,{disabled:!0,value:``,children:`Select Semester`}),se.map(e=>(0,H.jsx)(`option`,{children:e},e))]}),(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`expand_more`})]})]}),(0,H.jsxs)(`div`,{className:`student-field`,children:[(0,H.jsx)(`label`,{htmlFor:`school-year`,children:`School Year`}),(0,H.jsxs)(`div`,{className:`student-select-wrap`,children:[(0,H.jsxs)(`select`,{disabled:!0,id:`school-year`,value:M.schoolYear,children:[(0,H.jsx)(`option`,{disabled:!0,value:``,children:`Select School Year`}),ce.map(e=>(0,H.jsx)(`option`,{children:e},e))]}),(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`expand_more`})]})]})]}),(0,H.jsxs)(`section`,{className:`student-upload-section`,"aria-labelledby":`student-upload-title`,children:[(0,H.jsxs)(`div`,{className:`student-upload-copy`,children:[(0,H.jsx)(`h3`,{id:`student-upload-title`,children:`Upload colored copy of School ID with 3 signatures and Batch No.`}),(0,H.jsxs)(`p`,{children:[`Files will be saved to your `,M.schoolYear||`current`,` allinfo record. If you have records from other years, the portal automatically uses the current or latest School Year.`]})]}),(0,H.jsxs)(`aside`,{className:`student-sample-card`,"aria-label":`Sample School ID upload format`,children:[(0,H.jsxs)(`div`,{className:`student-sample-card__header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{className:`student-sample-card__eyebrow`,children:`Sample Format`}),(0,H.jsx)(`h4`,{children:`Scan layout guide`})]}),(0,H.jsx)(`span`,{className:`student-sample-card__badge`,children:`Required`})]}),(0,H.jsxs)(`div`,{className:`student-sample-card__body`,children:[(0,H.jsx)(`a`,{className:`student-sample-card__image-link`,href:Ir,rel:`noreferrer`,target:`_blank`,title:`Open sample format`,children:(0,H.jsx)(`img`,{alt:`Sample scan format showing front and back School ID, three signatures, and Batch No.`,src:Ir})}),(0,H.jsxs)(`div`,{className:`student-sample-card__checklist`,children:[(0,H.jsx)(`p`,{children:`Before converting to PDF, make sure your scan includes:`}),(0,H.jsxs)(`ul`,{children:[(0,H.jsx)(`li`,{children:`Colored front and back copy of your School ID`}),(0,H.jsx)(`li`,{children:`Three clear signatures below the ID copies`}),(0,H.jsx)(`li`,{children:`Readable Batch No. written on the same page`})]}),(0,H.jsx)(`span`,{children:`Upload the final file as PDF only, maximum 5MB.`})]})]})]}),(0,H.jsxs)(`div`,{className:`student-upload-field`,children:[(0,H.jsx)(`span`,{className:`student-upload-label`,children:`Upload File`}),(0,H.jsxs)(`label`,{className:`student-upload-card${s||le?` student-upload-card--selected`:``}`,htmlFor:`file-front`,children:[(0,H.jsx)(`input`,{accept:`application/pdf,.pdf`,disabled:!j||p,id:`file-front`,type:`file`,onChange:ge(c)}),(0,H.jsx)(`span`,{className:`student-upload-icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`id_card`})}),(0,H.jsx)(`span`,{className:`student-upload-title`,children:s?.name||(le?`File already uploaded`:`Tap to upload File`)}),(0,H.jsx)(`span`,{className:`student-upload-note`,children:`PDF only up to 5MB`})]})]}),ue&&(0,H.jsxs)(`div`,{className:`student-id-preview`,children:[(0,H.jsxs)(`div`,{className:`student-id-preview__header`,children:[(0,H.jsx)(`span`,{children:`Uploaded School ID`}),(0,H.jsx)(`a`,{href:ue,rel:`noreferrer`,target:`_blank`,children:`View full file`})]}),(0,H.jsx)(Yr,{url:ue}),(0,H.jsx)(`noscript`,{children:(0,H.jsxs)(`a`,{className:`student-id-preview__file`,href:ue,rel:`noreferrer`,target:`_blank`,children:[(0,H.jsx)(`span`,{className:`student-id-preview__file-icon`,"aria-hidden":`true`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`picture_as_pdf`})}),(0,H.jsx)(`span`,{children:`Open uploaded PDF`})]})})]}),l&&(0,H.jsx)(`p`,{className:`student-upload-message student-upload-message--error`,children:l}),d&&(0,H.jsx)(`p`,{className:`student-upload-message student-upload-message--success`,children:d}),(0,H.jsxs)(`button`,{className:`student-save-button`,disabled:!j||p,onClick:async()=>{if(u(``),f(``),!j){u(`No allinfo record is available for your Student ID.`);return}if(!s){u(`Choose a PDF file before saving.`);return}m(!0);try{let e=await _e(s),t=await a({studentId:j.studentId,schoolYear:j.schoolYear,frontIdStorageId:e});c(null),f(`ID file saved for School Year ${t.schoolYear||M.schoolYear}.`)}catch(e){u(e instanceof Error?e.message:`Unable to save uploaded files.`)}finally{m(!1)}},type:`button`,children:[(0,H.jsx)(`span`,{children:p?`Saving Uploads...`:`Save Uploaded ID`}),(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`check_circle`})]})]})]})]})]})}var Zr=class extends B.Component{constructor(e){super(e),this.state={hasError:!1,error:null}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,t){console.error(`ErrorBoundary caught`,e,t)}render(){if(this.state.hasError){let e=this.state.error?.message||`An unexpected error occurred.`;return(0,H.jsx)(`div`,{style:{minHeight:`100vh`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:24,boxSizing:`border-box`,background:`#fbfaf8`,color:`#1c1b1b`,fontFamily:`'Hanken Grotesk', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif`},children:(0,H.jsxs)(`div`,{style:{maxWidth:720},children:[(0,H.jsx)(`h2`,{style:{marginTop:0},children:`Something went wrong`}),(0,H.jsx)(`p`,{style:{color:`#584237`,fontWeight:700},children:e}),(0,H.jsx)(`p`,{style:{color:`#584237`},children:'If the message mentions Convex functions (for example "Could not find public function"), make sure the Convex dev server is running (`npx convex dev`) or that `VITE_CONVEX_URL` points to a deployed Convex app.'}),(0,H.jsxs)(`div`,{style:{display:`flex`,gap:8,marginTop:18},children:[(0,H.jsx)(`button`,{type:`button`,onClick:()=>window.location.reload(),style:{background:`#ea580c`,color:`#fff`,border:0,padding:`10px 14px`,borderRadius:8,fontWeight:800,cursor:`pointer`},children:`Reload`}),(0,H.jsx)(`button`,{type:`button`,onClick:()=>alert("Run `npx convex dev` in the project root or set VITE_CONVEX_URL."),style:{background:`#fff`,color:`#1c1b1b`,border:`1px solid rgba(150,116,101,0.6)`,padding:`10px 14px`,borderRadius:8,fontWeight:700,cursor:`pointer`},children:`Help`})]})]})})}return this.props.children}},Qr=`unifast.adminSession`,$r=`unifast.studentViewOpen`,ei=`unifast.studentSession`;function ti(){try{let e=window.localStorage.getItem(Qr);return e?JSON.parse(e):null}catch{return null}}function ni(){try{return window.localStorage.getItem($r)===`true`}catch{return!1}}function ri(){try{let e=window.localStorage.getItem(ei);return e?JSON.parse(e):null}catch{return null}}function ii(){let e=(0,An.c)(21),[t,n]=(0,B.useState)(ti),[r,i]=(0,B.useState)(ri),[a,o]=(0,B.useState)(ni),s;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(s=()=>{n(null)},e[0]=s):s=e[0];let c=s,l;e[1]===Symbol.for(`react.memo_cache_sentinel`)?(l=()=>{i(null),o(!1)},e[1]=l):l=e[1];let u=l,d;e[2]===Symbol.for(`react.memo_cache_sentinel`)?(d=e=>{if(e?.role===`student`){n(null),i(e),o(!0);return}i(null),o(!1),n(e)},e[2]=d):d=e[2];let f=d,p;e[3]===Symbol.for(`react.memo_cache_sentinel`)?(p=e=>{n(null),i(e??null),o(!0)},e[3]=p):p=e[3];let m=p,h;e[4]===Symbol.for(`react.memo_cache_sentinel`)?(h=e=>{i(t=>({...t??{},...e??{}}))},e[4]=h):h=e[4];let g=h,_,v;e[5]===t?(_=e[6],v=e[7]):(_=()=>{if(!t)return;let e=window.location.href,n={...window.history.state??{},unifastAdminGuard:!0};window.history.pushState(n,``,e);let r=()=>{window.history.pushState(n,``,e)};return window.addEventListener(`popstate`,r),()=>window.removeEventListener(`popstate`,r)},v=[t],e[5]=t,e[6]=_,e[7]=v),(0,B.useEffect)(_,v);let y,b;e[8]===t?(y=e[9],b=e[10]):(y=()=>{try{if(t){window.localStorage.setItem(Qr,JSON.stringify(t)),window.localStorage.removeItem($r),window.localStorage.removeItem(ei);return}window.localStorage.removeItem(Qr)}catch{}},b=[t],e[8]=t,e[9]=y,e[10]=b),(0,B.useEffect)(y,b);let x,S;if(e[11]!==a||e[12]!==r?(S=()=>{try{if(a){window.localStorage.setItem($r,`true`),window.localStorage.removeItem(Qr),r&&window.localStorage.setItem(ei,JSON.stringify(r));return}window.localStorage.removeItem($r),window.localStorage.removeItem(ei)}catch{}},x=[a,r],e[11]=a,e[12]=r,e[13]=x,e[14]=S):(x=e[13],S=e[14]),(0,B.useEffect)(S,x),t){let n;return e[15]===t?n=e[16]:(n=(0,H.jsx)(Zr,{children:(0,H.jsx)(fr,{adminSession:t,onLogout:c})}),e[15]=t,e[16]=n),n}if(a){let t=r?.schoolId??`student`,n;return e[17]!==r||e[18]!==t?(n=(0,H.jsx)(Zr,{children:(0,H.jsx)(Xr,{studentSession:r,onLogout:u,onStudentSessionUpdate:g},t)}),e[17]=r,e[18]=t,e[19]=n):n=e[19],n}let C;return e[20]===Symbol.for(`react.memo_cache_sentinel`)?(C=(0,H.jsx)(Zr,{children:(0,H.jsx)(Pr,{onAdminLoginSuccess:f,onStudentRegistrationSuccess:m})}),e[20]=C):C=e[20],C}var ai=`https://ideal-crane-292.convex.cloud`,oi=(0,Tn.createRoot)(document.getElementById(`root`));{let e=new sn(ai);oi.render((0,H.jsx)(B.StrictMode,{children:(0,H.jsx)(un,{client:e,children:(0,H.jsx)(ii,{})})}))}export{Br as t};