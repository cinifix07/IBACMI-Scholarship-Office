...
`||o===`\r`)&&!i?(o===`\r`&&s===`
`&&(a+=1),n.push(lr(r)),n.some(Boolean)&&t.push(n),n=[],r=``):r+=o}return n.push(lr(r)),n.some(Boolean)&&t.push(n),t}function dr(e){return ur(e).filter(e=>e.some(Boolean)).filter(e=>!e.join(` `).toLowerCase().includes(`tes award number`)).map(e=>({no:e[0]??``,tesAwardNumber:e[1]??``,studentId:e[2]??``,lastName:e[3]??``,firstName:e[4]??``,middleInitial:e[5]??``,batchId:e[6]??``,status:e[7]??``,semester:e[8]??``,schoolYear:e[9]??``})).filter(e=>e.no&&e.tesAwardNumber&&e.studentId&&e.lastName&&e.firstName&&e.batchId&&e.status&&e.semester&&e.schoolYear)}function fr({onLogout:e}){let[t,n]=(0,B.useState)(0),[r,i]=(0,B.useState)(!1),[a,o]=(0,B.useState)(!1),[s,c]=(0,B.useState)(!1),[l,u]=(0,B.useState)(!1),[d,f]=(0,B.useState)(!1),[p,m]=(0,B.useState)(``),[h,g]=(0,B.useState)(!1),[_,v]=(0,B.useState)(!1),[y,b]=(0,B.useState)(!1),[x,S]=(0,B.useState)(!1),[C,w]=(0,B.useState)(``),[T,E]=(0,B.useState)(!1),[D,O]=(0,B.useState)(null),[k,ee]=(0,B.useState)(null),[A,j]=(0,B.useState)(``),[te,M]=(0,B.useState)(``),[N,ne]=(0,B.useState)(!1),[P,re]=(0,B.useState)(!1),[ie,F]=(0,B.useState)(!1),[I,ae]=(0,B.useState)(!1),[oe,se]=(0,B.useState)(1),[ce,le]=(0,B.useState)(1),[L,ue]=(0,B.useState)([]),[de,fe]=(0,B.useState)(null),[pe,me]=(0,B.useState)(null),[he,ge]=(0,B.useState)(``),[_e,ve]=(0,B.useState)(!1),[ye,be]=(0,B.useState)(``),[xe,Se]=(0,B.useState)(``),[Ce,R]=(0,B.useState)(1),[we,Te]=(0,B.useState)(1),[Ee,De]=(0,B.useState)(1),[Oe,ke]=(0,B.useState)(1),[Ae,je]=(0,B.useState)(``),[Me,Ne]=(0,B.useState)(1),[Pe,Fe]=(0,B.useState)(1),Ie=dn(V.quickActions.list),Le=dn(V.activityLogs.list),Re=dn(V.allinfo.list),ze=dn(V.applicants.list),Be=dn(V.applicantPortal.get),Ve=dn(V.adminAuth.listStudentAccounts),He=fn(V.applicantPortal.setReceivingApplicants),Ue=fn(V.allinfo.bulkCreate),We=fn(V.allinfo.update),Ge=fn(V.allinfo.deleteMany),Ke=fn(V.quickActions.clearAll),qe=fn(V.activityLogs.clearAll),Je=r||a||s||l||d||!!p||h||_||y||!!D||x||!!C||!!de,Ye=(0,B.useMemo)(()=>Re??[],[Re]),Xe=Ie??[],Ze=Le??[],Qe=(0,B.useMemo)(()=>ze??[],[ze]),$e=(0,B.useMemo)(()=>Ve??[],[Ve]),et=Be?.applicationYear,tt=String(et??new Date().getFullYear()),nt=(0,B.useMemo)(()=>{let e=new Date().getFullYear(),t=new Set([String(e-1),String(e),String(e+1),String(e+2),String(e+3),String(e+4),String(e+5)]);return et&&t.add(String(et)),Qe.forEach(e=>{let n=$n(e);n&&t.add(n)}),Array.from(t).sort()},[Qe,et]),rt=Math.max(1,Math.ceil(nt.length/Bn)),z=Math.min(Pe,rt),it=(z-1)*Bn,at=nt.slice(it,it+Bn),ot=er(z,rt),st=nt.length===0?0:it+1,ct=it+at.length,lt=(0,B.useMemo)(()=>Array.from(new Set(Ye.map(e=>String(e.batchId??``).trim()).filter(Boolean))).sort(),[Ye]),ut=(0,B.useMemo)(()=>lt.map(e=>{let t=Ye.filter(t=>String(t.batchId??``).trim()===e),n=new Set(t.map(e=>String(e.studentId??``).trim().toLowerCase()));return{accountCount:$e.filter(e=>n.has(String(e.schoolId??``).trim().toLowerCase())).length,batchId:e,recordCount:t.length}}),[lt,Ye,$e]),dt=(0,B.useMemo)(()=>Vn.map(e=>({applicantCount:Qe.filter(t=>$n(t)===tt&&Qn(t).toLowerCase()===e.toLowerCase()).length,course:e})),[tt,Qe]),ft=(0,B.useMemo)(()=>{let e=p.trim().toLowerCase();return e?Qe.filter(t=>$n(t)===tt&&Qn(t).toLowerCase()===e):[]},[tt,Qe,p]),pt=(0,B.useMemo)(()=>{let e=Ae.trim().toLowerCase();return e?ft.filter(t=>{let n=[t.firstName,t.middleName,t.lastName,t.extensionName].filter(Boolean).join(` `);return[t.studentId,n,t.gender,t.birthDate,t.year,t.address,t.mobileNumber,t.emailAddress,t.status,t.psaFileName,t.schoolIdFileName,t.pwdIdFileName,t.fourPsFileName,Kn(t.submittedAt)].map(e=>String(e??``).toLowerCase()).join(` `).includes(e)}):ft},[Ae,ft]),mt=Math.max(1,Math.ceil(pt.length/zn)),ht=Math.min(Me,mt),gt=(ht-1)*zn,_t=pt.slice(gt,gt+zn),vt=er(ht,mt),yt=pt.length===0?0:gt+1,bt=gt+_t.length,xt=(0,B.useMemo)(()=>{let e=ye.trim().toLowerCase(),t=xe.trim().toLowerCase();return Ye.filter(n=>{let r=[n.no,n.tesAwardNumber,n.studentId,n.lastName,n.firstName,n.middleInitial,n.batchId,n.status,n.semester,n.schoolYear].map(e=>String(e??``).toLowerCase()).join(` `),i=e?r.includes(e):!0,a=t?String(n.batchId??``).trim().toLowerCase()===t:!0;return i&&a})},[Ye,ye,xe]),St=Math.max(1,Math.ceil(xt.length/Nn)),Ct=Math.min(oe,St),wt=(Ct-1)*Nn,Tt=er(Ct,St),Et=xt.slice(wt,wt+Nn),Dt=xt.filter(e=>e.frontIdUrl),Ot=(0,B.useMemo)(()=>Array.from(new Set(Dt.map(e=>String(e.schoolYear??``).trim()).filter(Boolean))).sort((e,t)=>t.localeCompare(e)),[Dt]),kt=(0,B.useMemo)(()=>Ot.map(e=>({fileCount:Dt.filter(t=>String(t.schoolYear??``).trim()===e).length,schoolYear:e})),[Dt,Ot]),At=(0,B.useMemo)(()=>{if(!C)return[];let e=new Map;return Dt.forEach(t=>{if(String(t.schoolYear??``).trim()!==C)return;let n=String(t.batchId??``).trim();if(!n)return;let r=e.get(n)??{batchId:n,fileCount:0};r.fileCount+=1,e.set(n,r)}),Array.from(e.values()).sort((e,t)=>e.batchId.localeCompare(t.batchId))},[Dt,C]),jt=xt.length===0?0:wt+1,Mt=wt+Et.length,Nt=Math.max(1,Math.ceil(Xe.length/Pn)),Pt=Math.min(ce,Nt),Ft=(Pt-1)*Pn,It=Xe.slice(Ft,Ft+Pn),Lt=Xe.length===0?0:Ft+1,Rt=Ft+It.length,zt=Math.max(1,Math.ceil(Ze.length/Fn)),Bt=Math.min(Ce,zt),Vt=(Bt-1)*Fn,Ht=Ze.slice(Vt,Vt+Fn),Ut=Ze.length===0?0:Vt+1,Wt=Vt+Ht.length,Gt=Math.max(1,Math.ceil(ut.length/In)),Kt=Math.min(we,Gt),qt=(Kt-1)*In,Jt=ut.slice(qt,qt+In),Yt=ut.length===0?0:qt+1,Xt=qt+Jt.length,Zt=Math.max(1,Math.ceil(kt.length/Ln)),Qt=Math.min(Ee,Zt),$t=(Qt-1)*Ln,en=kt.slice($t,$t+Ln),tn=kt.length===0?0:$t+1,nn=$t+en.length,rn=Math.max(1,Math.ceil(At.length/Rn)),an=Math.min(Oe,rn),on=(an-1)*Rn,sn=At.slice(on,on+Rn),cn=At.length===0?0:on+1,ln=on+sn.length,un=e=>{se(Math.min(Math.max(e,1),St))},pn=e=>{le(Math.min(Math.max(e,1),Nt))},mn=e=>{R(Math.min(Math.max(e,1),zt))},hn=e=>{Te(Math.min(Math.max(e,1),Gt))},gn=e=>{De(Math.min(Math.max(e,1),Zt))},_n=e=>{ke(Math.min(Math.max(e,1),rn))},vn=e=>{Ne(Math.min(Math.max(e,1),mt))},yn=e=>{Fe(Math.min(Math.max(e,1),rt))},bn=e=>{m(e),je(``),Ne(1)},xn=()=>{m(``),je(``),Ne(1)},Sn=e=>{je(e.target.value),Ne(1)},Cn=e=>{w(e),ke(1)},wn=()=>{T||(S(!1),w(``),ke(1))},Tn=()=>{be(``),Se(``),se(1)},En=e=>{be(e.target.value),se(1)},Dn=e=>{Se(e.target.value),se(1)},On=async(e,t)=>{let n=String(e??``).trim(),r=String(t??``).trim(),i=Dt.filter(e=>String(e.schoolYear??``).trim()===n&&String(e.batchId??``).trim()===r);if(i.length!==0){E(!0);try{let e=[];for(let[t,n]of i.entries())try{let r=await nr(n,t);e.push(r)}catch(e){console.warn(e)}if(e.length===0)throw Error(`No School ID files could be downloaded for this batch.`);let t=cr(e),a=URL.createObjectURL(t),o=document.createElement(`a`),s=Xn(n,`school-year`),c=Xn(r,`batch`);o.href=a,o.download=`school-id-files-${s}-batch-${c}.zip`,o.rel=`noreferrer`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a),S(!1),w(``),ke(1)}catch(e){window.alert(e instanceof Error?e.message:`Unable to download School ID files.`)}finally{E(!1)}}},kn=e=>{if(Ve===void 0){window.alert(`Please wait while student account data is loading.`);return}let t=String(e??``).trim(),n=Ye.filter(e=>String(e.batchId??``).trim()===t);if(n.length===0){window.alert(`No records found for this batch.`);return}let r=new Map($e.map(e=>[String(e.schoolId??``).trim().toLowerCase(),e])),i=[[`Batch No.`,`Student ID`,`TES Award Number`,`Last Name`,`First Name`,`MI.`,`School Year`,`Status`,`Email Account`,`Phone No.`,`Current Address`,`Account Status`],...n.map(e=>{let t=r.get(String(e.studentId??``).trim().toLowerCase());return[e.batchId??``,e.studentId??``,e.tesAwardNumber??``,e.lastName??``,e.firstName??``,e.middleInitial??``,e.schoolYear??``,e.status??``,t?.email??``,t?.phoneNumber??``,t?.currentAddress??``,t?.status??`No student account`]})];Jn(`batch-info-${Xn(t,`batch`)}.csv`,i),v(!1)},An=e=>{if(ze===void 0){window.alert(`Please wait while applicant information is loading.`);return}let t=String(e??``).trim(),n=[[`Application Year`,`Course`,`Student ID`,`Last Name`,`First Name`,`Ext Name`,`Middle Name`,`Gender`,`Birth Date`,`Year`,`Father Last Name`,`Father First Name`,`Father Middle Name`,`Mother Last Name`,`Mother First Name`,`Mother Middle Name`,`Address`,`Zip Code`,`PWD ID`,`PWD ID PDF`,`4Ps ID PDF`,`Mobile No.`,`Email Address`,`Status`,`Submitted At`],...Qe.filter(e=>$n(e)===tt&&Qn(e).toLowerCase()===t.toLowerCase()).map(e=>[$n(e),Qn(e)||t,e.studentId??``,e.lastName??``,e.firstName??``,e.extensionName??``,e.middleName??``,e.gender??``,e.birthDate??``,e.year??``,e.fatherLastName??``,e.fatherFirstName??``,e.fatherMiddleName??``,e.motherLastName??``,e.motherFirstName??``,e.motherMiddleName??``,e.address??``,e.zipCode??``,e.pwdId??``,e.pwdIdFileName??``,e.fourPsFileName??``,e.mobileNumber??``,e.emailAddress??``,e.status??``,Kn(e.submittedAt)])],r=Xn(t,`course`);Jn(`unifast-applicants-${Xn(tt,`application-year`)}-${r}.csv`,n)},Mn=()=>{if(Ie===void 0){window.alert(`Please wait while student requests are loading.`);return}if(Xe.length===0){window.alert(`No student requests are available to export.`);return}let e=Kn(Date.now()),t=[[`No.`,`Student ID`,`Last Name`,`First Name`,`MI`,`Email Account`,`Question / Request`,`Source`,`Status`,`Submitted At`,`Exported At`],...Xe.map((t,n)=>[n+1,t.studentId??``,t.lastName??``,t.firstName??``,t.middleInitial??``,t.email??``,t.question??``,t.source??``,t.status??``,Kn(t.submittedAt),e])];Jn(`student-requests-responses-${new Date().toISOString().slice(0,10)}.csv`,t)},qn=async()=>{if(!(ie||Xe.length===0)&&window.confirm(`Clear all ${Xe.length} Quick Action message${Xe.length===1?``:`s`}? This cannot be undone.`)){F(!0);try{await Ke({}),le(1)}catch(e){window.alert(e instanceof Error?e.message:`Unable to clear Quick Action messages.`)}finally{F(!1)}}},tr=async()=>{if(!(I||Ze.length===0)&&window.confirm(`Clear all ${Ze.length} visible activity logs? This permanently removes all stored logs and cannot be undone.`)){ae(!0);try{await qe({}),R(1)}catch(e){window.alert(e instanceof Error?e.message:`Unable to clear activity logs.`)}finally{ae(!1)}}},rr=async(e,t)=>{try{let n=await He({isReceivingApplicants:e,...t?{applicationYear:t}:{}});n.success||window.alert(n.message||`Unable to update applicant portal status.`)}catch(e){window.alert(e instanceof Error?e.message:`Unable to update applicant portal status.`)}},ir=async e=>{await rr(!0,e),f(!1),Fe(1)},ar=()=>{c(!1),u(!1),f(!1),Fe(1),m(``),je(``),Ne(1)},or=()=>{Te(1),M(``),b(!0)},sr=()=>{P||(b(!1),O(null))},U=()=>{le(1),o(!0)},lr=()=>{ee(null),j(``),M(``),ne(!1),g(!0)},ur=()=>{N||(g(!1),ee(null),j(``),ne(!1))},fr=()=>{_e||(fe(null),me(null),ge(``))},mr=e=>{fe(e),me({no:e.no??``,tesAwardNumber:e.tesAwardNumber??``,studentId:e.studentId??``,lastName:e.lastName??``,firstName:e.firstName??``,middleInitial:e.middleInitial??``,batchId:e.batchId??``,status:e.status??``,semester:e.semester??``,schoolYear:e.schoolYear??``}),ge(``)},hr=e=>t=>{ge(``),me(n=>({...n,[e]:t.target.value}))},gr=async e=>{if(e.preventDefault(),!(!de||!pe)){if([`no`,`tesAwardNumber`,`studentId`,`lastName`,`firstName`,`batchId`,`status`,`semester`,`schoolYear`].some(e=>!String(pe[e]??``).trim())){ge(`Please complete all required fields before saving.`);return}ve(!0),ge(`Saving changes...`);try{await We({id:de._id,...pe}),ge(`Record updated successfully.`),fe(null),me(null)}catch(e){ge(e instanceof Error?e.message:`Unable to update record.`)}finally{ve(!1)}}},_r=e=>{M(``),ue(t=>t.includes(e)?t.filter(t=>t!==e):[...t,e])},vr=async()=>{if(L.length===0){M(`Please check at least one record before deleting.`);return}if(window.confirm(`Delete ${L.length} checked record${L.length===1?``:`s`}?`)){re(!0),M(`Deleting checked record...`);try{let e=await Ge({ids:L});ue([]),M(`${e?.deleted??L.length} record${(e?.deleted??L.length)===1?``:`s`} deleted successfully.`)}catch(e){M(e instanceof Error?e.message:`Unable to delete records.`)}finally{re(!1)}}};return(0,B.useEffect)(()=>{let e=()=>{let e=document.documentElement.scrollTop||document.body.scrollTop,t=document.documentElement.scrollHeight-document.documentElement.clientHeight;n(t>0?e/t:0)};return e(),window.addEventListener(`scroll`,e,{passive:!0}),()=>window.removeEventListener(`scroll`,e)},[]),(0,B.useEffect)(()=>{if(!Je)return;let e=e=>{e.key===`Escape`&&(i(!1),o(!1),c(!1),u(!1),f(!1),Fe(1),m(``),je(``),Ne(1),g(!1),v(!1),b(!1),O(null),S(!1),w(``),ke(1),ee(null),j(``),ne(!1),fe(null))};return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),()=>{document.body.style.overflow=``,window.removeEventListener(`keydown`,e)}},[Je]),(0,H.jsxs)(`div`,{className:`admin-page`,children:[(0,H.jsx)(`style`,{children:pr}),(0,H.jsxs)(`header`,{className:`admin-topbar`,children:[(0,H.jsxs)(`div`,{className:`brand-lockup`,children:[(0,H.jsx)(`div`,{className:`brand-mark`,children:(0,H.jsx)(`img`,{alt:`IBACMI`,className:`brand-mark__image`,src:jn})}),(0,H.jsxs)(`div`,{className:`brand-copy`,children:[(0,H.jsx)(`p`,{className:`brand-title`,children:`IBACMI`}),(0,H.jsx)(`p`,{className:`brand-subtitle`,children:`Scholarship Office`})]})]}),(0,H.jsxs)(`div`,{className:`header-actions`,children:[(0,H.jsxs)(`button`,{className:`admin-button admin-button--ghost`,onClick:()=>{R(1),i(!0)},type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`history`}),`Logs`]}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--ghost`,onClick:()=>c(!0),type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`folder_open`}),`UNIFAST PORTAL`]}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--ghost`,onClick:U,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`task_alt`}),`Quick Actions`]}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--admin`,onClick:e,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`logout`}),`Logout`]})]})]}),(0,H.jsx)(`main`,{className:`admin-main`,children:(0,H.jsxs)(`div`,{className:`admin-container`,children:[(0,H.jsxs)(`section`,{className:`admin-heading`,children:[(0,H.jsxs)(`div`,{className:`admin-heading__copy`,children:[(0,H.jsx)(`span`,{className:`admin-eyebrow`,children:`Grantee Management`}),(0,H.jsx)(`h1`,{children:`Grantee Management`}),(0,H.jsx)(`p`,{children:`Manage TES grantee records, review student requests, upload CSV records, and monitor scholarship information in one responsive workspace.`})]}),(0,H.jsxs)(`div`,{className:`admin-heading__actions`,children:[(0,H.jsxs)(`button`,{className:`admin-button admin-button--secondary`,disabled:lt.length===0,onClick:()=>{Te(1),v(!0)},title:lt.length===0?`No batches available to export`:`Choose a batch to export student account info`,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`table_view`}),`Export to CSV Batch Info`]}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--secondary`,disabled:Dt.length===0,onClick:()=>{De(1),S(!0)},title:Dt.length===0?`No School ID files available to download`:`Choose a School Year to download School ID files`,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`download`}),`Download School ID File`]}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--primary`,onClick:lr,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`add`}),`Add New Record`]}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--danger`,disabled:lt.length===0,onClick:or,title:lt.length===0?`No batches available to delete`:`Choose a batch to delete`,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`delete`}),`Delete Batch`]})]})]}),(0,H.jsxs)(`section`,{className:`admin-stats-grid`,"aria-label":`Grantee summary`,children:[(0,H.jsxs)(`div`,{className:`admin-stat-card`,children:[(0,H.jsx)(`span`,{children:`Total Records`}),(0,H.jsx)(`strong`,{children:Ye.length})]}),(0,H.jsxs)(`div`,{className:`admin-stat-card`,children:[(0,H.jsx)(`span`,{children:`Filtered Results`}),(0,H.jsx)(`strong`,{children:xt.length})]}),(0,H.jsxs)(`div`,{className:`admin-stat-card`,children:[(0,H.jsx)(`span`,{children:`Checked Records`}),(0,H.jsx)(`strong`,{children:L.length})]}),(0,H.jsxs)(`div`,{className:`admin-stat-card`,children:[(0,H.jsx)(`span`,{children:`Student Requests`}),(0,H.jsx)(`strong`,{children:Xe.length})]})]}),(0,H.jsxs)(`section`,{className:`admin-filter-panel`,"aria-label":`Grantee filters`,children:[(0,H.jsxs)(`div`,{className:`admin-search-field`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`search`}),(0,H.jsx)(`input`,{placeholder:`Search by Student ID, award number, status, semester...`,type:`text`,value:ye,onChange:En})]}),(0,H.jsxs)(`select`,{value:xe,onChange:Dn,children:[(0,H.jsx)(`option`,{value:``,children:`All Batches`}),lt.map(e=>(0,H.jsx)(`option`,{value:e,children:e},e))]}),(0,H.jsx)(`button`,{className:`admin-filter-button`,type:`button`,"aria-label":`Reset filters`,title:`Reset filters`,onClick:Tn,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`refresh`})})]}),(0,H.jsxs)(`section`,{className:`admin-table-card`,"aria-label":`TDP grantee records`,children:[(0,H.jsx)(`div`,{className:`admin-table-header`,children:(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h2`,{children:`Grantee Records`}),(0,H.jsx)(`p`,{children:`Review, check, edit, or delete selected records.`})]})}),(0,H.jsx)(`div`,{className:`admin-table-scroll`,children:(0,H.jsxs)(`table`,{children:[(0,H.jsx)(`thead`,{children:(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`th`,{children:`No.`}),(0,H.jsx)(`th`,{children:`TES Award Number`}),(0,H.jsx)(`th`,{children:`Student ID`}),(0,H.jsx)(`th`,{children:`Last Name`}),(0,H.jsx)(`th`,{children:`First Name`}),(0,H.jsx)(`th`,{children:`MI.`}),(0,H.jsx)(`th`,{children:`Batch No.`}),(0,H.jsx)(`th`,{children:`Status`}),(0,H.jsx)(`th`,{children:`Semester`}),(0,H.jsx)(`th`,{children:`School Year`}),(0,H.jsx)(`th`,{children:`School ID File`}),(0,H.jsx)(`th`,{children:`Actions`})]})}),(0,H.jsxs)(`tbody`,{children:[Re===void 0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`admin-empty-state`,colSpan:12,children:`Loading grantee records...`})}),Re?.length===0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`admin-empty-state`,colSpan:12,children:`No grantee records yet. Upload a CSV file to add records.`})}),Re&&Re.length>0&&xt.length===0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`admin-empty-state`,colSpan:12,children:`No matching record found.`})}),Et.map((e,t)=>(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`td`,{"data-label":`No.`,children:wt+t+1}),(0,H.jsx)(`td`,{className:`admin-award-cell`,"data-label":`TES Award Number`,children:e.tesAwardNumber}),(0,H.jsx)(`td`,{"data-label":`Student ID`,children:e.studentId}),(0,H.jsx)(`td`,{"data-label":`Last Name`,children:e.lastName||`—`}),(0,H.jsx)(`td`,{"data-label":`First Name`,children:e.firstName||`—`}),(0,H.jsx)(`td`,{"data-label":`MI.`,children:e.middleInitial||`—`}),(0,H.jsx)(`td`,{className:`admin-batch-cell`,"data-label":`Batch No.`,children:e.batchId}),(0,H.jsx)(`td`,{"data-label":`Status`,children:(0,H.jsx)(Wn,{status:e.status,tone:Gn(e.status)})}),(0,H.jsx)(`td`,{"data-label":`Semester`,children:e.semester||`—`}),(0,H.jsx)(`td`,{"data-label":`School Year`,children:e.schoolYear||`—`}),(0,H.jsx)(`td`,{"data-label":`School ID File`,children:e.frontIdUrl?(0,H.jsx)(`a`,{className:`admin-file-link`,href:e.frontIdUrl,rel:`noreferrer`,target:`_blank`,children:`View file`}):(0,H.jsx)(`span`,{className:`admin-file-empty`,children:`No file`})}),(0,H.jsx)(`td`,{"data-label":`Actions`,children:(0,H.jsxs)(`div`,{className:`admin-row-actions`,children:[(0,H.jsx)(`button`,{className:`admin-edit-button`,type:`button`,onClick:()=>mr(e),children:`Edit`}),(0,H.jsxs)(`label`,{className:`admin-checkbox-control`,children:[(0,H.jsx)(`input`,{type:`checkbox`,checked:L.includes(e._id),onChange:()=>_r(e._id)}),(0,H.jsx)(`span`,{children:`Check`})]}),(0,H.jsx)(`button`,{className:`admin-delete-button`,type:`button`,disabled:P||!L.includes(e._id),onClick:vr,children:`Delete`})]})})]},e._id))]})]})}),(0,H.jsxs)(`div`,{className:`admin-pagination`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:jt}),` to `,(0,H.jsx)(`strong`,{children:Mt}),` of`,` `,(0,H.jsx)(`strong`,{children:xt.length}),` results`]}),te&&(0,H.jsx)(`p`,{className:`admin-delete-message`,children:te})]}),(0,H.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,H.jsx)(`button`,{type:`button`,disabled:Ct===1||xt.length===0,"aria-label":`Previous page`,onClick:()=>un(Ct-1),children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Tt.map(e=>{if(typeof e==`string`)return(0,H.jsx)(`span`,{className:`admin-pagination__ellipsis`,children:`...`},e);let t=e;return(0,H.jsx)(`button`,{"aria-current":Ct===t?`page`:void 0,className:Ct===t?`admin-page-button--active`:void 0,disabled:xt.length===0,onClick:()=>un(t),type:`button`,children:t},t)}),(0,H.jsx)(`button`,{type:`button`,disabled:Ct===St||xt.length===0,"aria-label":`Next page`,onClick:()=>un(Ct+1),children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]})]})]})}),r&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-logs-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close logs modal`,className:`admin-modal-backdrop`,onClick:()=>i(!1),type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--wide`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Activity Logs`}),(0,H.jsx)(`h2`,{id:`admin-logs-title`,children:`System Activity Records`}),(0,H.jsx)(`p`,{children:`Review recent uploads, edits, deletes, student updates, and page actions.`})]}),(0,H.jsx)(`button`,{"aria-label":`Close logs`,className:`admin-modal-close`,onClick:()=>i(!1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsxs)(`div`,{className:`admin-logs-toolbar`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{children:`Log Management`}),(0,H.jsx)(`strong`,{children:`Permanently remove all system activity records.`})]}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--danger`,disabled:Le===void 0||Ze.length===0||I,onClick:tr,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`delete_sweep`}),I?`Clearing...`:`Clear All Logs`]})]}),(0,H.jsx)(`div`,{className:`admin-logs-table-wrap`,children:(0,H.jsxs)(`table`,{className:`admin-logs-table`,children:[(0,H.jsx)(`thead`,{children:(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`th`,{children:`Date & Time`}),(0,H.jsx)(`th`,{children:`Action`}),(0,H.jsx)(`th`,{children:`Actor`}),(0,H.jsx)(`th`,{children:`Target`}),(0,H.jsx)(`th`,{children:`Summary`})]})}),(0,H.jsxs)(`tbody`,{children:[Le===void 0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`admin-empty-state`,colSpan:5,children:`Loading activity logs...`})}),Le&&Ze.length===0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`admin-empty-state`,colSpan:5,children:`No activity logs recorded yet.`})}),Ht.map(e=>(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`td`,{"data-label":`Date & Time`,children:Hn(e.createdAt)}),(0,H.jsx)(`td`,{"data-label":`Action`,children:(0,H.jsx)(`span`,{className:`admin-log-action`,children:e.action})}),(0,H.jsxs)(`td`,{"data-label":`Actor`,children:[(0,H.jsx)(`strong`,{children:e.actorName||e.actorId||e.actorRole}),(0,H.jsx)(`span`,{children:e.actorRole})]}),(0,H.jsxs)(`td`,{"data-label":`Target`,children:[(0,H.jsx)(`strong`,{children:e.targetLabel||e.targetType}),(0,H.jsx)(`span`,{children:e.targetType})]}),(0,H.jsx)(`td`,{"data-label":`Summary`,children:e.summary})]},e._id))]})]})}),(0,H.jsxs)(`div`,{className:`admin-pagination admin-logs-pagination`,children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:Ut}),` to `,(0,H.jsx)(`strong`,{children:Wt}),` of`,` `,(0,H.jsx)(`strong`,{children:Ze.length}),` logs`]}),(0,H.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,H.jsx)(`button`,{type:`button`,disabled:Bt===1||Ze.length===0,"aria-label":`Previous logs page`,onClick:()=>mn(Bt-1),children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:zt},(e,t)=>{let n=t+1;return(0,H.jsx)(`button`,{className:Bt===n?`admin-page-button--active`:void 0,disabled:Ze.length===0,onClick:()=>mn(n),type:`button`,children:n},n)}),(0,H.jsx)(`button`,{type:`button`,disabled:Bt===zt||Ze.length===0,"aria-label":`Next logs page`,onClick:()=>mn(Bt+1),children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]})]})]}),_&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-batch-export-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close batch export modal`,className:`admin-modal-backdrop`,onClick:()=>v(!1),type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Batch CSV Export`}),(0,H.jsx)(`h2`,{id:`admin-batch-export-title`,children:`Choose Batch`}),(0,H.jsx)(`p`,{children:`Export student account information for a specific batch using allinfo Student IDs.`})]}),(0,H.jsx)(`button`,{"aria-label":`Close batch export`,className:`admin-modal-close`,onClick:()=>v(!1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsx)(`div`,{className:`admin-school-year-downloads`,children:Jt.map(({accountCount:e,batchId:t,recordCount:n})=>(0,H.jsxs)(`button`,{className:`admin-school-year-button`,disabled:Ve===void 0,onClick:()=>kn(t),type:`button`,children:[(0,H.jsx)(`span`,{children:t}),(0,H.jsx)(`strong`,{children:Ve===void 0?`Loading accounts...`:`${n} records / ${e} accounts`})]},t))}),(0,H.jsxs)(`div`,{className:`admin-pagination admin-batch-export-pagination`,children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:Yt}),`-`,(0,H.jsx)(`strong`,{children:Xt}),` `,`of `,(0,H.jsx)(`strong`,{children:ut.length}),` batches`]}),(0,H.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,H.jsx)(`button`,{disabled:Kt===1,onClick:()=>hn(Kt-1),type:`button`,"aria-label":`Previous batch export page`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:Gt},(e,t)=>{let n=t+1;return(0,H.jsx)(`button`,{"aria-current":Kt===n?`page`:void 0,className:Kt===n?`admin-page-button--active`:void 0,onClick:()=>hn(n),type:`button`,children:n},n)}),(0,H.jsx)(`button`,{disabled:Kt===Gt,onClick:()=>hn(Kt+1),type:`button`,"aria-label":`Next batch export page`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,H.jsx)(`div`,{className:`admin-upload-actions`,children:(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:()=>v(!1),type:`button`,children:`Cancel`})})]})]}),y&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-batch-delete-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close batch delete modal`,className:`admin-modal-backdrop`,onClick:sr,type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Delete Batch`}),(0,H.jsx)(`h2`,{id:`admin-batch-delete-title`,children:`Choose Batch`}),(0,H.jsx)(`p`,{children:`Select a batch to delete all information records under that batch.`})]}),(0,H.jsx)(`button`,{"aria-label":`Close batch delete`,className:`admin-modal-close`,disabled:P,onClick:sr,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsx)(`div`,{className:`admin-school-year-downloads`,children:Jt.map(({batchId:e,recordCount:t})=>(0,H.jsxs)(`button`,{className:`admin-school-year-button admin-school-year-button--danger`,disabled:P,onClick:()=>O({batchId:e,recordCount:t}),type:`button`,children:[(0,H.jsx)(`span`,{children:e}),(0,H.jsxs)(`strong`,{children:[t,` `,t===1?`record`:`records`]})]},e))}),(0,H.jsxs)(`div`,{className:`admin-pagination admin-batch-export-pagination`,children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:Yt}),`-`,(0,H.jsx)(`strong`,{children:Xt}),` `,`of `,(0,H.jsx)(`strong`,{children:ut.length}),` batches`]}),(0,H.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,H.jsx)(`button`,{"aria-label":`Previous batch delete page`,disabled:Kt===1||P,onClick:()=>hn(Kt-1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:Gt},(e,t)=>{let n=t+1;return(0,H.jsx)(`button`,{"aria-current":Kt===n?`page`:void 0,className:Kt===n?`admin-page-button--active`:void 0,disabled:P,onClick:()=>hn(n),type:`button`,children:n},n)}),(0,H.jsx)(`button`,{"aria-label":`Next batch delete page`,disabled:Kt===Gt||P,onClick:()=>hn(Kt+1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,H.jsx)(`div`,{className:`admin-upload-actions`,children:(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:P,onClick:sr,type:`button`,children:`Cancel`})})]})]}),D&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-batch-delete-confirm-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close batch delete confirmation`,className:`admin-modal-backdrop`,onClick:()=>{P||O(null)},type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--compact admin-modal-card--applicant-years`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Confirm Delete`}),(0,H.jsx)(`h2`,{id:`admin-batch-delete-confirm-title`,children:`Delete this batch information?`}),(0,H.jsx)(`p`,{children:`Are you sure you want to delete this batch information?`})]}),(0,H.jsx)(`button`,{"aria-label":`Close batch delete confirmation`,className:`admin-modal-close`,disabled:P,onClick:()=>O(null),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsxs)(`div`,{className:`admin-confirm-body`,children:[(0,H.jsx)(`strong`,{children:D.batchId}),(0,H.jsxs)(`p`,{children:[`This will permanently delete `,D.recordCount,` `,D.recordCount===1?`record`:`records`,` from this batch.`]})]}),(0,H.jsxs)(`div`,{className:`admin-upload-actions`,children:[(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:P,onClick:()=>O(null),type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`admin-button admin-button--danger`,disabled:P,onClick:async()=>{if(!D)return;let e=D.batchId,t=Ye.filter(t=>String(t.batchId??``).trim()===e).map(e=>e._id);if(t.length===0){M(`No records found for this batch.`),O(null);return}re(!0),M(`Deleting batch ${e}...`);try{let n=await Ge({ids:t});ue(e=>e.filter(e=>!t.includes(e))),M(`${n?.deleted??t.length} record${(n?.deleted??t.length)===1?``:`s`} deleted from batch ${e}.`),O(null),b(!1),se(1)}catch(e){M(e instanceof Error?e.message:`Unable to delete batch records.`)}finally{re(!1)}},type:`button`,children:P?`Deleting...`:`Delete Batch`})]})]})]}),s&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-unifast-open-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close UNIFAST portal confirmation`,className:`admin-modal-backdrop`,onClick:ar,type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--compact`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`UNIFAST Portal`}),(0,H.jsx)(`h2`,{id:`admin-unifast-open-title`,children:`Open the portal?`}),(0,H.jsx)(`p`,{children:`Do you want to open the portal for receiving applicants information?`})]}),(0,H.jsx)(`button`,{"aria-label":`Close UNIFAST portal confirmation`,className:`admin-modal-close`,onClick:ar,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsx)(`div`,{className:`admin-confirm-body`,children:(0,H.jsx)(`p`,{children:`Select Yes to view applicants by course and prepare a course download.`})}),(0,H.jsxs)(`div`,{className:`admin-upload-actions`,children:[(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:ar,type:`button`,children:`No`}),(0,H.jsx)(`button`,{className:`admin-button admin-button--primary`,onClick:()=>{c(!1),u(!0)},type:`button`,children:`Yes`})]})]})]}),l&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-unifast-courses-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close UNIFAST portal courses`,className:`admin-modal-backdrop`,onClick:ar,type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Receiving Applicants Information`}),(0,H.jsx)(`h2`,{id:`admin-unifast-courses-title`,children:`Choose Course`}),(0,H.jsxs)(`p`,{children:[`Select a specific course to download applicant information for `,tt,`.`]})]}),(0,H.jsx)(`button`,{"aria-label":`Close UNIFAST portal courses`,className:`admin-modal-close`,onClick:ar,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsxs)(`div`,{className:`admin-applicant-portal-controls`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{children:`Landing Portal Status`}),(0,H.jsx)(`strong`,{children:Be?.isReceivingApplicants?`Receiving ${tt} applicants`:`Closed for applicants`})]}),(0,H.jsxs)(`div`,{className:`admin-applicant-portal-actions`,children:[(0,H.jsx)(`button`,{className:`admin-button admin-button--primary`,disabled:Be===void 0||Be?.isReceivingApplicants,onClick:()=>{Fe(1),f(!0)},type:`button`,children:`Receive Applicants`}),(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:Be===void 0||!Be?.isReceivingApplicants,onClick:()=>rr(!1),type:`button`,children:`Close Applicants`})]})]}),(0,H.jsx)(`div`,{className:`admin-school-year-downloads admin-course-downloads`,children:dt.map(({applicantCount:e,course:t})=>(0,H.jsxs)(`button`,{className:`admin-school-year-button`,disabled:ze===void 0,onClick:()=>bn(t),type:`button`,children:[(0,H.jsx)(`span`,{children:t}),(0,H.jsx)(`strong`,{children:ze===void 0?`Loading...`:`${e} ${e===1?`applicant`:`applicants`}`})]},t))}),(0,H.jsx)(`div`,{className:`admin-upload-actions`,children:(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:ar,type:`button`,children:`Cancel`})})]})]}),d&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-applicant-year-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close applicant year selection`,className:`admin-modal-backdrop`,onClick:()=>{f(!1),Fe(1)},type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--compact`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Receive Applicants`}),(0,H.jsx)(`h2`,{id:`admin-applicant-year-title`,children:`Choose Application Year`}),(0,H.jsx)(`p`,{children:`Select the year for the new applicant cycle. Counts and downloads will use this year.`})]}),(0,H.jsx)(`button`,{"aria-label":`Close applicant year selection`,className:`admin-modal-close`,onClick:()=>{f(!1),Fe(1)},type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsx)(`div`,{className:`admin-year-options`,children:at.map(e=>(0,H.jsxs)(`button`,{className:`admin-year-option`,onClick:()=>ir(e),type:`button`,children:[(0,H.jsx)(`span`,{children:e}),(0,H.jsxs)(`strong`,{children:[Qe.filter(t=>$n(t)===e).length,` `,`existing applicants`]})]},e))}),(0,H.jsxs)(`div`,{className:`admin-pagination admin-applicant-year-pagination`,children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:st}),` to`,` `,(0,H.jsx)(`strong`,{children:ct}),` of`,` `,(0,H.jsx)(`strong`,{children:nt.length}),` years`]}),(0,H.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,H.jsx)(`button`,{"aria-label":`Previous application years page`,disabled:z===1||nt.length===0,onClick:()=>yn(z-1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),ot.map(e=>typeof e==`number`?(0,H.jsx)(`button`,{className:z===e?`admin-page-button--active`:void 0,disabled:nt.length===0,onClick:()=>yn(e),type:`button`,children:e},e):(0,H.jsx)(`span`,{className:`admin-pagination__ellipsis`,children:`...`},e)),(0,H.jsx)(`button`,{"aria-label":`Next application years page`,disabled:z===rt||nt.length===0,onClick:()=>yn(z+1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,H.jsx)(`div`,{className:`admin-upload-actions`,children:(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:()=>{f(!1),Fe(1)},type:`button`,children:`Cancel`})})]})]}),p&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-course-applicants-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close course applicants`,className:`admin-modal-backdrop`,onClick:xn,type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card admin-course-applicants-modal`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Course Applicants Information`}),(0,H.jsx)(`h2`,{id:`admin-course-applicants-title`,children:`Applicants Table`}),(0,H.jsxs)(`p`,{children:[p,` applicants for `,tt,`.`]})]}),(0,H.jsx)(`button`,{"aria-label":`Close course applicants`,className:`admin-modal-close`,onClick:xn,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsxs)(`div`,{className:`admin-course-applicants-toolbar`,children:[(0,H.jsxs)(`div`,{className:`admin-search-field admin-course-applicant-search`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`search`}),(0,H.jsx)(`input`,{"aria-label":`Search course applicants`,placeholder:`Search applicant name, ID, email, mobile, status...`,type:`search`,value:Ae,onChange:Sn})]}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--primary`,disabled:ze===void 0||ft.length===0,onClick:()=>An(p),type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`download`}),`Download All Applicants Info`]})]}),(0,H.jsxs)(`div`,{className:`admin-course-applicants-summary`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{children:`Total Course Applicants`}),(0,H.jsx)(`strong`,{children:ft.length})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{children:`Filtered Results`}),(0,H.jsx)(`strong`,{children:pt.length})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{children:`Rows Per Page`}),(0,H.jsx)(`strong`,{children:zn})]})]}),(0,H.jsx)(`div`,{className:`admin-course-applicants-table-wrap`,children:(0,H.jsxs)(`table`,{className:`admin-course-applicants-table`,children:[(0,H.jsx)(`thead`,{children:(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`th`,{children:`No.`}),(0,H.jsx)(`th`,{children:`Student ID`}),(0,H.jsx)(`th`,{children:`Applicant Name`}),(0,H.jsx)(`th`,{children:`Gender`}),(0,H.jsx)(`th`,{children:`Birth Date`}),(0,H.jsx)(`th`,{children:`Year`}),(0,H.jsx)(`th`,{children:`Mobile No.`}),(0,H.jsx)(`th`,{children:`Email Address`}),(0,H.jsx)(`th`,{children:`Address`}),(0,H.jsx)(`th`,{children:`PSA`}),(0,H.jsx)(`th`,{children:`School ID`}),(0,H.jsx)(`th`,{children:`PWD ID PDF`}),(0,H.jsx)(`th`,{children:`4Ps ID PDF`}),(0,H.jsx)(`th`,{children:`Status`}),(0,H.jsx)(`th`,{children:`Submitted`})]})}),(0,H.jsxs)(`tbody`,{children:[ze===void 0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`admin-empty-state`,colSpan:15,children:`Loading applicants...`})}),ze!==void 0&&pt.length===0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`admin-empty-state`,colSpan:15,children:`No applicants found for this course.`})}),_t.map((e,t)=>{let n=[e.firstName,e.middleName,e.lastName,e.extensionName].filter(Boolean).join(` `)||`No name`;return(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`td`,{"data-label":`No.`,children:gt+t+1}),(0,H.jsx)(`td`,{"data-label":`Student ID`,children:e.studentId}),(0,H.jsx)(`td`,{className:`admin-applicant-name`,"data-label":`Applicant Name`,children:n}),(0,H.jsx)(`td`,{"data-label":`Gender`,children:e.gender}),(0,H.jsx)(`td`,{"data-label":`Birth Date`,children:e.birthDate}),(0,H.jsx)(`td`,{"data-label":`Year`,children:e.year}),(0,H.jsx)(`td`,{"data-label":`Mobile No.`,children:e.mobileNumber}),(0,H.jsx)(`td`,{className:`admin-applicant-email`,"data-label":`Email Address`,children:e.emailAddress}),(0,H.jsx)(`td`,{className:`admin-applicant-address`,"data-label":`Address`,children:e.address}),(0,H.jsx)(`td`,{"data-label":`PSA`,children:e.psaFileUrl?(0,H.jsxs)(`a`,{className:`admin-applicant-file-link`,href:e.psaFileUrl,rel:`noreferrer`,target:`_blank`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`picture_as_pdf`}),`View PSA`]}):(0,H.jsx)(`span`,{className:`admin-applicant-file-missing`,children:`No file`})}),(0,H.jsx)(`td`,{"data-label":`School ID`,children:e.schoolIdFileUrl?(0,H.jsxs)(`a`,{className:`admin-applicant-file-link`,href:e.schoolIdFileUrl,rel:`noreferrer`,target:`_blank`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`badge`}),`View School ID`]}):(0,H.jsx)(`span`,{className:`admin-applicant-file-missing`,children:`No file`})}),(0,H.jsx)(`td`,{"data-label":`PWD ID PDF`,children:e.pwdIdFileUrl?(0,H.jsxs)(`a`,{className:`admin-applicant-file-link`,href:e.pwdIdFileUrl,rel:`noreferrer`,target:`_blank`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`accessible`}),`View PWD ID`]}):(0,H.jsx)(`span`,{className:`admin-applicant-file-missing`,children:`Optional`})}),(0,H.jsx)(`td`,{"data-label":`4Ps ID PDF`,children:e.fourPsFileUrl?(0,H.jsxs)(`a`,{className:`admin-applicant-file-link`,href:e.fourPsFileUrl,rel:`noreferrer`,target:`_blank`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`family_restroom`}),`View 4Ps ID`]}):(0,H.jsx)(`span`,{className:`admin-applicant-file-missing`,children:`Optional`})}),(0,H.jsx)(`td`,{"data-label":`Status`,children:(0,H.jsx)(Wn,{status:e.status,tone:Gn(e.status)})}),(0,H.jsx)(`td`,{"data-label":`Submitted`,children:Kn(e.submittedAt)})]},e._id)})]})]})}),(0,H.jsxs)(`div`,{className:`admin-pagination admin-course-applicants-pagination`,children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:yt}),` to`,` `,(0,H.jsx)(`strong`,{children:bt}),` of`,` `,(0,H.jsx)(`strong`,{children:pt.length}),` applicants`]}),(0,H.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,H.jsx)(`button`,{"aria-label":`Previous course applicants page`,disabled:ht===1||pt.length===0,onClick:()=>vn(ht-1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),vt.map(e=>typeof e==`number`?(0,H.jsx)(`button`,{className:ht===e?`admin-page-button--active`:void 0,disabled:pt.length===0,onClick:()=>vn(e),type:`button`,children:e},e):(0,H.jsx)(`span`,{className:`admin-pagination__ellipsis`,children:`...`},e)),(0,H.jsx)(`button`,{"aria-label":`Next course applicants page`,disabled:ht===mt||pt.length===0,onClick:()=>vn(ht+1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,H.jsx)(`div`,{className:`admin-upload-actions`,children:(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:xn,type:`button`,children:`Close`})})]})]}),x&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-school-id-download-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close School ID download modal`,className:`admin-modal-backdrop`,onClick:wn,type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`School ID Files`}),(0,H.jsx)(`h2`,{id:`admin-school-id-download-title`,children:`Choose School Year`}),(0,H.jsx)(`p`,{children:`Download all uploaded School ID files for a specific School Year.`})]}),(0,H.jsx)(`button`,{"aria-label":`Close School ID download`,className:`admin-modal-close`,disabled:T,onClick:wn,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsx)(`div`,{className:`admin-school-year-downloads`,children:en.map(({fileCount:e,schoolYear:t})=>(0,H.jsxs)(`button`,{className:`admin-school-year-button`,disabled:T,onClick:()=>Cn(t),type:`button`,children:[(0,H.jsx)(`span`,{children:t}),(0,H.jsx)(`strong`,{children:T?`Preparing...`:`${e} ${e===1?`file`:`files`}`})]},t))}),(0,H.jsxs)(`div`,{className:`admin-pagination admin-school-id-pagination`,children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:tn}),`-`,(0,H.jsx)(`strong`,{children:nn}),` of`,` `,(0,H.jsx)(`strong`,{children:kt.length}),` school years`]}),(0,H.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,H.jsx)(`button`,{"aria-label":`Previous School ID page`,disabled:Qt===1||T,onClick:()=>gn(Qt-1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:Zt},(e,t)=>{let n=t+1;return(0,H.jsx)(`button`,{"aria-current":Qt===n?`page`:void 0,className:Qt===n?`admin-page-button--active`:void 0,disabled:T,onClick:()=>gn(n),type:`button`,children:n},n)}),(0,H.jsx)(`button`,{"aria-label":`Next School ID page`,disabled:Qt===Zt||T,onClick:()=>gn(Qt+1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,H.jsx)(`div`,{className:`admin-upload-actions`,children:(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:T,onClick:wn,type:`button`,children:`Cancel`})})]})]}),C&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-school-id-batch-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close School ID batch modal`,className:`admin-modal-backdrop`,onClick:()=>{T||w(``)},type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`School ID Files`}),(0,H.jsx)(`h2`,{id:`admin-school-id-batch-title`,children:`Choose Batch`}),(0,H.jsxs)(`p`,{children:[`Download uploaded School ID files for `,C,` by batch. File names include Student ID, last name, first name, middle name, and batch no.`]})]}),(0,H.jsx)(`button`,{"aria-label":`Close School ID batch download`,className:`admin-modal-close`,disabled:T,onClick:()=>w(``),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsxs)(`div`,{className:`admin-school-year-downloads`,children:[sn.map(({batchId:e,fileCount:t})=>(0,H.jsxs)(`button`,{className:`admin-school-year-button`,disabled:T,onClick:()=>On(C,e),type:`button`,children:[(0,H.jsx)(`span`,{children:e}),(0,H.jsx)(`strong`,{children:T?`Preparing...`:`${t} ${t===1?`file`:`files`}`})]},e)),At.length===0&&(0,H.jsx)(`div`,{className:`admin-modal-empty-state`,children:`No batches with uploaded School ID files were found for this School Year.`})]}),(0,H.jsxs)(`div`,{className:`admin-pagination admin-school-id-pagination`,children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:cn}),`-`,(0,H.jsx)(`strong`,{children:ln}),` of`,` `,(0,H.jsx)(`strong`,{children:At.length}),` batches`]}),(0,H.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,H.jsx)(`button`,{"aria-label":`Previous School ID batch page`,disabled:an===1||T,onClick:()=>_n(an-1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:rn},(e,t)=>{let n=t+1;return(0,H.jsx)(`button`,{"aria-current":an===n?`page`:void 0,className:an===n?`admin-page-button--active`:void 0,disabled:T,onClick:()=>_n(n),type:`button`,children:n},n)}),(0,H.jsx)(`button`,{"aria-label":`Next School ID batch page`,disabled:an===rn||T,onClick:()=>_n(an+1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,H.jsx)(`div`,{className:`admin-upload-actions`,children:(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:T,onClick:()=>w(``),type:`button`,children:`Back`})})]})]}),de&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-edit-record-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close edit record modal`,className:`admin-modal-backdrop`,onClick:fr,type:`button`}),(0,H.jsxs)(`form`,{className:`admin-modal-card admin-modal-card--edit`,onSubmit:gr,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header admin-modal-header--edit`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Edit Record`}),(0,H.jsx)(`h2`,{id:`admin-edit-record-title`,children:`Edit Grantee Information`}),(0,H.jsx)(`p`,{children:`Update the selected grantee record details.`})]}),(0,H.jsx)(`button`,{"aria-label":`Close edit record`,className:`admin-modal-close`,disabled:_e,onClick:fr,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsxs)(`div`,{className:`admin-edit-summary`,children:[(0,H.jsx)(`div`,{className:`admin-edit-summary__icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`person`})}),(0,H.jsxs)(`div`,{className:`admin-edit-summary__text`,children:[(0,H.jsx)(`span`,{children:`Selected Record`}),(0,H.jsx)(`strong`,{children:de.studentId||`No Student ID`}),(0,H.jsx)(Wn,{status:de.status,tone:Gn(de.status)})]})]}),(0,H.jsxs)(`div`,{className:`admin-record-details admin-record-details--responsive`,children:[(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`No.`}),(0,H.jsx)(`input`,{value:pe?.no??``,onChange:hr(`no`)})]}),(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`TES Award Number`}),(0,H.jsx)(`input`,{value:pe?.tesAwardNumber??``,onChange:hr(`tesAwardNumber`)})]}),(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`Student ID`}),(0,H.jsx)(`input`,{value:pe?.studentId??``,onChange:hr(`studentId`)})]}),(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`Last Name`}),(0,H.jsx)(`input`,{value:pe?.lastName??``,onChange:hr(`lastName`)})]}),(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`First Name`}),(0,H.jsx)(`input`,{value:pe?.firstName??``,onChange:hr(`firstName`)})]}),(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`MI.`}),(0,H.jsx)(`input`,{value:pe?.middleInitial??``,onChange:hr(`middleInitial`)})]}),(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`Batch No.`}),(0,H.jsx)(`input`,{value:pe?.batchId??``,onChange:hr(`batchId`)})]}),(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`Status`}),(0,H.jsxs)(`select`,{value:pe?.status??``,onChange:hr(`status`),children:[(0,H.jsx)(`option`,{value:``,children:`Select Status`}),(0,H.jsx)(`option`,{children:`Grantee`}),(0,H.jsx)(`option`,{children:`Validated`}),(0,H.jsx)(`option`,{children:`Pending`}),(0,H.jsx)(`option`,{children:`Rejected`})]})]}),(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`Semester`}),(0,H.jsx)(`input`,{value:pe?.semester??``,onChange:hr(`semester`)})]}),(0,H.jsxs)(`label`,{children:[(0,H.jsx)(`span`,{children:`School Year`}),(0,H.jsx)(`input`,{value:pe?.schoolYear??``,onChange:hr(`schoolYear`)})]})]}),he&&(0,H.jsx)(`p`,{className:`admin-edit-message`,children:he}),(0,H.jsxs)(`div`,{className:`admin-upload-actions admin-upload-actions--sticky`,children:[(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:_e,onClick:fr,type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`admin-button admin-button--primary`,disabled:_e,type:`submit`,children:_e?`Saving...`:`Save Changes`})]})]})]}),h&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-add-record-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close add record modal`,className:`admin-modal-backdrop`,onClick:ur,type:`button`}),(0,H.jsxs)(`form`,{className:`admin-modal-card`,onSubmit:async e=>{if(e.preventDefault(),!k){j(`Select a CSV file before uploading.`);return}if(!k.name.toLowerCase().endsWith(`.csv`)){j(`Please upload the downloaded CSV template file.`);return}ne(!0),j(`Reading file...`);try{let e=dr(await k.text());if(e.length===0){j(`No valid rows found. Use the CSV template headers and add record values.`);return}let t=await Ue({records:e});j(`${t.inserted} record${t.inserted===1?``:`s`} saved to allinfo.`),ee(null)}catch(e){j(e instanceof Error?e.message:`Unable to upload records.`)}finally{ne(!1)}},children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Add New Record`}),(0,H.jsx)(`h2`,{id:`admin-add-record-title`,children:`Upload CSV File`}),(0,H.jsx)(`p`,{children:`Use the required template format before uploading grantee records.`})]}),(0,H.jsx)(`button`,{"aria-label":`Close add record`,className:`admin-modal-close`,disabled:N,onClick:ur,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsxs)(`div`,{className:`admin-upload-body`,children:[(0,H.jsxs)(`button`,{className:`admin-button admin-button--secondary`,onClick:Yn,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`download`}),`Download CSV Template`]}),(0,H.jsxs)(`label`,{className:`admin-upload-dropzone`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`upload_file`}),(0,H.jsx)(`strong`,{children:k?k.name:`Choose CSV file`}),(0,H.jsx)(`span`,{children:`Accepted format: downloaded CSV template`}),(0,H.jsx)(`input`,{accept:`.csv,text/csv`,disabled:N,onChange:e=>{let t=e.target.files?.[0]??null;ee(t),j(t?`${t.name} is ready to upload.`:``)},type:`file`})]}),(0,H.jsx)(`div`,{className:`admin-template-preview`,"aria-label":`CSV template headers`,children:Un.map(e=>(0,H.jsx)(`span`,{children:e},e))}),A&&(0,H.jsx)(`p`,{className:`admin-upload-message`,children:A})]}),(0,H.jsxs)(`div`,{className:`admin-upload-actions`,children:[(0,H.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:N,onClick:ur,type:`button`,children:`Cancel`}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--primary`,disabled:N,type:`submit`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`upload`}),N?`Uploading...`:`Upload`]})]})]})]}),a&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-quick-actions-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close quick actions modal`,className:`admin-modal-backdrop`,onClick:()=>o(!1),type:`button`}),(0,H.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--wide`,children:[(0,H.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`admin-modal-kicker`,children:`Quick Actions`}),(0,H.jsx)(`h2`,{id:`admin-quick-actions-title`,children:`Student Requests`}),(0,H.jsx)(`p`,{children:`Review submitted questions and requests from the student portal.`})]}),(0,H.jsx)(`button`,{"aria-label":`Close quick actions`,className:`admin-modal-close`,onClick:()=>o(!1),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsxs)(`div`,{className:`admin-quick-actions-summary`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{children:`Total Requests`}),(0,H.jsx)(`strong`,{children:Ie?.length??0})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{children:`Source`}),(0,H.jsx)(`strong`,{children:`Student Portal`})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{children:`Status`}),(0,H.jsx)(`strong`,{children:`Live Data`})]})]}),(0,H.jsxs)(`div`,{className:`admin-quick-actions-toolbar`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`span`,{children:`Export Report`}),(0,H.jsx)(`strong`,{children:`Download all student responses with email accounts.`})]}),(0,H.jsxs)(`div`,{className:`admin-quick-actions-toolbar__actions`,children:[(0,H.jsxs)(`button`,{className:`admin-button admin-button--primary`,disabled:Ie===void 0||Xe.length===0||ie,onClick:Mn,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`download`}),`Export All Responses`]}),(0,H.jsxs)(`button`,{className:`admin-button admin-button--danger`,disabled:Ie===void 0||Xe.length===0||ie,onClick:qn,type:`button`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`delete_sweep`}),ie?`Clearing...`:`Clear All Messages`]})]})]}),(0,H.jsx)(`div`,{className:`admin-quick-actions-table-wrap`,children:(0,H.jsxs)(`table`,{className:`admin-quick-actions-table`,children:[(0,H.jsx)(`thead`,{children:(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`th`,{children:`No.`}),(0,H.jsx)(`th`,{children:`Student Details`}),(0,H.jsx)(`th`,{children:`Email Account`}),(0,H.jsx)(`th`,{children:`Question`}),(0,H.jsx)(`th`,{children:`Source`}),(0,H.jsx)(`th`,{children:`Status`}),(0,H.jsx)(`th`,{children:`Submitted`})]})}),(0,H.jsxs)(`tbody`,{children:[Ie===void 0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`admin-empty-state`,colSpan:7,children:`Loading quick actions...`})}),Ie?.length===0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`admin-empty-state`,colSpan:7,children:`No quick action requests yet.`})}),It.map((e,t)=>(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`td`,{"data-label":`No.`,children:Ft+t+1}),(0,H.jsxs)(`td`,{className:`admin-request-student`,"data-label":`Student Details`,children:[(0,H.jsx)(`strong`,{children:Zn(e)||`Not provided`}),(0,H.jsx)(`span`,{children:e.studentId||`No Student ID`})]}),(0,H.jsx)(`td`,{className:`admin-request-email`,"data-label":`Email Account`,children:e.email}),(0,H.jsx)(`td`,{className:`admin-request-question`,"data-label":`Question`,children:e.question}),(0,H.jsx)(`td`,{"data-label":`Source`,children:e.source}),(0,H.jsx)(`td`,{"data-label":`Status`,children:(0,H.jsx)(Wn,{status:e.status,tone:Gn(e.status)})}),(0,H.jsx)(`td`,{"data-label":`Submitted`,children:Kn(e.submittedAt)})]},e._id))]})]})}),(0,H.jsxs)(`div`,{className:`admin-pagination admin-quick-actions-pagination`,children:[(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:Lt}),` to`,` `,(0,H.jsx)(`strong`,{children:Rt}),` of`,` `,(0,H.jsx)(`strong`,{children:Xe.length}),` requests`]}),(0,H.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,H.jsx)(`button`,{type:`button`,disabled:Pt===1||Xe.length===0,"aria-label":`Previous quick actions page`,onClick:()=>pn(Pt-1),children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:Nt},(e,t)=>{let n=t+1;return(0,H.jsx)(`button`,{className:Pt===n?`admin-page-button--active`:void 0,disabled:Xe.length===0,onClick:()=>pn(n),type:`button`,children:n},n)}),(0,H.jsx)(`button`,{type:`button`,disabled:Pt===Nt||Xe.length===0,"aria-label":`Next quick actions page`,onClick:()=>pn(Pt+1),children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]})]})]}),(0,H.jsx)(`div`,{className:`admin-scroll-progress`,style:{"--admin-scroll":t}})]})}var pr=`
...
`,mr={quickActions:{table:`quickActions`,source:`all-grantee-information-header`,defaultStatus:`new`,fields:{email:{label:`Email account`,type:`email`,required:!0,placeholder:`name@example.com`},question:{label:`Question`,type:`textarea`,required:!0,placeholder:`Type your question or request here...`}}}};function hr(e){let t=(0,An.c)(4),{status:n,tone:r}=e,i=`status-badge status-badge--${r}`,a;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(a=(0,H.jsx)(`span`,{className:`status-badge__dot`}),t[0]=a):a=t[0];let o;return t[1]!==n||t[2]!==i?(o=(0,H.jsxs)(`span`,{className:i,children:[a,n]}),t[1]=n,t[2]=i,t[3]=o):o=t[3],o}function gr(e=``){let t=e.toLowerCase();return t.includes(`grantee`)||t.includes(`valid`)||t.includes(`complete`)||t.includes(`resolved`)||t.includes(`approved`)?`validated`:t.includes(`reject`)||t.includes(`decline`)?`rejected`:`pending`}function _r(e,t){let n=[];if(t<=5){for(let e=1;e<=t;e+=1)n.push(e);return n}n.push(1),e>3&&n.push(`left-ellipsis`);let r=Math.max(2,e-1),i=Math.min(t-1,e+1);for(let e=r;e<=i;e+=1)n.push(e);return e<t-2&&n.push(`right-ellipsis`),n.push(t),n}function vr(e){return/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/i.test(e)}function yr(e){return/^[A-Za-z0-9-]{4,30}$/.test(e)}function br(e){return e.replace(/[\s-]/g,``).trim()}function xr(e){return e.replace(/[^\d+]/g,``).replace(/(?!^)\+/g,``)}function Sr(e){return e.replace(/[\r\n]+/g,` `).replace(/\s{2,}/g,` `)}function Cr(e){let t=br(e);return/^09\d{9}$/.test(t)||/^\+639\d{9}$/.test(t)}var wr=5*1024*1024;function Tr(e){return e?e.type===`application/pdf`||/\.pdf$/i.test(e.name):!1}function Er(e){if(!e)return``;let t=e/(1024*1024);return`${t.toFixed(t>=10?0:1)} MB`}function Dr(e){return e.length>=6}function Or(e,t,n){let r,i=new Promise((e,i)=>{r=setTimeout(()=>i(Error(n)),t)});return Promise.race([e,i]).finally(()=>clearTimeout(r))}var kr=[{label:`Student ID`,name:`studentId`,autoComplete:`off`,required:!0},{label:`Last Name`,name:`lastName`,autoComplete:`family-name`,required:!0},{label:`First Name`,name:`firstName`,autoComplete:`given-name`,required:!0},{label:`Ext Name (JR)`,name:`extensionName`,autoComplete:`honorific-suffix`},{label:`Middle Name`,name:`middleName`,autoComplete:`additional-name`}],Ar=[{label:`Last Name`,name:`fatherLastName`,autoComplete:`family-name`},{label:`First Name`,name:`fatherFirstName`,autoComplete:`given-name`},{label:`Middle Name`,name:`fatherMiddleName`,autoComplete:`additional-name`}],jr=[{label:`Last Name`,name:`motherLastName`,autoComplete:`family-name`},{label:`First Name`,name:`motherFirstName`,autoComplete:`given-name`},{label:`Middle Name`,name:`motherMiddleName`,autoComplete:`additional-name`}],Mr=[`BACHELOR OF SCIENCE IN INFORMATION TECHNOLOGY`,`BACHELOR OF SCIENCE IN ENTREPRENEURSHIP`,`BACHELOR OF SCIENCE IN CRIMINOLOGY`,`BACHELOR OF ELEMENTARY EDUCATION`,`BACHELOR OF EARLY CHILDHOOD EDUCATION`,`BACHELOR OF SCIENCE IN HOSPITALITY MANAGEMENT`,`BACHELOR OF PUBLIC ADMINISTRATION`],Nr=[{label:`Address`,name:`address`,autoComplete:`street-address`,className:`portal-full-field`,required:!0},{label:`Zip Code`,name:`zipCode`,autoComplete:`postal-code`,inputMode:`numeric`},{label:`PWD ID`,name:`pwdId`,autoComplete:`off`},{label:`Mobile No.`,name:`mobileNumber`,autoComplete:`tel`,inputMode:`tel`,type:`tel`,pattern:`\\+?[0-9]*`,required:!0},{label:`Email Address`,name:`emailAddress`,autoComplete:`email`,inputMode:`email`,type:`email`,required:!0}];function Pr({onAdminLoginSuccess:e,onStudentRegistrationSuccess:t}){let n=(0,B.useRef)(null),[r,i]=(0,B.useState)(0),[a,o]=(0,B.useState)(!1),[s,c]=(0,B.useState)(!1),[l,u]=(0,B.useState)(!1),[d,f]=(0,B.useState)(!1),[p,m]=(0,B.useState)(!1),[h,g]=(0,B.useState)(!1),[_,v]=(0,B.useState)(``),[y,b]=(0,B.useState)(``),[x,S]=(0,B.useState)(``),[C,w]=(0,B.useState)(``),[T,E]=(0,B.useState)(``),[D,O]=(0,B.useState)(``),[k,ee]=(0,B.useState)({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),[A,j]=(0,B.useState)(null),[te,M]=(0,B.useState)(!1),[N,ne]=(0,B.useState)(!1),[P,re]=(0,B.useState)(!1),[ie,F]=(0,B.useState)(!1),[I,ae]=(0,B.useState)(1),[oe,se]=(0,B.useState)(``),[ce,le]=(0,B.useState)(``),[L,ue]=(0,B.useState)(``),[de,fe]=(0,B.useState)(``),[pe,me]=(0,B.useState)(``),[he,ge]=(0,B.useState)(``),[_e,ve]=(0,B.useState)(``),[ye,be]=(0,B.useState)(``),[xe,Se]=(0,B.useState)(``),[Ce,R]=(0,B.useState)(``),[we,Te]=(0,B.useState)(``),[Ee,De]=(0,B.useState)(null),[Oe,ke]=(0,B.useState)(``),[Ae,je]=(0,B.useState)(``),[Me,Ne]=(0,B.useState)(``),[Pe,Fe]=(0,B.useState)(``),[Ie,Le]=(0,B.useState)(``),[Re,ze]=(0,B.useState)(``),[Be,Ve]=(0,B.useState)(``),[He,Ue]=(0,B.useState)(``),[We,Ge]=(0,B.useState)(!1),[Ke,qe]=(0,B.useState)(!1),[Je,Ye]=(0,B.useState)(!1),Xe=fn(V.applicants.create),Ze=fn(V.applicants.generateUploadUrl),Qe=fn(V.quickActions.create),$e=fn(V.adminAuth.login),et=fn(V.adminAuth.register),tt=fn(V.adminAuth.requestPasswordResetOtp),nt=fn(V.adminAuth.changePasswordWithOtp),rt=dn(V.allinfo.list),z=dn(V.applicantPortal.get),it=(0,B.useMemo)(()=>rt??[],[rt]),at=oe.trim().length>0,ot=(0,B.useMemo)(()=>{let e=oe.trim().toLowerCase();return e?it.filter(t=>{let n=String(t.studentId??``).trim().toLowerCase(),r=String(t.batchId??``).trim().toLowerCase(),i=String(t.lastName??``).trim().toLowerCase(),a=String(t.firstName??``).trim().toLowerCase(),o=String(t.middleName??t.middleInitial??``).trim().toLowerCase(),s=[i,a,o].filter(Boolean).join(` `);return n===e||r===e||i.includes(e)||a.includes(e)||o.includes(e)||s.includes(e)}):[]},[it,oe]),st=ot.length,ct=Math.max(1,Math.ceil(st/6)),lt=(I-1)*6,ut=Math.min(lt+6,st),dt=(0,B.useMemo)(()=>ot.slice(lt,ut),[ot,lt,ut]),ft=(0,B.useMemo)(()=>_r(I,ct),[I,ct]),pt=e=>{let t=e.trim().toLowerCase();return it.some(e=>String(e.studentId??``).trim().toLowerCase()===t)},mt=(0,B.useCallback)(()=>{Te(``),De(null),me(``),ge(``),be(``),Se(``),typeof t==`function`&&t(Ee)},[t,Ee]);(0,B.useEffect)(()=>{let e=()=>{let e=document.documentElement.scrollTop||document.body.scrollTop,t=document.documentElement.scrollHeight-document.documentElement.clientHeight;i(t>0?e/t:0)};return e(),window.addEventListener(`scroll`,e,{passive:!0}),()=>window.removeEventListener(`scroll`,e)},[]),(0,B.useEffect)(()=>{if(!a&&!s&&!l&&!d&&!p&&!h&&!D&&!we&&!x)return;let e=e=>{e.key===`Escape`&&(o(!1),c(!1),w(``),E(``),j(null),ee({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),u(!1),M(!1),f(!1),m(!1),g(!1),O(``),we&&mt(),S(``))};return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),()=>{document.body.style.overflow=``,window.removeEventListener(`keydown`,e)}},[a,s,l,d,p,h,D,we,x,mt]);let ht=()=>{S(``),b(``),o(!0)},gt=()=>{o(!1),b(``)},_t=()=>{if(z===void 0){O(`Please wait while the UNIFAST portal status is loading.`);return}if(!z.isReceivingApplicants){O(`The UNIFAST portal is not receiving applicants right now. Please wait for the administrator to open applications.`);return}w(``),E(``),c(!0)},vt=()=>{P||(c(!1),w(``),E(``),ee({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),j(null))},yt=async e=>{let t=await Ze(),n=await fetch(t,{body:e,headers:{"Content-Type":e.type||`application/pdf`},method:`POST`});if(!n.ok)throw Error(`Unable to upload ${e.name}.`);let{storageId:r}=await n.json();return r},bt=e=>{let{files:t,name:n}=e.target,r=t?.[0]??null;if(w(``),E(``),j(null),!r){ee(e=>({...e,[n]:null}));return}if(!Tr(r)){e.target.value=``,ee(e=>({...e,[n]:null})),w(`Please upload PDF files only for all document requirements.`);return}if(r.size>wr){e.target.value=``,ee(e=>({...e,[n]:null})),w(`Each uploaded PDF must be 5MB or smaller.`);return}ee(e=>({...e,[n]:r}))},xt=async e=>{e.preventDefault();let t=e.currentTarget,n=new FormData(t),r=br(String(n.get(`mobileNumber`)||``)),i=String(n.get(`emailAddress`)||``).trim().toLowerCase(),a=n.get(`psaFile`),o=n.get(`schoolIdFile`),s=n.get(`pwdIdFile`),c=n.get(`fourPsFile`);if(w(``),E(``),!z?.isReceivingApplicants){w(`The UNIFAST portal is closed for applicants right now.`);return}if(!Cr(r)){w(`Please enter a valid mobile number. Example: 09123456789 or +639123456789.`);return}if(!vr(i)){w(`Please enter a valid email address.`);return}if(!(a instanceof File)||!a.name||!Tr(a)){w(`Please upload your PSA as a PDF file.`);return}if(!(o instanceof File)||!o.name||!Tr(o)){w(`Please upload your colored School ID photocopy as a PDF file.`);return}if(a.size>wr||o.size>wr){w(`Each uploaded PDF must be 5MB or smaller.`);return}let l=[s,c].filter(e=>e instanceof File&&e.name);if(l.some(e=>!Tr(e))){w(`Optional PWD ID and 4Ps ID documents must be PDF files.`);return}if(l.some(e=>e.size>wr)){w(`Each uploaded PDF must be 5MB or smaller.`);return}j({studentId:String(n.get(`studentId`)||``).trim(),lastName:String(n.get(`lastName`)||``).trim(),firstName:String(n.get(`firstName`)||``).trim(),extensionName:String(n.get(`extensionName`)||``).trim(),middleName:String(n.get(`middleName`)||``).trim(),gender:String(n.get(`gender`)||``),birthDate:String(n.get(`birthDate`)||``),course:String(n.get(`course`)||``),year:String(n.get(`year`)||``),fatherLastName:String(n.get(`fatherLastName`)||``).trim(),fatherFirstName:String(n.get(`fatherFirstName`)||``).trim(),fatherMiddleName:String(n.get(`fatherMiddleName`)||``).trim(),motherLastName:String(n.get(`motherLastName`)||``).trim(),motherFirstName:String(n.get(`motherFirstName`)||``).trim(),motherMiddleName:String(n.get(`motherMiddleName`)||``).trim(),address:String(n.get(`address`)||``).trim(),zipCode:String(n.get(`zipCode`)||``).trim(),pwdId:String(n.get(`pwdId`)||``).trim(),mobileNumber:r,emailAddress:i,psaFile:a,schoolIdFile:o,pwdIdFile:l.includes(s)?s:null,fourPsFile:l.includes(c)?c:null})},St=()=>{w(``),E(``),j(null)},Ct=async()=>{if(A){if(w(``),E(``),!z?.isReceivingApplicants){w(`The UNIFAST portal is closed for applicants right now.`);return}re(!0);try{let[e,t,r,i]=await Promise.all([yt(A.psaFile),yt(A.schoolIdFile),A.pwdIdFile?yt(A.pwdIdFile):Promise.resolve(void 0),A.fourPsFile?yt(A.fourPsFile):Promise.resolve(void 0)]),a={studentId:A.studentId,lastName:A.lastName,firstName:A.firstName,extensionName:A.extensionName,middleName:A.middleName,gender:A.gender,birthDate:A.birthDate,course:A.course,year:A.year,fatherLastName:A.fatherLastName,fatherFirstName:A.fatherFirstName,fatherMiddleName:A.fatherMiddleName,motherLastName:A.motherLastName,motherFirstName:A.motherFirstName,motherMiddleName:A.motherMiddleName,address:A.address,zipCode:A.zipCode,pwdId:A.pwdId,mobileNumber:A.mobileNumber,emailAddress:A.emailAddress,psaFileStorageId:e,psaFileName:A.psaFile.name,schoolIdFileStorageId:t,schoolIdFileName:A.schoolIdFile.name};r&&A.pwdIdFile&&(a.pwdIdFileStorageId=r,a.pwdIdFileName=A.pwdIdFile.name),i&&A.fourPsFile&&(a.fourPsFileStorageId=i,a.fourPsFileName=A.fourPsFile.name);let o=await Xe(a);if(!o.success){w(o.message||`Unable to submit applicant information.`);return}n.current?.reset(),ee({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),j(null),E(o.message||`Applicant information submitted successfully.`),window.setTimeout(()=>{E(``),c(!1)},900)}catch(e){w(e instanceof Error?e.message:`Unable to submit applicant information right now.`)}finally{re(!1)}}},wt=()=>{v(``),le(``),ue(``),fe(``),u(!0)},Tt=()=>{u(!1),M(!1),v(``),le(``),ue(``),fe(``)},Et=()=>{u(!1),m(!0),R(``),Te(``),me(ce),ge(L),be(``),Se(``)},Dt=()=>{m(!1),R(``),Te(``),me(``),ge(``),ve(``),be(``),Se(``)},Ot=()=>{m(!1),R(``),Te(``),De(null),le(pe),ue(he),fe(``),u(!0)},kt=()=>{g(!1),m(!0)},At=()=>{u(!1),f(!0),Ve(``),Ue(``),Ge(!1),ke(ce),je(L),Ne(``),Fe(``),Le(``),ze(``)},jt=()=>{f(!1),Ve(``),Ue(``),Ge(!1),ke(``),je(``),Ne(``),Fe(``),Le(``),ze(``)},Mt=()=>{ae(e=>Math.max(e-1,1))},Nt=()=>{ae(e=>Math.min(e+1,ct))},Pt=()=>{se(``),ae(1)},Ft=e=>{se(e.target.value),ae(1)},It=e=>{e.target.value=xr(e.target.value)},Lt=()=>{Ge(!1),Ue(``),Fe(``),Le(``),ze(``)},Rt=e=>{let t=e.target.value;ke(t),t.trim()&&je(``),Lt()},zt=e=>{let t=e.target.value;je(t),t.trim()&&ke(``),Lt()},Bt=e=>{Ne(xr(e.target.value)),Lt()},Vt=()=>{let e=Oe.trim().toLowerCase(),t=Ae.trim(),n=br(Me);return!e&&!t?`Email address or School ID is required.`:e&&t?`Use either email address or School ID, not both.`:e&&!vr(e)?`Please enter a valid email address.`:t&&!yr(t)?`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`:n?Cr(n)?``:`Please enter a valid phone number. Example: 09123456789 or +639123456789.`:`Phone number is required.`};return(0,H.jsxs)(`div`,{className:`landing-page`,children:[(0,H.jsx)(`style`,{children:Fr}),(0,H.jsxs)(`header`,{className:`landing-header`,children:[(0,H.jsxs)(`div`,{className:`brand-lockup`,children:[(0,H.jsx)(`div`,{className:`brand-mark`,children:(0,H.jsx)(`img`,{alt:`IBACMI`,className:`brand-mark__image`,src:jn})}),(0,H.jsx)(`div`,{className:`brand-copy`,children:(0,H.jsx)(`p`,{className:`brand-title`,children:`IBACMI - Scholarship Office`})})]}),(0,H.jsxs)(`div`,{className:`header-actions`,children:[(0,H.jsx)(`button`,{className:`button button--compact`,onClick:ht,type:`button`,children:`Quick Actions`}),(0,H.jsx)(`button`,{className:`button button--compact button--admin`,onClick:wt,type:`button`,children:`SIGN IN`})]})]}),(0,H.jsx)(`main`,{className:`landing-main`,children:(0,H.jsxs)(`div`,{className:`landing-container`,children:[(0,H.jsx)(`section`,{className:`page-heading`,children:(0,H.jsxs)(`div`,{className:`page-heading__copy`,children:[(0,H.jsx)(`span`,{className:`eyebrow`,children:`Grantee Records`}),(0,H.jsx)(`h2`,{children:`SEARCH YOUR SCHOOL ID EITHER BATCH NO., OR LAST NAME`})]})}),(0,H.jsxs)(`section`,{className:`filter-panel`,"aria-label":`Grantee filters`,children:[(0,H.jsxs)(`div`,{className:`search-field`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`search`}),(0,H.jsx)(`input`,{placeholder:`Enter School ID, Either Batch No., or Last Name...`,type:`text`,value:oe,onChange:Ft})]}),(0,H.jsxs)(`button`,{className:`icon-button filter-button`,type:`button`,"aria-label":`Clear search`,title:`Clear search`,onClick:Pt,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`restart_alt`}),(0,H.jsx)(`span`,{className:`filter-button__text`,children:`Reset`})]})]}),(0,H.jsxs)(`section`,{className:`table-card`,"aria-label":`Grantee records`,children:[(0,H.jsx)(`div`,{className:`table-scroll`,children:(0,H.jsxs)(`table`,{children:[(0,H.jsx)(`thead`,{children:(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`th`,{children:`No.`}),(0,H.jsx)(`th`,{children:`TES Award Number`}),(0,H.jsx)(`th`,{children:`Student ID`}),(0,H.jsx)(`th`,{children:`Last Name`}),(0,H.jsx)(`th`,{children:`First Name`}),(0,H.jsx)(`th`,{children:`Middle Name`}),(0,H.jsx)(`th`,{children:`Batch No.`}),(0,H.jsx)(`th`,{children:`Status`}),(0,H.jsx)(`th`,{children:`Semester`}),(0,H.jsx)(`th`,{children:`School Year`})]})}),(0,H.jsxs)(`tbody`,{children:[!at&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`empty-state`,colSpan:10,children:`Enter a School ID, Batch No./ID, or name in the search field to view records.`})}),at&&rt===void 0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`empty-state`,colSpan:10,children:`Searching grantee record...`})}),at&&rt&&ot.length===0&&(0,H.jsx)(`tr`,{children:(0,H.jsx)(`td`,{className:`empty-state`,colSpan:10,children:`No matching School ID, Batch No./ID, or name found.`})}),at&&dt.map((e,t)=>(0,H.jsxs)(`tr`,{children:[(0,H.jsx)(`td`,{"data-label":`No.`,children:e.no||lt+t+1}),(0,H.jsx)(`td`,{className:`award-cell`,"data-label":`TES Award Number`,children:e.tesAwardNumber}),(0,H.jsx)(`td`,{"data-label":`Student ID`,children:e.studentId}),(0,H.jsx)(`td`,{"data-label":`Last Name`,children:e.lastName||`â€”`}),(0,H.jsx)(`td`,{"data-label":`First Name`,children:e.firstName||`â€”`}),(0,H.jsx)(`td`,{"data-label":`Middle Name`,children:e.middleName||e.middleInitial||`â€”`}),(0,H.jsx)(`td`,{className:`batch-cell`,"data-label":`Batch ID`,children:e.batchId}),(0,H.jsx)(`td`,{"data-label":`Status`,children:(0,H.jsx)(hr,{status:e.status,tone:gr(e.status)})}),(0,H.jsx)(`td`,{"data-label":`Semester`,children:e.semester||`—`}),(0,H.jsx)(`td`,{"data-label":`School Year`,children:e.schoolYear||`—`})]},e._id))]})]})}),(0,H.jsxs)(`div`,{className:`table-footer`,children:[at?(0,H.jsxs)(`p`,{children:[`Showing `,(0,H.jsx)(`strong`,{children:st===0?0:lt+1}),` to`,` `,(0,H.jsx)(`strong`,{children:ut}),` of `,(0,H.jsx)(`strong`,{children:st}),` result`,st===1?``:`s`]}):(0,H.jsxs)(`p`,{children:[`Search by `,(0,H.jsx)(`strong`,{children:`School ID`}),`, `,(0,H.jsx)(`strong`,{children:`Batch No./ID`}),`, or`,` `,(0,H.jsx)(`strong`,{children:`Name`}),` to display grantee records.`]}),(0,H.jsxs)(`div`,{className:`pagination`,children:[(0,H.jsx)(`button`,{className:`page-button`,disabled:!at||I===1||st===0,onClick:Mt,type:`button`,"aria-label":`Previous page`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),ft.map(e=>typeof e==`string`?(0,H.jsx)(`span`,{className:`pagination__ellipsis`,children:`...`},e):(0,H.jsx)(`button`,{className:`page-button ${I===e?`page-button--active`:``}`,disabled:!at||st===0,onClick:()=>ae(e),type:`button`,children:e},e)),(0,H.jsx)(`button`,{className:`page-button`,disabled:!at||I===ct||st===0,onClick:Nt,type:`button`,"aria-label":`Next page`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]})]}),(0,H.jsxs)(`section`,{className:`portal-cta`,"aria-labelledby":`portal-cta-title`,children:[(0,H.jsx)(`div`,{className:`portal-cta__icon`,"aria-hidden":`true`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`assignment`})}),(0,H.jsxs)(`div`,{className:`portal-cta__copy`,children:[(0,H.jsx)(`span`,{className:`eyebrow`,children:`UNIFAST Portal`}),(0,H.jsx)(`h3`,{id:`portal-cta-title`,children:`Submit student information`}),(0,H.jsx)(`p`,{children:`Complete the student, parent, address, and contact information form for UNIFAST applicant processing.`})]}),(0,H.jsx)(`button`,{className:`button button--portal`,onClick:_t,type:`button`,children:`Open Portal`})]})]})}),(0,H.jsx)(`footer`,{className:`landing-footer`,children:(0,H.jsx)(`p`,{children:`Copyright 2026 | All Rights Reserved IBACMI - Scholarship Office | Developed By CINIFIX`})}),s&&(0,H.jsxs)(`div`,{"aria-labelledby":`unifast-portal-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close UNIFAST portal modal`,className:`modal-backdrop-button`,onClick:vt,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card portal-modal-card`,ref:n,onSubmit:xt,children:[(0,H.jsx)(`div`,{className:`modal-header portal-modal-header`,children:(0,H.jsxs)(`div`,{className:`modal-title-row`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`modal-kicker`,children:`UNIFAST Portal`}),(0,H.jsx)(`h3`,{id:`unifast-portal-title`,children:`Student Information Form`}),(0,H.jsxs)(`p`,{children:[`Complete the student, parent, and contact information fields below`,z?.applicationYear?` for ${z.applicationYear}.`:`.`]})]}),(0,H.jsx)(`button`,{"aria-label":`Close UNIFAST portal`,className:`icon-button modal-close`,onClick:vt,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]})}),(0,H.jsxs)(`div`,{className:`modal-body portal-form${A?` portal-form--hidden`:``}`,children:[(0,H.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-student-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-student-heading`,children:`Student Information`}),(0,H.jsxs)(`div`,{className:`portal-grid`,children:[kr.map(e=>(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:e.label}),(0,H.jsx)(`input`,{autoComplete:e.autoComplete,name:e.name,placeholder:`Enter ${e.label.toLowerCase()}`,required:e.required,type:`text`})]},e.name)),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Gender`}),(0,H.jsxs)(`select`,{name:`gender`,defaultValue:``,required:!0,children:[(0,H.jsx)(`option`,{value:``,disabled:!0,children:`Select gender`}),(0,H.jsx)(`option`,{value:`Female`,children:`Female`}),(0,H.jsx)(`option`,{value:`Male`,children:`Male`}),(0,H.jsx)(`option`,{value:`Prefer not to say`,children:`Prefer not to say`})]})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Birth Date`}),(0,H.jsx)(`input`,{name:`birthDate`,required:!0,type:`date`})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Year`}),(0,H.jsxs)(`select`,{name:`year`,defaultValue:``,required:!0,children:[(0,H.jsx)(`option`,{value:``,disabled:!0,children:`Select year`}),(0,H.jsx)(`option`,{value:`1st Year`,children:`1st Year`}),(0,H.jsx)(`option`,{value:`2nd Year`,children:`2nd Year`}),(0,H.jsx)(`option`,{value:`3rd Year`,children:`3rd Year`}),(0,H.jsx)(`option`,{value:`4th Year`,children:`4th Year`}),(0,H.jsx)(`option`,{value:`5th Year`,children:`5th Year`})]})]}),(0,H.jsxs)(`fieldset`,{className:`portal-course-list`,children:[(0,H.jsx)(`legend`,{children:`Course`}),Mr.map(e=>(0,H.jsxs)(`label`,{className:`portal-course-option`,children:[(0,H.jsx)(`input`,{name:`course`,required:!0,type:`radio`,value:e}),(0,H.jsx)(`span`,{children:e})]},e))]})]})]}),(0,H.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-parents-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-parents-heading`,children:`Parents Information`}),(0,H.jsxs)(`div`,{className:`portal-parent-group`,children:[(0,H.jsx)(`p`,{children:`Father Information`}),(0,H.jsx)(`div`,{className:`portal-grid portal-grid--three`,children:Ar.map(e=>(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:e.label}),(0,H.jsx)(`input`,{autoComplete:e.autoComplete,name:e.name,placeholder:`Enter father's ${e.label.toLowerCase()}`,type:`text`})]},e.name))})]}),(0,H.jsxs)(`div`,{className:`portal-parent-group`,children:[(0,H.jsx)(`p`,{children:`Mother Information`}),(0,H.jsx)(`div`,{className:`portal-grid portal-grid--three`,children:jr.map(e=>(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:e.label}),(0,H.jsx)(`input`,{autoComplete:e.autoComplete,name:e.name,placeholder:`Enter mother's ${e.label.toLowerCase()}`,type:`text`})]},e.name))})]})]}),(0,H.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-contact-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-contact-heading`,children:`Address and Contact Information`}),(0,H.jsx)(`div`,{className:`portal-grid`,children:Nr.map(e=>(0,H.jsxs)(`label`,{className:`form-field ${e.className??``}`.trim(),children:[(0,H.jsx)(`span`,{children:e.label}),(0,H.jsx)(`input`,{autoComplete:e.autoComplete,inputMode:e.inputMode,name:e.name,onInput:e.name===`mobileNumber`?It:void 0,pattern:e.pattern,placeholder:`Enter ${e.label.toLowerCase()}`,required:e.required,type:e.type??`text`})]},e.name))})]}),(0,H.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-documents-heading`,children:[(0,H.jsxs)(`div`,{className:`portal-section-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-documents-heading`,children:`Document Requirements`}),(0,H.jsx)(`p`,{children:`Upload clear PDF copies up to 5MB each. Required and optional documents are labeled below.`})]}),(0,H.jsxs)(`div`,{className:`portal-document-grid`,children:[(0,H.jsxs)(`label`,{className:`portal-document-upload${k.psaFile?` portal-document-upload--selected`:``}`,children:[(0,H.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`psaFile`,onChange:bt,required:!0,type:`file`}),(0,H.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`picture_as_pdf`})}),(0,H.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,H.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,H.jsx)(`strong`,{children:`PSA Birth Certificate`}),(0,H.jsx)(`span`,{className:`portal-document-badge portal-document-badge--required`,children:`Required`})]}),(0,H.jsx)(`span`,{children:k.psaFile?`${k.psaFile.name} (${Er(k.psaFile.size)})`:`Select PSA PDF file`})]})]}),(0,H.jsxs)(`label`,{className:`portal-document-upload${k.schoolIdFile?` portal-document-upload--selected`:``}`,children:[(0,H.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`schoolIdFile`,onChange:bt,required:!0,type:`file`}),(0,H.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`badge`})}),(0,H.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,H.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,H.jsx)(`strong`,{children:`Colored School ID Photocopy`}),(0,H.jsx)(`span`,{className:`portal-document-badge portal-document-badge--required`,children:`Required`})]}),(0,H.jsx)(`span`,{children:k.schoolIdFile?`${k.schoolIdFile.name} (${Er(k.schoolIdFile.size)})`:`Select colored School ID photocopy PDF`})]})]}),(0,H.jsxs)(`label`,{className:`portal-document-upload portal-document-upload--optional${k.pwdIdFile?` portal-document-upload--selected`:``}`,children:[(0,H.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`pwdIdFile`,onChange:bt,type:`file`}),(0,H.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`accessible`})}),(0,H.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,H.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,H.jsx)(`strong`,{children:`PWD ID`}),(0,H.jsx)(`span`,{className:`portal-document-badge`,children:`Optional`})]}),(0,H.jsx)(`span`,{children:k.pwdIdFile?`${k.pwdIdFile.name} (${Er(k.pwdIdFile.size)})`:`Attach a clear PWD ID PDF, if applicable`})]})]}),(0,H.jsxs)(`label`,{className:`portal-document-upload portal-document-upload--optional${k.fourPsFile?` portal-document-upload--selected`:``}`,children:[(0,H.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`fourPsFile`,onChange:bt,type:`file`}),(0,H.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`family_restroom`})}),(0,H.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,H.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,H.jsx)(`strong`,{children:`4Ps ID`}),(0,H.jsx)(`span`,{className:`portal-document-badge`,children:`Optional`})]}),(0,H.jsx)(`span`,{children:k.fourPsFile?`${k.fourPsFile.name} (${Er(k.fourPsFile.size)})`:`Attach a clear 4Ps ID PDF, if applicable`})]})]})]})]})]}),A&&(0,H.jsx)(`div`,{className:`modal-body portal-review`,children:(0,H.jsxs)(`section`,{className:`portal-review-card`,"aria-labelledby":`portal-review-heading`,children:[(0,H.jsxs)(`div`,{className:`portal-section-heading`,children:[(0,H.jsx)(`h4`,{id:`portal-review-heading`,children:`Review Information`}),(0,H.jsx)(`p`,{children:`Please check every detail before final submission.`})]}),(0,H.jsxs)(`div`,{className:`portal-review-grid`,children:[(0,H.jsxs)(`div`,{className:`portal-review-group`,children:[(0,H.jsx)(`h5`,{children:`Student Information`}),(0,H.jsxs)(`dl`,{children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Student ID`}),(0,H.jsx)(`dd`,{children:A.studentId})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Full Name`}),(0,H.jsx)(`dd`,{children:[A.firstName,A.middleName,A.lastName,A.extensionName].filter(Boolean).join(` `)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Gender`}),(0,H.jsx)(`dd`,{children:A.gender})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Birth Date`}),(0,H.jsx)(`dd`,{children:A.birthDate})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Year`}),(0,H.jsx)(`dd`,{children:A.year})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Course`}),(0,H.jsx)(`dd`,{children:A.course})]})]})]}),(0,H.jsxs)(`div`,{className:`portal-review-group`,children:[(0,H.jsx)(`h5`,{children:`Parents Information`}),(0,H.jsxs)(`dl`,{children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Father`}),(0,H.jsx)(`dd`,{children:[A.fatherFirstName,A.fatherMiddleName,A.fatherLastName].filter(Boolean).join(` `)||`Not provided`})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Mother`}),(0,H.jsx)(`dd`,{children:[A.motherFirstName,A.motherMiddleName,A.motherLastName].filter(Boolean).join(` `)||`Not provided`})]})]})]}),(0,H.jsxs)(`div`,{className:`portal-review-group`,children:[(0,H.jsx)(`h5`,{children:`Address and Contact`}),(0,H.jsxs)(`dl`,{children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Address`}),(0,H.jsx)(`dd`,{children:A.address})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Zip Code`}),(0,H.jsx)(`dd`,{children:A.zipCode||`Not provided`})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`PWD ID`}),(0,H.jsx)(`dd`,{children:A.pwdId||`Not provided`})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Mobile No.`}),(0,H.jsx)(`dd`,{children:A.mobileNumber})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`Email Address`}),(0,H.jsx)(`dd`,{children:A.emailAddress})]})]})]}),(0,H.jsxs)(`div`,{className:`portal-review-group`,children:[(0,H.jsx)(`h5`,{children:`Documents`}),(0,H.jsxs)(`dl`,{children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`PSA Birth Certificate`}),(0,H.jsxs)(`dd`,{children:[A.psaFile.name,` (`,Er(A.psaFile.size),`)`]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`School ID Photocopy`}),(0,H.jsxs)(`dd`,{children:[A.schoolIdFile.name,` (`,Er(A.schoolIdFile.size),`)`]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`PWD ID (Optional)`}),(0,H.jsx)(`dd`,{children:A.pwdIdFile?`${A.pwdIdFile.name} (${Er(A.pwdIdFile.size)})`:`Not provided`})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`dt`,{children:`4Ps ID (Optional)`}),(0,H.jsx)(`dd`,{children:A.fourPsFile?`${A.fourPsFile.name} (${Er(A.fourPsFile.size)})`:`Not provided`})]})]})]})]})]})}),(C||T)&&(0,H.jsxs)(`div`,{className:`portal-message-row`,children:[C&&(0,H.jsx)(`p`,{className:`form-error`,children:C}),T&&(0,H.jsx)(`p`,{className:`form-success`,children:T})]}),(0,H.jsx)(`div`,{className:`modal-actions portal-actions`,children:A?(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:P,onClick:St,type:`button`,children:`Edit Information`}),(0,H.jsx)(`button`,{className:`button`,disabled:P,onClick:Ct,type:`button`,children:P?`Submitting...`:`Submit Information`})]}):(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:P,onClick:vt,type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`button`,disabled:P,type:`submit`,children:`Review Information`})]})})]})]}),D&&(0,H.jsxs)(`div`,{"aria-labelledby":`portal-status-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close portal status modal`,className:`modal-backdrop-button`,onClick:()=>O(``),type:`button`}),(0,H.jsxs)(`section`,{className:`modal-card portal-status-card`,children:[(0,H.jsx)(`div`,{className:`modal-header portal-modal-header`,children:(0,H.jsxs)(`div`,{className:`modal-title-row`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`modal-kicker`,children:`UNIFAST Portal`}),(0,H.jsx)(`h3`,{id:`portal-status-title`,children:`Portal Status`}),(0,H.jsx)(`p`,{children:D})]}),(0,H.jsx)(`button`,{"aria-label":`Close portal status`,className:`icon-button modal-close`,onClick:()=>O(``),type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]})}),(0,H.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,H.jsx)(`button`,{className:`button`,onClick:()=>O(``),type:`button`,children:`OK`})})]})]}),a&&(0,H.jsxs)(`div`,{"aria-labelledby":`quick-actions-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close quick actions modal`,className:`modal-backdrop-button`,onClick:gt,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card modal-card--wide auth-modal-card`,onSubmit:async e=>{e.preventDefault();let t=e.currentTarget,n=new FormData(t),r=String(n.get(`email`)||``).trim().toLowerCase(),i=String(n.get(`studentId`)||``).trim(),a=String(n.get(`lastName`)||``).trim(),s=String(n.get(`firstName`)||``).trim(),c=String(n.get(`middleInitial`)||``).trim(),l=Sr(String(n.get(`question`)||``)).trim();b(``),S(``),ne(!0);try{if(!vr(r))throw Error(`Please enter a valid email account.`);if(!yr(i))throw Error(`Please enter a valid Student ID.`);if(!a||!s)throw Error(`Last name and first name are required.`);if(c&&!/^[A-Za-z. -]{1,10}$/.test(c))throw Error(`Please enter a valid middle initial.`);if(!l)throw Error(`Please enter your question or request.`);if(l.length>500)throw Error(`Your question must be 500 characters or fewer.`);await Qe({email:r,studentId:i,lastName:a,firstName:s,middleInitial:c,question:l,source:mr.quickActions.source,status:mr.quickActions.defaultStatus}),t.reset(),o(!1),S(`Your request has been submitted.`)}catch(e){b(e instanceof Error?e.message:`Unable to submit your request right now.`)}finally{ne(!1)}},children:[(0,H.jsxs)(`div`,{className:`modal-header`,children:[(0,H.jsxs)(`div`,{className:`modal-title-row`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`p`,{className:`modal-kicker`,children:`Quick Actions`}),(0,H.jsx)(`h3`,{id:`quick-actions-title`,children:`Submit a Request`})]}),(0,H.jsx)(`button`,{"aria-label":`Close modal`,className:`icon-button modal-close`,onClick:gt,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,H.jsx)(`p`,{children:`Send a question or request to the scholarship office for review.`})]}),(0,H.jsxs)(`div`,{className:`modal-body quick-action-form-grid`,children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Student ID`}),(0,H.jsx)(`input`,{autoComplete:`off`,name:`studentId`,placeholder:`Enter Student ID`,required:!0})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Email account`}),(0,H.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`email`,placeholder:mr.quickActions.fields.email.placeholder,required:!0,type:`email`})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Last name`}),(0,H.jsx)(`input`,{autoComplete:`family-name`,name:`lastName`,placeholder:`Enter last name`,required:!0})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`First name`}),(0,H.jsx)(`input`,{autoComplete:`given-name`,name:`firstName`,placeholder:`Enter first name`,required:!0})]}),(0,H.jsxs)(`label`,{className:`form-field quick-action-mi-field`,children:[(0,H.jsx)(`span`,{children:`MI`}),(0,H.jsx)(`input`,{autoComplete:`additional-name`,maxLength:10,name:`middleInitial`,placeholder:`M`})]}),(0,H.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,H.jsx)(`span`,{children:`Question`}),(0,H.jsx)(`textarea`,{"aria-describedby":`quick-action-question-help`,maxLength:500,name:`question`,onInput:e=>{e.currentTarget.value=Sr(e.currentTarget.value)},placeholder:mr.quickActions.fields.question.placeholder,required:!0,rows:4}),(0,H.jsx)(`small`,{className:`form-field__help`,id:`quick-action-question-help`,children:`One paragraph only, up to 500 characters.`})]}),y&&(0,H.jsx)(`p`,{className:`form-error auth-full-field`,children:y})]}),(0,H.jsxs)(`div`,{className:`modal-actions`,children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:N,onClick:gt,type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`button`,disabled:N,type:`submit`,children:N?`Submitting...`:`Submit`})]})]})]}),l&&(0,H.jsxs)(`div`,{"aria-labelledby":`admin-login-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close admin login modal`,className:`modal-backdrop-button`,onClick:Tt,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card modal-card--admin auth-modal-card`,onSubmit:async t=>{t.preventDefault();let n=ce.trim().toLowerCase(),r=L.trim(),i=de,a=n.length>0,o=r.length>0;if(v(``),!a&&!o){v(`Enter either your valid email address or your School ID.`);return}if(a&&!vr(n)){v(`Please enter a valid email address.`);return}if(o&&!yr(r)){v(`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`);return}if(!i){v(`Password is required.`);return}if(!Dr(i)){v(`Password must be at least 6 characters.`);return}let s={password:i,...a?{email:n}:{},...o?{schoolId:r}:{}};M(!0);try{let t=await Or($e(s),15e3,`Login is taking too long. Please check your internet connection is running, then try again.`);if(!t.success){v(t.message||`Invalid admin credentials.`);return}u(!1),typeof e==`function`&&e(t.admin)}catch(e){v(e instanceof Error?e.message:`Unable to login right now.`)}finally{M(!1)}},children:[(0,H.jsxs)(`div`,{className:`admin-login-hero auth-modal-hero`,children:[(0,H.jsx)(`div`,{className:`admin-login-brand`,children:(0,H.jsx)(`img`,{alt:`IBACMI`,src:`/IBACMI-Scholarship-Office/assets/IBACMI-DvrUkuyb.png`})}),(0,H.jsx)(`button`,{"aria-label":`Close admin login`,className:`icon-button modal-close admin-login-close`,onClick:Tt,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})}),(0,H.jsx)(`p`,{className:`modal-kicker`,children:`Administrator Access`}),(0,H.jsx)(`h3`,{id:`admin-login-title`,children:`Sign in to Admin View`}),(0,H.jsx)(`p`,{children:`Use either your valid email address or School ID, then enter your password.`})]}),(0,H.jsxs)(`div`,{className:`modal-body admin-login-body auth-form-grid`,children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Email address`}),(0,H.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`adminEmail`,placeholder:`Enter email address`,type:`email`,disabled:L.trim().length>0,value:ce,onChange:e=>le(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`School ID`}),(0,H.jsx)(`input`,{autoComplete:`off`,name:`adminSchoolId`,placeholder:`Enter School ID`,type:`text`,minLength:4,maxLength:30,pattern:`[A-Za-z0-9-]{4,30}`,title:`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`,disabled:ce.trim().length>0,value:L,onChange:e=>ue(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,H.jsx)(`span`,{children:`Password`}),(0,H.jsx)(`input`,{autoComplete:`current-password`,name:`adminPassword`,placeholder:`Enter password`,required:!0,type:`password`,minLength:6,value:de,onChange:e=>fe(e.target.value)})]}),(0,H.jsxs)(`div`,{className:`auth-note-box auth-full-field`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`info`}),(0,H.jsx)(`p`,{children:`You may sign in using either your registered email address or your School ID. Password is still required.`})]}),(0,H.jsxs)(`div`,{className:`auth-link-row auth-full-field`,children:[(0,H.jsx)(`button`,{className:`auth-text-button`,disabled:te,onClick:At,type:`button`,children:`Forgot Password?`}),(0,H.jsx)(`button`,{className:`auth-text-button auth-text-button--strong`,disabled:te,onClick:Et,type:`button`,children:`Create Account`})]}),_&&(0,H.jsx)(`p`,{className:`form-error auth-full-field`,children:_})]}),(0,H.jsxs)(`div`,{className:`modal-actions admin-login-actions auth-actions`,children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:te,onClick:Tt,type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`button`,disabled:te,type:`submit`,children:te?`Logging in...`:`Login`})]})]})]}),p&&(0,H.jsxs)(`div`,{"aria-labelledby":`sign-up-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close sign up modal`,className:`modal-backdrop-button`,onClick:Dt,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card modal-card--admin auth-modal-card auth-modal-card--large`,onSubmit:async e=>{e.preventDefault();let t=pe.trim().toLowerCase(),n=he.trim(),r=br(_e),i=ye,a=xe;if(R(``),Te(``),!t){R(`Email account is required.`);return}if(!vr(t)){R(`Please enter a valid email account.`);return}if(!n){R(`School ID is required.`);return}if(!yr(n)){R(`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`);return}if(rt===void 0){R(`Please wait while we verify the School ID.`);return}if(!pt(n)){m(!1),g(!0);return}if(!r){R(`Phone number is required.`);return}if(!Cr(r)){R(`Please enter a valid phone number. Example: 09123456789 or +639123456789.`);return}if(!i){R(`Password is required.`);return}if(!Dr(i)){R(`Password must be at least 6 characters.`);return}if(!a){R(`Confirm password is required.`);return}if(i!==a){R(`Password and confirm password do not match.`);return}F(!0);try{let e=await et({email:t,schoolId:n,phoneNumber:r,password:i});if(!e.success){if(e.reason===`schoolIdNotFound`){m(!1),g(!0);return}R(e.message||`Unable to register account.`);return}m(!1),De(e.admin??{email:t,schoolId:n,role:`student`}),Te(`Your account has been registered successfully.`),le(t),ue(n),fe(``),ve(``),be(``),Se(``)}catch(e){R(e instanceof Error?e.message:`Unable to register account.`)}finally{F(!1)}},children:[(0,H.jsxs)(`div`,{className:`admin-login-hero auth-modal-hero`,children:[(0,H.jsx)(`div`,{className:`admin-login-brand`,children:(0,H.jsx)(`img`,{alt:`IBACMI`,src:`/IBACMI-Scholarship-Office/assets/IBACMI-DvrUkuyb.png`})}),(0,H.jsx)(`button`,{"aria-label":`Close sign up`,className:`icon-button modal-close admin-login-close`,onClick:Dt,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})}),(0,H.jsx)(`p`,{className:`modal-kicker`,children:`Account Registration`}),(0,H.jsx)(`h3`,{id:`sign-up-title`,children:`Create Account`}),(0,H.jsx)(`p`,{children:`Registration is only available for verified School IDs listed in the IBACMI Scholarship Office records.`})]}),(0,H.jsxs)(`div`,{className:`modal-body admin-login-body auth-form-grid`,children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Email account`}),(0,H.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`signUpEmail`,placeholder:`Enter email account`,required:!0,type:`email`,value:pe,onChange:e=>me(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`School ID`}),(0,H.jsx)(`input`,{autoComplete:`off`,name:`signUpSchoolId`,placeholder:`Enter School ID`,required:!0,type:`text`,minLength:4,maxLength:30,pattern:`[A-Za-z0-9-]{4,30}`,value:he,onChange:e=>ge(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Phone Number`}),(0,H.jsx)(`input`,{autoComplete:`tel`,inputMode:`tel`,name:`signUpPhoneNumber`,pattern:`\\+?[0-9]*`,placeholder:`e.g. 09123456789`,required:!0,type:`tel`,value:_e,onChange:e=>ve(xr(e.target.value))})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Password`}),(0,H.jsx)(`input`,{autoComplete:`new-password`,name:`signUpPassword`,placeholder:`Create password`,required:!0,type:`password`,minLength:6,value:ye,onChange:e=>be(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Confirm Password`}),(0,H.jsx)(`input`,{autoComplete:`new-password`,name:`signUpConfirmPassword`,placeholder:`Confirm password`,required:!0,type:`password`,minLength:6,value:xe,onChange:e=>Se(e.target.value)})]}),(0,H.jsxs)(`div`,{className:`auth-note-box auth-full-field`,children:[(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`verified_user`}),(0,H.jsx)(`p`,{children:`Your School ID will be checked against the official grantee information record before account creation.`})]}),Ce&&(0,H.jsx)(`p`,{className:`form-error auth-full-field`,children:Ce}),we&&(0,H.jsx)(`p`,{className:`form-success auth-full-field`,children:we})]}),(0,H.jsxs)(`div`,{className:`modal-actions admin-login-actions auth-actions`,children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:ie,onClick:Ot,type:`button`,children:`Back to Login`}),(0,H.jsx)(`button`,{className:`button`,disabled:ie,type:`submit`,children:ie?`Registering...`:`Register Now`})]})]})]}),h&&(0,H.jsxs)(`div`,{"aria-labelledby":`sign-up-denied-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close sign up denied modal`,className:`modal-backdrop-button`,onClick:kt,type:`button`}),(0,H.jsxs)(`section`,{className:`modal-card modal-card--success auth-modal-card auth-denied-card`,children:[(0,H.jsxs)(`div`,{className:`success-modal-body auth-denied-body`,children:[(0,H.jsx)(`div`,{className:`auth-denied-icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`error`})}),(0,H.jsx)(`h3`,{id:`sign-up-denied-title`,children:`Account Registration Not Approved`}),(0,H.jsx)(`p`,{children:`Sorry, you cannot proceed. Your School ID was not found in the official records. Please contact the IBACMI | Scholarship Office for assistance.`})]}),(0,H.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,H.jsx)(`button`,{className:`button`,onClick:kt,type:`button`,children:`Back to Sign Up`})})]})]}),we&&(0,H.jsxs)(`div`,{"aria-labelledby":`sign-up-success-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Continue to student page`,className:`modal-backdrop-button`,onClick:mt,type:`button`}),(0,H.jsxs)(`section`,{className:`modal-card modal-card--success auth-modal-card`,children:[(0,H.jsxs)(`div`,{className:`success-modal-body`,children:[(0,H.jsx)(`div`,{className:`success-icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`check_circle`})}),(0,H.jsx)(`h3`,{id:`sign-up-success-title`,children:`Successfully Registered`}),(0,H.jsxs)(`p`,{children:[we,` You can now continue to the student information page.`]})]}),(0,H.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,H.jsx)(`button`,{className:`button`,onClick:mt,type:`button`,children:`Continue`})})]})]}),d&&(0,H.jsxs)(`div`,{"aria-labelledby":`forgot-password-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close forgot password modal`,className:`modal-backdrop-button`,onClick:jt,type:`button`}),(0,H.jsxs)(`form`,{className:`modal-card modal-card--admin auth-modal-card auth-modal-card--large`,onSubmit:async e=>{e.preventDefault();let t=Vt(),n=Oe.trim().toLowerCase(),r=Ae.trim(),i=br(Me),a=Pe.trim(),o=Ie,s=Re;if(Ve(``),Ue(``),t){Ve(t);return}if(!We){Ve(`Please request an OTP first.`);return}if(!a){Ve(`OTP is required.`);return}if(!/^\d{4,8}$/.test(a)){Ve(`OTP must be 4 to 8 digits.`);return}if(!o){Ve(`New password is required.`);return}if(!Dr(o)){Ve(`New password must be at least 6 characters.`);return}if(!s){Ve(`Confirm password is required.`);return}if(o!==s){Ve(`New password and confirm password do not match.`);return}Ye(!0);try{let e=await nt({email:n||void 0,schoolId:r||void 0,phoneNumber:i,otp:a,newPassword:o});if(!e.success){Ve(e.message||`Unable to change password.`);return}Ue(e.message||`Password changed successfully.`),Fe(``),Le(``),ze(``),Ge(!1),le(n),ue(r),fe(``)}catch(e){Ve(e instanceof Error?e.message:`Unable to change password right now.`)}finally{Ye(!1)}},children:[(0,H.jsxs)(`div`,{className:`admin-login-hero auth-modal-hero`,children:[(0,H.jsx)(`div`,{className:`admin-login-brand`,children:(0,H.jsx)(`img`,{alt:`IBACMI`,src:`/IBACMI-Scholarship-Office/assets/IBACMI-DvrUkuyb.png`})}),(0,H.jsx)(`button`,{"aria-label":`Close forgot password`,className:`icon-button modal-close admin-login-close`,onClick:jt,type:`button`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})}),(0,H.jsx)(`p`,{className:`modal-kicker`,children:`Account Recovery`}),(0,H.jsx)(`h3`,{id:`forgot-password-title`,children:`Forgot Password`}),(0,H.jsx)(`p`,{children:`Verify your email or School ID with your registered phone number before changing your password.`})]}),(0,H.jsxs)(`div`,{className:`modal-body admin-login-body auth-form-grid`,children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`Email address`}),(0,H.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`forgotEmail`,placeholder:`Enter valid email address`,required:!Ae.trim(),type:`email`,disabled:Ae.trim().length>0||Ke||Je,value:Oe,onChange:Rt})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`School ID`}),(0,H.jsx)(`input`,{autoComplete:`off`,name:`forgotSchoolId`,placeholder:`Enter School ID`,required:!0,type:`text`,minLength:4,maxLength:30,pattern:`[A-Za-z0-9-]{4,30}`,title:`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`,required:!Oe.trim(),disabled:Oe.trim().length>0||Ke||Je,value:Ae,onChange:zt})]}),(0,H.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,H.jsx)(`span`,{children:`Phone number`}),(0,H.jsx)(`input`,{autoComplete:`tel`,inputMode:`tel`,name:`forgotPhoneNumber`,pattern:`\\+?[0-9]*`,placeholder:`09123456789 or +639123456789`,required:!0,type:`tel`,disabled:Ke||Je,value:Me,onChange:Bt})]}),(0,H.jsx)(`button`,{className:`button button--secondary auth-full-field`,disabled:Ke||Je,onClick:async()=>{let e=Vt();if(Ve(``),Ue(``),e){Ve(e);return}let t=Oe.trim().toLowerCase(),n=Ae.trim(),r=br(Me);qe(!0);try{let e=await tt({email:t||void 0,schoolId:n||void 0,phoneNumber:r});if(!e.success){Ve(e.message||`Unable to send OTP.`);return}Ge(!0),Ue(e.message||`OTP generated successfully. Enter it below to change your password.`)}catch(e){Ve(e instanceof Error?e.message:`Unable to request OTP right now.`)}finally{qe(!1)}},type:`button`,children:Ke?`Sending OTP...`:We?`Resend OTP`:`Send OTP`}),We&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`OTP Code`}),(0,H.jsx)(`input`,{autoComplete:`one-time-code`,inputMode:`numeric`,name:`forgotOtp`,placeholder:`Enter OTP`,required:!0,type:`text`,maxLength:8,value:Pe,onChange:e=>Fe(e.target.value.replace(/\D/g,``))})]}),(0,H.jsxs)(`label`,{className:`form-field`,children:[(0,H.jsx)(`span`,{children:`New Password`}),(0,H.jsx)(`input`,{autoComplete:`new-password`,name:`forgotNewPassword`,placeholder:`Enter new password`,required:!0,type:`password`,minLength:6,value:Ie,onChange:e=>Le(e.target.value)})]}),(0,H.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,H.jsx)(`span`,{children:`Confirm New Password`}),(0,H.jsx)(`input`,{autoComplete:`new-password`,name:`forgotConfirmPassword`,placeholder:`Confirm new password`,required:!0,type:`password`,minLength:6,value:Re,onChange:e=>ze(e.target.value)})]})]}),Be&&(0,H.jsx)(`p`,{className:`form-error auth-full-field`,children:Be}),He&&(0,H.jsx)(`p`,{className:`form-success auth-full-field`,children:He})]}),(0,H.jsxs)(`div`,{className:`modal-actions admin-login-actions auth-actions`,children:[(0,H.jsx)(`button`,{className:`button button--secondary`,disabled:Ke||Je,onClick:jt,type:`button`,children:`Cancel`}),(0,H.jsx)(`button`,{className:`button`,disabled:!We||Ke||Je,type:`submit`,children:Je?`Changing Password...`:`Change Password`})]})]})]}),x&&(0,H.jsxs)(`div`,{"aria-labelledby":`quick-action-success-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,H.jsx)(`button`,{"aria-label":`Close success modal`,className:`modal-backdrop-button`,onClick:()=>S(``),type:`button`}),(0,H.jsxs)(`div`,{className:`modal-card modal-card--success`,children:[(0,H.jsxs)(`div`,{className:`success-modal-body`,children:[(0,H.jsx)(`div`,{className:`success-icon`,children:(0,H.jsx)(`span`,{className:`material-symbols-outlined`,children:`check_circle`})}),(0,H.jsx)(`h3`,{id:`quick-action-success-title`,children:`Submitted Successfully`}),(0,H.jsxs)(`p`,{children:[x,` The scholarship office can now review your request.`]})]}),(0,H.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,H.jsx)(`button`,{className:`button`,onClick:()=>S(``),type:`button`,children:`Done`})})]})]}),(0,H.jsx)(`div`,{className:`scroll-progress`,style:{"--scroll-progress":r}})]})}var Fr=`
.auth-modal-card {
  width: min(100%, 520px);
