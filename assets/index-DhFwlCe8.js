...
`||o===`\r`)&&!i?(o===`\r`&&s===`
`&&(a+=1),n.push(cr(r)),n.some(Boolean)&&t.push(n),n=[],r=``):r+=o}return n.push(cr(r)),n.some(Boolean)&&t.push(n),t}function ur(e){return lr(e).filter(e=>e.some(Boolean)).filter(e=>!e.join(` `).toLowerCase().includes(`tes award number`)).map(e=>({no:e[0]??``,tesAwardNumber:e[1]??``,studentId:e[2]??``,lastName:e[3]??``,firstName:e[4]??``,middleInitial:e[5]??``,batchId:e[6]??``,status:e[7]??``,semester:e[8]??``,schoolYear:e[9]??``})).filter(e=>e.no&&e.tesAwardNumber&&e.studentId&&e.lastName&&e.firstName&&e.batchId&&e.status&&e.semester&&e.schoolYear)}function dr({onLogout:e}){let[t,n]=(0,H.useState)(0),[r,i]=(0,H.useState)(!1),[a,o]=(0,H.useState)(!1),[s,c]=(0,H.useState)(!1),[l,u]=(0,H.useState)(!1),[d,f]=(0,H.useState)(!1),[p,m]=(0,H.useState)(!1),[h,g]=(0,H.useState)(``),[_,v]=(0,H.useState)(!1),[y,b]=(0,H.useState)(!1),[x,S]=(0,H.useState)(!1),[C,w]=(0,H.useState)(!1),[ee,T]=(0,H.useState)(``),[E,D]=(0,H.useState)(!1),[te,O]=(0,H.useState)(null),[ne,re]=(0,H.useState)(null),[k,A]=(0,H.useState)(``),[j,M]=(0,H.useState)(``),[N,P]=(0,H.useState)(!1),[F,I]=(0,H.useState)(!1),[L,ie]=(0,H.useState)(!1),[ae,oe]=(0,H.useState)(!1),[se,ce]=(0,H.useState)(1),[le,ue]=(0,H.useState)(1),[de,fe]=(0,H.useState)([]),[pe,me]=(0,H.useState)(null),[he,ge]=(0,H.useState)(null),[_e,ve]=(0,H.useState)(``),[ye,be]=(0,H.useState)(!1),[xe,Se]=(0,H.useState)(``),[Ce,we]=(0,H.useState)(``),[Te,Ee]=(0,H.useState)(1),[De,R]=(0,H.useState)(1),[Oe,ke]=(0,H.useState)(1),[Ae,je]=(0,H.useState)(1),[Me,Ne]=(0,H.useState)(``),[Pe,Fe]=(0,H.useState)(1),[Ie,Le]=(0,H.useState)(1),Re=ln(kn.quickActions.list),ze=ln(kn.activityLogs.list),Be=ln(kn.allinfo.list),Ve=ln(kn.applicants.list),He=ln(kn.applicantPortal.get),Ue=ln(kn.adminAuth.listStudentAccounts),We=un(kn.applicantPortal.setReceivingApplicants),z=un(kn.allinfo.bulkCreate),Ge=un(kn.allinfo.update),Ke=un(kn.allinfo.deleteMany),qe=un(kn.quickActions.clearAll),Je=un(kn.activityLogs.clearAll),Ye=r||a||s||l||d||p||!!h||_||y||x||!!te||C||!!ee||!!pe,Xe=(0,H.useMemo)(()=>Be??[],[Be]),Ze=Re??[],Qe=ze??[],$e=(0,H.useMemo)(()=>Ve??[],[Ve]),et=(0,H.useMemo)(()=>Ue??[],[Ue]),tt=He?.applicationYear,nt=String(tt??new Date().getFullYear()),rt=(0,H.useMemo)(()=>{let e=new Date().getFullYear(),t=new Set([String(e-1),String(e),String(e+1),String(e+2),String(e+3),String(e+4),String(e+5)]);return tt&&t.add(String(tt)),$e.forEach(e=>{let n=Qn(e);n&&t.add(n)}),Array.from(t).sort()},[$e,tt]),it=Math.max(1,Math.ceil(rt.length/zn)),at=Math.min(Ie,it),ot=(at-1)*zn,st=rt.slice(ot,ot+zn),ct=$n(at,it),lt=rt.length===0?0:ot+1,ut=ot+st.length,dt=(0,H.useMemo)(()=>Array.from(new Set(Xe.map(e=>String(e.batchId??``).trim()).filter(Boolean))).sort(),[Xe]),ft=(0,H.useMemo)(()=>dt.map(e=>{let t=Xe.filter(t=>String(t.batchId??``).trim()===e),n=new Set(t.map(e=>String(e.studentId??``).trim().toLowerCase()));return{accountCount:et.filter(e=>n.has(String(e.schoolId??``).trim().toLowerCase())).length,batchId:e,recordCount:t.length}}),[dt,Xe,et]),pt=(0,H.useMemo)(()=>Bn.map(e=>({applicantCount:$e.filter(t=>Qn(t)===nt&&Zn(t).toLowerCase()===e.toLowerCase()).length,course:e})),[nt,$e]),mt=(0,H.useMemo)(()=>{let e=h.trim().toLowerCase();return e?$e.filter(t=>Qn(t)===nt&&Zn(t).toLowerCase()===e):[]},[nt,$e,h]),ht=(0,H.useMemo)(()=>{let e=Me.trim().toLowerCase();return e?mt.filter(t=>{let n=[t.firstName,t.middleName,t.lastName,t.extensionName].filter(Boolean).join(` `);return[t.studentId,n,t.gender,t.birthDate,t.year,t.address,t.mobileNumber,t.emailAddress,t.status,t.psaFileName,t.schoolIdFileName,t.pwdIdFileName,t.fourPsFileName,Gn(t.submittedAt)].map(e=>String(e??``).toLowerCase()).join(` `).includes(e)}):mt},[Me,mt]),gt=Math.max(1,Math.ceil(ht.length/Rn)),_t=Math.min(Pe,gt),B=(_t-1)*Rn,vt=ht.slice(B,B+Rn),yt=$n(_t,gt),bt=ht.length===0?0:B+1,xt=B+vt.length,St=(0,H.useMemo)(()=>{let e=xe.trim().toLowerCase(),t=Ce.trim().toLowerCase();return Xe.filter(n=>{let r=[n.no,n.tesAwardNumber,n.studentId,n.lastName,n.firstName,n.middleInitial,n.batchId,n.status,n.semester,n.schoolYear].map(e=>String(e??``).toLowerCase()).join(` `),i=e?r.includes(e):!0,a=t?String(n.batchId??``).trim().toLowerCase()===t:!0;return i&&a})},[Xe,xe,Ce]),Ct=Math.max(1,Math.ceil(St.length/Mn)),wt=Math.min(se,Ct),Tt=(wt-1)*Mn,Et=$n(wt,Ct),Dt=St.slice(Tt,Tt+Mn),Ot=St.filter(e=>e.frontIdUrl),kt=(0,H.useMemo)(()=>Array.from(new Set(Ot.map(e=>String(e.schoolYear??``).trim()).filter(Boolean))).sort((e,t)=>t.localeCompare(e)),[Ot]),At=(0,H.useMemo)(()=>kt.map(e=>({fileCount:Ot.filter(t=>String(t.schoolYear??``).trim()===e).length,schoolYear:e})),[Ot,kt]),jt=(0,H.useMemo)(()=>{if(!ee)return[];let e=new Map;return Ot.forEach(t=>{if(String(t.schoolYear??``).trim()!==ee)return;let n=String(t.batchId??``).trim();if(!n)return;let r=e.get(n)??{batchId:n,fileCount:0};r.fileCount+=1,e.set(n,r)}),Array.from(e.values()).sort((e,t)=>e.batchId.localeCompare(t.batchId))},[Ot,ee]),Mt=St.length===0?0:Tt+1,Nt=Tt+Dt.length,Pt=Math.max(1,Math.ceil(Ze.length/Nn)),Ft=Math.min(le,Pt),It=(Ft-1)*Nn,Lt=Ze.slice(It,It+Nn),Rt=Ze.length===0?0:It+1,zt=It+Lt.length,Bt=Math.max(1,Math.ceil(Qe.length/Pn)),Vt=Math.min(Te,Bt),Ht=(Vt-1)*Pn,Ut=Qe.slice(Ht,Ht+Pn),Wt=Qe.length===0?0:Ht+1,Gt=Ht+Ut.length,V=Math.max(1,Math.ceil(ft.length/Fn)),Kt=Math.min(De,V),qt=(Kt-1)*Fn,Jt=ft.slice(qt,qt+Fn),Yt=ft.length===0?0:qt+1,Xt=qt+Jt.length,Zt=Math.max(1,Math.ceil(At.length/In)),Qt=Math.min(Oe,Zt),$t=(Qt-1)*In,en=At.slice($t,$t+In),tn=At.length===0?0:$t+1,nn=$t+en.length,rn=Math.max(1,Math.ceil(jt.length/Ln)),an=Math.min(Ae,rn),on=(an-1)*Ln,sn=jt.slice(on,on+Ln),cn=jt.length===0?0:on+1,dn=on+sn.length,fn=e=>{ce(Math.min(Math.max(e,1),Ct))},pn=e=>{ue(Math.min(Math.max(e,1),Pt))},mn=e=>{Ee(Math.min(Math.max(e,1),Bt))},hn=e=>{R(Math.min(Math.max(e,1),V))},gn=e=>{ke(Math.min(Math.max(e,1),Zt))},_n=e=>{je(Math.min(Math.max(e,1),rn))},vn=e=>{Fe(Math.min(Math.max(e,1),gt))},yn=e=>{Le(Math.min(Math.max(e,1),it))},bn=e=>{g(e),Ne(``),Fe(1)},xn=()=>{g(``),Ne(``),Fe(1)},Sn=e=>{Ne(e.target.value),Fe(1)},Cn=e=>{T(e),je(1)},wn=()=>{E||(w(!1),T(``),je(1))},Tn=()=>{Se(``),we(``),ce(1)},En=e=>{Se(e.target.value),ce(1)},Dn=e=>{we(e.target.value),ce(1)},On=async(e,t)=>{let n=String(e??``).trim(),r=String(t??``).trim(),i=Ot.filter(e=>String(e.schoolYear??``).trim()===n&&String(e.batchId??``).trim()===r);if(i.length!==0){D(!0);try{let e=[];for(let[t,n]of i.entries())try{let r=await tr(n,t);e.push(r)}catch(e){console.warn(e)}if(e.length===0)throw Error(`No School ID files could be downloaded for this batch.`);let t=sr(e),a=URL.createObjectURL(t),o=document.createElement(`a`),s=Yn(n,`school-year`),c=Yn(r,`batch`);o.href=a,o.download=`school-id-files-${s}-batch-${c}.zip`,o.rel=`noreferrer`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a),w(!1),T(``),je(1)}catch(e){window.alert(e instanceof Error?e.message:`Unable to download School ID files.`)}finally{D(!1)}}},jn=e=>{if(Ue===void 0){window.alert(`Please wait while student account data is loading.`);return}let t=String(e??``).trim(),n=Xe.filter(e=>String(e.batchId??``).trim()===t);if(n.length===0){window.alert(`No records found for this batch.`);return}let r=new Map(et.map(e=>[String(e.schoolId??``).trim().toLowerCase(),e])),i=[[`Batch No.`,`Student ID`,`TES Award Number`,`Last Name`,`First Name`,`MI.`,`School Year`,`Status`,`Email Account`,`Phone No.`,`Current Address`,`Account Status`],...n.map(e=>{let t=r.get(String(e.studentId??``).trim().toLowerCase());return[e.batchId??``,e.studentId??``,e.tesAwardNumber??``,e.lastName??``,e.firstName??``,e.middleInitial??``,e.schoolYear??``,e.status??``,t?.email??``,t?.phoneNumber??``,t?.currentAddress??``,t?.status??`No student account`]})];qn(`batch-info-${Yn(t,`batch`)}.csv`,i),b(!1)},Kn=e=>{if(Ve===void 0){window.alert(`Please wait while applicant information is loading.`);return}let t=String(e??``).trim(),n=[[`Application Year`,`Course`,`Student ID`,`Last Name`,`First Name`,`Ext Name`,`Middle Name`,`Gender`,`Birth Date`,`Year`,`Father Last Name`,`Father First Name`,`Father Middle Name`,`Mother Last Name`,`Mother First Name`,`Mother Middle Name`,`Address`,`Zip Code`,`PWD ID`,`PWD ID PDF`,`4Ps ID PDF`,`Mobile No.`,`Email Address`,`Status`,`Submitted At`],...$e.filter(e=>Qn(e)===nt&&Zn(e).toLowerCase()===t.toLowerCase()).map(e=>[Qn(e),Zn(e)||t,e.studentId??``,e.lastName??``,e.firstName??``,e.extensionName??``,e.middleName??``,e.gender??``,e.birthDate??``,e.year??``,e.fatherLastName??``,e.fatherFirstName??``,e.fatherMiddleName??``,e.motherLastName??``,e.motherFirstName??``,e.motherMiddleName??``,e.address??``,e.zipCode??``,e.pwdId??``,e.pwdIdFileName??``,e.fourPsFileName??``,e.mobileNumber??``,e.emailAddress??``,e.status??``,Gn(e.submittedAt)])],r=Yn(t,`course`);qn(`unifast-applicants-${Yn(nt,`application-year`)}-${r}.csv`,n)},er=()=>{if(Re===void 0){window.alert(`Please wait while student requests are loading.`);return}if(Ze.length===0){window.alert(`No student requests are available to export.`);return}let e=Gn(Date.now()),t=[[`No.`,`Student ID`,`Last Name`,`First Name`,`MI`,`Email Account`,`Question / Request`,`Source`,`Status`,`Submitted At`,`Exported At`],...Ze.map((t,n)=>[n+1,t.studentId??``,t.lastName??``,t.firstName??``,t.middleInitial??``,t.email??``,t.question??``,t.source??``,t.status??``,Gn(t.submittedAt),e])];qn(`student-requests-responses-${new Date().toISOString().slice(0,10)}.csv`,t)},nr=()=>{L||Ze.length===0||c(!0)},rr=async()=>{if(!(L||Ze.length===0)){ie(!0);try{await qe({}),ue(1),c(!1)}catch(e){window.alert(e instanceof Error?e.message:`Unable to clear Quick Action messages.`)}finally{ie(!1)}}},ir=async()=>{if(!(ae||Qe.length===0)&&window.confirm(`Clear all ${Qe.length} visible activity logs? This permanently removes all stored logs and cannot be undone.`)){oe(!0);try{await Je({}),Ee(1)}catch(e){window.alert(e instanceof Error?e.message:`Unable to clear activity logs.`)}finally{oe(!1)}}},ar=async(e,t)=>{try{let n=await We({isReceivingApplicants:e,...t?{applicationYear:t}:{}});n.success||window.alert(n.message||`Unable to update applicant portal status.`)}catch(e){window.alert(e instanceof Error?e.message:`Unable to update applicant portal status.`)}},or=async e=>{await ar(!0,e),m(!1),Le(1)},W=()=>{u(!1),f(!1),m(!1),Le(1),g(``),Ne(``),Fe(1)},cr=()=>{R(1),M(``),S(!0)},lr=()=>{F||(S(!1),O(null))},dr=()=>{ue(1),o(!0)},pr=()=>{re(null),A(``),M(``),P(!1),v(!0)},mr=()=>{N||(v(!1),re(null),A(``),P(!1))},hr=()=>{ye||(me(null),ge(null),ve(``))},gr=e=>{me(e),ge({no:e.no??``,tesAwardNumber:e.tesAwardNumber??``,studentId:e.studentId??``,lastName:e.lastName??``,firstName:e.firstName??``,middleInitial:e.middleInitial??``,batchId:e.batchId??``,status:e.status??``,semester:e.semester??``,schoolYear:e.schoolYear??``}),ve(``)},_r=e=>t=>{ve(``),ge(n=>({...n,[e]:t.target.value}))},vr=async e=>{if(e.preventDefault(),!(!pe||!he)){if([`no`,`tesAwardNumber`,`studentId`,`lastName`,`firstName`,`batchId`,`status`,`semester`,`schoolYear`].some(e=>!String(he[e]??``).trim())){ve(`Please complete all required fields before saving.`);return}be(!0),ve(`Saving changes...`);try{await Ge({id:pe._id,...he}),ve(`Record updated successfully.`),me(null),ge(null)}catch(e){ve(e instanceof Error?e.message:`Unable to update record.`)}finally{be(!1)}}},yr=e=>{M(``),fe(t=>t.includes(e)?t.filter(t=>t!==e):[...t,e])},br=async()=>{if(de.length===0){M(`Please check at least one record before deleting.`);return}if(window.confirm(`Delete ${de.length} checked record${de.length===1?``:`s`}?`)){I(!0),M(`Deleting checked record...`);try{let e=await Ke({ids:de});fe([]),M(`${e?.deleted??de.length} record${(e?.deleted??de.length)===1?``:`s`} deleted successfully.`)}catch(e){M(e instanceof Error?e.message:`Unable to delete records.`)}finally{I(!1)}}};return(0,H.useEffect)(()=>{let e=()=>{let e=document.documentElement.scrollTop||document.body.scrollTop,t=document.documentElement.scrollHeight-document.documentElement.clientHeight;n(t>0?e/t:0)};return e(),window.addEventListener(`scroll`,e,{passive:!0}),()=>window.removeEventListener(`scroll`,e)},[]),(0,H.useEffect)(()=>{if(!Ye)return;let e=e=>{if(e.key===`Escape`){if(s&&!L){c(!1);return}i(!1),o(!1),c(!1),u(!1),f(!1),m(!1),Le(1),g(``),Ne(``),Fe(1),v(!1),b(!1),S(!1),O(null),w(!1),T(``),je(1),re(null),A(``),P(!1),me(null)}};return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),()=>{document.body.style.overflow=``,window.removeEventListener(`keydown`,e)}},[Ye,L,s]),(0,U.jsxs)(`div`,{className:`admin-page`,children:[(0,U.jsx)(`style`,{children:fr}),(0,U.jsxs)(`header`,{className:`admin-topbar`,children:[(0,U.jsxs)(`div`,{className:`brand-lockup`,children:[(0,U.jsx)(`div`,{className:`brand-mark`,children:(0,U.jsx)(`img`,{alt:`IBACMI`,className:`brand-mark__image`,src:An})}),(0,U.jsxs)(`div`,{className:`brand-copy`,children:[(0,U.jsx)(`p`,{className:`brand-title`,children:`IBACMI`}),(0,U.jsx)(`p`,{className:`brand-subtitle`,children:`Scholarship Office`})]})]}),(0,U.jsxs)(`div`,{className:`header-actions`,children:[(0,U.jsxs)(`button`,{className:`admin-button admin-button--ghost`,onClick:()=>{Ee(1),i(!0)},type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`history`}),`Logs`]}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--ghost`,onClick:()=>u(!0),type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`folder_open`}),`UNIFAST PORTAL`]}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--ghost`,onClick:dr,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`task_alt`}),`Quick Actions`]}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--admin`,onClick:e,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`logout`}),`Logout`]})]})]}),(0,U.jsx)(`main`,{className:`admin-main`,children:(0,U.jsxs)(`div`,{className:`admin-container`,children:[(0,U.jsxs)(`section`,{className:`admin-heading`,children:[(0,U.jsxs)(`div`,{className:`admin-heading__copy`,children:[(0,U.jsx)(`span`,{className:`admin-eyebrow`,children:`Grantee Management`}),(0,U.jsx)(`h1`,{children:`Grantee Management`}),(0,U.jsx)(`p`,{children:`Manage TES grantee records, review student requests, upload CSV records, and monitor scholarship information in one responsive workspace.`})]}),(0,U.jsxs)(`div`,{className:`admin-heading__actions`,children:[(0,U.jsxs)(`button`,{className:`admin-button admin-button--secondary`,disabled:dt.length===0,onClick:()=>{R(1),b(!0)},title:dt.length===0?`No batches available to export`:`Choose a batch to export student account info`,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`table_view`}),`Export to CSV Batch Info`]}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--secondary`,disabled:Ot.length===0,onClick:()=>{ke(1),w(!0)},title:Ot.length===0?`No School ID files available to download`:`Choose a School Year to download School ID files`,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`download`}),`Download School ID File`]}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--primary`,onClick:pr,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`add`}),`Add New Record`]}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--danger`,disabled:dt.length===0,onClick:cr,title:dt.length===0?`No batches available to delete`:`Choose a batch to delete`,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`delete`}),`Delete Batch`]})]})]}),(0,U.jsxs)(`section`,{className:`admin-stats-grid`,"aria-label":`Grantee summary`,children:[(0,U.jsxs)(`div`,{className:`admin-stat-card`,children:[(0,U.jsx)(`span`,{children:`Total Records`}),(0,U.jsx)(`strong`,{children:Xe.length})]}),(0,U.jsxs)(`div`,{className:`admin-stat-card`,children:[(0,U.jsx)(`span`,{children:`Filtered Results`}),(0,U.jsx)(`strong`,{children:St.length})]}),(0,U.jsxs)(`div`,{className:`admin-stat-card`,children:[(0,U.jsx)(`span`,{children:`Checked Records`}),(0,U.jsx)(`strong`,{children:de.length})]}),(0,U.jsxs)(`div`,{className:`admin-stat-card`,children:[(0,U.jsx)(`span`,{children:`Student Requests`}),(0,U.jsx)(`strong`,{children:Ze.length})]})]}),(0,U.jsxs)(`section`,{className:`admin-filter-panel`,"aria-label":`Grantee filters`,children:[(0,U.jsxs)(`div`,{className:`admin-search-field`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`search`}),(0,U.jsx)(`input`,{placeholder:`Search by Student ID, award number, status, semester...`,type:`text`,value:xe,onChange:En})]}),(0,U.jsxs)(`select`,{value:Ce,onChange:Dn,children:[(0,U.jsx)(`option`,{value:``,children:`All Batches`}),dt.map(e=>(0,U.jsx)(`option`,{value:e,children:e},e))]}),(0,U.jsx)(`button`,{className:`admin-filter-button`,type:`button`,"aria-label":`Reset filters`,title:`Reset filters`,onClick:Tn,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`refresh`})})]}),(0,U.jsxs)(`section`,{className:`admin-table-card`,"aria-label":`TDP grantee records`,children:[(0,U.jsx)(`div`,{className:`admin-table-header`,children:(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`h2`,{children:`Grantee Records`}),(0,U.jsx)(`p`,{children:`Review, check, edit, or delete selected records.`})]})}),(0,U.jsx)(`div`,{className:`admin-table-scroll`,children:(0,U.jsxs)(`table`,{children:[(0,U.jsx)(`thead`,{children:(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`th`,{children:`No.`}),(0,U.jsx)(`th`,{children:`TES Award Number`}),(0,U.jsx)(`th`,{children:`Student ID`}),(0,U.jsx)(`th`,{children:`Last Name`}),(0,U.jsx)(`th`,{children:`First Name`}),(0,U.jsx)(`th`,{children:`MI.`}),(0,U.jsx)(`th`,{children:`Batch No.`}),(0,U.jsx)(`th`,{children:`Status`}),(0,U.jsx)(`th`,{children:`Semester`}),(0,U.jsx)(`th`,{children:`School Year`}),(0,U.jsx)(`th`,{children:`School ID File`}),(0,U.jsx)(`th`,{children:`Actions`})]})}),(0,U.jsxs)(`tbody`,{children:[Be===void 0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`admin-empty-state`,colSpan:12,children:`Loading grantee records...`})}),Be?.length===0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`admin-empty-state`,colSpan:12,children:`No grantee records yet. Upload a CSV file to add records.`})}),Be&&Be.length>0&&St.length===0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`admin-empty-state`,colSpan:12,children:`No matching record found.`})}),Dt.map((e,t)=>(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`td`,{"data-label":`No.`,children:Tt+t+1}),(0,U.jsx)(`td`,{className:`admin-award-cell`,"data-label":`TES Award Number`,children:e.tesAwardNumber}),(0,U.jsx)(`td`,{"data-label":`Student ID`,children:e.studentId}),(0,U.jsx)(`td`,{"data-label":`Last Name`,children:e.lastName||`—`}),(0,U.jsx)(`td`,{"data-label":`First Name`,children:e.firstName||`—`}),(0,U.jsx)(`td`,{"data-label":`MI.`,children:e.middleInitial||`—`}),(0,U.jsx)(`td`,{className:`admin-batch-cell`,"data-label":`Batch No.`,children:e.batchId}),(0,U.jsx)(`td`,{"data-label":`Status`,children:(0,U.jsx)(Un,{status:e.status,tone:Wn(e.status)})}),(0,U.jsx)(`td`,{"data-label":`Semester`,children:e.semester||`—`}),(0,U.jsx)(`td`,{"data-label":`School Year`,children:e.schoolYear||`—`}),(0,U.jsx)(`td`,{"data-label":`School ID File`,children:e.frontIdUrl?(0,U.jsx)(`a`,{className:`admin-file-link`,href:e.frontIdUrl,rel:`noreferrer`,target:`_blank`,children:`View file`}):(0,U.jsx)(`span`,{className:`admin-file-empty`,children:`No file`})}),(0,U.jsx)(`td`,{"data-label":`Actions`,children:(0,U.jsxs)(`div`,{className:`admin-row-actions`,children:[(0,U.jsx)(`button`,{className:`admin-edit-button`,type:`button`,onClick:()=>gr(e),children:`Edit`}),(0,U.jsxs)(`label`,{className:`admin-checkbox-control`,children:[(0,U.jsx)(`input`,{type:`checkbox`,checked:de.includes(e._id),onChange:()=>yr(e._id)}),(0,U.jsx)(`span`,{children:`Check`})]}),(0,U.jsx)(`button`,{className:`admin-delete-button`,type:`button`,disabled:F||!de.includes(e._id),onClick:br,children:`Delete`})]})})]},e._id))]})]})}),(0,U.jsxs)(`div`,{className:`admin-pagination`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:Mt}),` to `,(0,U.jsx)(`strong`,{children:Nt}),` of`,` `,(0,U.jsx)(`strong`,{children:St.length}),` results`]}),j&&(0,U.jsx)(`p`,{className:`admin-delete-message`,children:j})]}),(0,U.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,U.jsx)(`button`,{type:`button`,disabled:wt===1||St.length===0,"aria-label":`Previous page`,onClick:()=>fn(wt-1),children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Et.map(e=>{if(typeof e==`string`)return(0,U.jsx)(`span`,{className:`admin-pagination__ellipsis`,children:`...`},e);let t=e;return(0,U.jsx)(`button`,{"aria-current":wt===t?`page`:void 0,className:wt===t?`admin-page-button--active`:void 0,disabled:St.length===0,onClick:()=>fn(t),type:`button`,children:t},t)}),(0,U.jsx)(`button`,{type:`button`,disabled:wt===Ct||St.length===0,"aria-label":`Next page`,onClick:()=>fn(wt+1),children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]})]})]})}),r&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-logs-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close logs modal`,className:`admin-modal-backdrop`,onClick:()=>i(!1),type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--wide`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Activity Logs`}),(0,U.jsx)(`h2`,{id:`admin-logs-title`,children:`System Activity Records`}),(0,U.jsx)(`p`,{children:`Review recent uploads, edits, deletes, student updates, and page actions.`})]}),(0,U.jsx)(`button`,{"aria-label":`Close logs`,className:`admin-modal-close`,onClick:()=>i(!1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsxs)(`div`,{className:`admin-logs-toolbar`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{children:`Log Management`}),(0,U.jsx)(`strong`,{children:`Permanently remove all system activity records.`})]}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--danger`,disabled:ze===void 0||Qe.length===0||ae,onClick:ir,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`delete_sweep`}),ae?`Clearing...`:`Clear All Logs`]})]}),(0,U.jsx)(`div`,{className:`admin-logs-table-wrap`,children:(0,U.jsxs)(`table`,{className:`admin-logs-table`,children:[(0,U.jsx)(`thead`,{children:(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`th`,{children:`Date & Time`}),(0,U.jsx)(`th`,{children:`Action`}),(0,U.jsx)(`th`,{children:`Actor`}),(0,U.jsx)(`th`,{children:`Target`}),(0,U.jsx)(`th`,{children:`Summary`})]})}),(0,U.jsxs)(`tbody`,{children:[ze===void 0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`admin-empty-state`,colSpan:5,children:`Loading activity logs...`})}),ze&&Qe.length===0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`admin-empty-state`,colSpan:5,children:`No activity logs recorded yet.`})}),Ut.map(e=>(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`td`,{"data-label":`Date & Time`,children:Vn(e.createdAt)}),(0,U.jsx)(`td`,{"data-label":`Action`,children:(0,U.jsx)(`span`,{className:`admin-log-action`,children:e.action})}),(0,U.jsxs)(`td`,{"data-label":`Actor`,children:[(0,U.jsx)(`strong`,{children:e.actorName||e.actorId||e.actorRole}),(0,U.jsx)(`span`,{children:e.actorRole})]}),(0,U.jsxs)(`td`,{"data-label":`Target`,children:[(0,U.jsx)(`strong`,{children:e.targetLabel||e.targetType}),(0,U.jsx)(`span`,{children:e.targetType})]}),(0,U.jsx)(`td`,{"data-label":`Summary`,children:e.summary})]},e._id))]})]})}),(0,U.jsxs)(`div`,{className:`admin-pagination admin-logs-pagination`,children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:Wt}),` to `,(0,U.jsx)(`strong`,{children:Gt}),` of`,` `,(0,U.jsx)(`strong`,{children:Qe.length}),` logs`]}),(0,U.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,U.jsx)(`button`,{type:`button`,disabled:Vt===1||Qe.length===0,"aria-label":`Previous logs page`,onClick:()=>mn(Vt-1),children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:Bt},(e,t)=>{let n=t+1;return(0,U.jsx)(`button`,{className:Vt===n?`admin-page-button--active`:void 0,disabled:Qe.length===0,onClick:()=>mn(n),type:`button`,children:n},n)}),(0,U.jsx)(`button`,{type:`button`,disabled:Vt===Bt||Qe.length===0,"aria-label":`Next logs page`,onClick:()=>mn(Vt+1),children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]})]})]}),y&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-batch-export-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close batch export modal`,className:`admin-modal-backdrop`,onClick:()=>b(!1),type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Batch CSV Export`}),(0,U.jsx)(`h2`,{id:`admin-batch-export-title`,children:`Choose Batch`}),(0,U.jsx)(`p`,{children:`Export student account information for a specific batch using allinfo Student IDs.`})]}),(0,U.jsx)(`button`,{"aria-label":`Close batch export`,className:`admin-modal-close`,onClick:()=>b(!1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsx)(`div`,{className:`admin-school-year-downloads`,children:Jt.map(({accountCount:e,batchId:t,recordCount:n})=>(0,U.jsxs)(`button`,{className:`admin-school-year-button`,disabled:Ue===void 0,onClick:()=>jn(t),type:`button`,children:[(0,U.jsx)(`span`,{children:t}),(0,U.jsx)(`strong`,{children:Ue===void 0?`Loading accounts...`:`${n} records / ${e} accounts`})]},t))}),(0,U.jsxs)(`div`,{className:`admin-pagination admin-batch-export-pagination`,children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:Yt}),`-`,(0,U.jsx)(`strong`,{children:Xt}),` `,`of `,(0,U.jsx)(`strong`,{children:ft.length}),` batches`]}),(0,U.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,U.jsx)(`button`,{disabled:Kt===1,onClick:()=>hn(Kt-1),type:`button`,"aria-label":`Previous batch export page`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:V},(e,t)=>{let n=t+1;return(0,U.jsx)(`button`,{"aria-current":Kt===n?`page`:void 0,className:Kt===n?`admin-page-button--active`:void 0,onClick:()=>hn(n),type:`button`,children:n},n)}),(0,U.jsx)(`button`,{disabled:Kt===V,onClick:()=>hn(Kt+1),type:`button`,"aria-label":`Next batch export page`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,U.jsx)(`div`,{className:`admin-upload-actions`,children:(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:()=>b(!1),type:`button`,children:`Cancel`})})]})]}),x&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-batch-delete-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close batch delete modal`,className:`admin-modal-backdrop`,onClick:lr,type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Delete Batch`}),(0,U.jsx)(`h2`,{id:`admin-batch-delete-title`,children:`Choose Batch`}),(0,U.jsx)(`p`,{children:`Select a batch to delete all information records under that batch.`})]}),(0,U.jsx)(`button`,{"aria-label":`Close batch delete`,className:`admin-modal-close`,disabled:F,onClick:lr,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsx)(`div`,{className:`admin-school-year-downloads`,children:Jt.map(({batchId:e,recordCount:t})=>(0,U.jsxs)(`button`,{className:`admin-school-year-button admin-school-year-button--danger`,disabled:F,onClick:()=>O({batchId:e,recordCount:t}),type:`button`,children:[(0,U.jsx)(`span`,{children:e}),(0,U.jsxs)(`strong`,{children:[t,` `,t===1?`record`:`records`]})]},e))}),(0,U.jsxs)(`div`,{className:`admin-pagination admin-batch-export-pagination`,children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:Yt}),`-`,(0,U.jsx)(`strong`,{children:Xt}),` `,`of `,(0,U.jsx)(`strong`,{children:ft.length}),` batches`]}),(0,U.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,U.jsx)(`button`,{"aria-label":`Previous batch delete page`,disabled:Kt===1||F,onClick:()=>hn(Kt-1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:V},(e,t)=>{let n=t+1;return(0,U.jsx)(`button`,{"aria-current":Kt===n?`page`:void 0,className:Kt===n?`admin-page-button--active`:void 0,disabled:F,onClick:()=>hn(n),type:`button`,children:n},n)}),(0,U.jsx)(`button`,{"aria-label":`Next batch delete page`,disabled:Kt===V||F,onClick:()=>hn(Kt+1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,U.jsx)(`div`,{className:`admin-upload-actions`,children:(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:F,onClick:lr,type:`button`,children:`Cancel`})})]})]}),te&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-batch-delete-confirm-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close batch delete confirmation`,className:`admin-modal-backdrop`,onClick:()=>{F||O(null)},type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--compact admin-modal-card--applicant-years`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Confirm Delete`}),(0,U.jsx)(`h2`,{id:`admin-batch-delete-confirm-title`,children:`Delete this batch information?`}),(0,U.jsx)(`p`,{children:`Are you sure you want to delete this batch information?`})]}),(0,U.jsx)(`button`,{"aria-label":`Close batch delete confirmation`,className:`admin-modal-close`,disabled:F,onClick:()=>O(null),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsxs)(`div`,{className:`admin-confirm-body`,children:[(0,U.jsx)(`strong`,{children:te.batchId}),(0,U.jsxs)(`p`,{children:[`This will permanently delete `,te.recordCount,` `,te.recordCount===1?`record`:`records`,` from this batch.`]})]}),(0,U.jsxs)(`div`,{className:`admin-upload-actions`,children:[(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:F,onClick:()=>O(null),type:`button`,children:`Cancel`}),(0,U.jsx)(`button`,{className:`admin-button admin-button--danger`,disabled:F,onClick:async()=>{if(!te)return;let e=te.batchId,t=Xe.filter(t=>String(t.batchId??``).trim()===e).map(e=>e._id);if(t.length===0){M(`No records found for this batch.`),O(null);return}I(!0),M(`Deleting batch ${e}...`);try{let n=await Ke({ids:t});fe(e=>e.filter(e=>!t.includes(e))),M(`${n?.deleted??t.length} record${(n?.deleted??t.length)===1?``:`s`} deleted from batch ${e}.`),O(null),S(!1),ce(1)}catch(e){M(e instanceof Error?e.message:`Unable to delete batch records.`)}finally{I(!1)}},type:`button`,children:F?`Deleting...`:`Delete Batch`})]})]})]}),l&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-unifast-open-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close UNIFAST portal confirmation`,className:`admin-modal-backdrop`,onClick:W,type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--compact`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`UNIFAST Portal`}),(0,U.jsx)(`h2`,{id:`admin-unifast-open-title`,children:`Open the portal?`}),(0,U.jsx)(`p`,{children:`Do you want to open the portal for receiving applicants information?`})]}),(0,U.jsx)(`button`,{"aria-label":`Close UNIFAST portal confirmation`,className:`admin-modal-close`,onClick:W,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsx)(`div`,{className:`admin-confirm-body`,children:(0,U.jsx)(`p`,{children:`Select Yes to view applicants by course and prepare a course download.`})}),(0,U.jsxs)(`div`,{className:`admin-upload-actions`,children:[(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:W,type:`button`,children:`No`}),(0,U.jsx)(`button`,{className:`admin-button admin-button--primary`,onClick:()=>{u(!1),f(!0)},type:`button`,children:`Yes`})]})]})]}),d&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-unifast-courses-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close UNIFAST portal courses`,className:`admin-modal-backdrop`,onClick:W,type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Receiving Applicants Information`}),(0,U.jsx)(`h2`,{id:`admin-unifast-courses-title`,children:`Choose Course`}),(0,U.jsxs)(`p`,{children:[`Select a specific course to download applicant information for `,nt,`.`]})]}),(0,U.jsx)(`button`,{"aria-label":`Close UNIFAST portal courses`,className:`admin-modal-close`,onClick:W,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsxs)(`div`,{className:`admin-applicant-portal-controls`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{children:`Landing Portal Status`}),(0,U.jsx)(`strong`,{children:He?.isReceivingApplicants?`Receiving ${nt} applicants`:`Closed for applicants`})]}),(0,U.jsxs)(`div`,{className:`admin-applicant-portal-actions`,children:[(0,U.jsx)(`button`,{className:`admin-button admin-button--primary`,disabled:He===void 0||He?.isReceivingApplicants,onClick:()=>{Le(1),m(!0)},type:`button`,children:`Receive Applicants`}),(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:He===void 0||!He?.isReceivingApplicants,onClick:()=>ar(!1),type:`button`,children:`Close Applicants`})]})]}),(0,U.jsx)(`div`,{className:`admin-school-year-downloads admin-course-downloads`,children:pt.map(({applicantCount:e,course:t})=>(0,U.jsxs)(`button`,{className:`admin-school-year-button`,disabled:Ve===void 0,onClick:()=>bn(t),type:`button`,children:[(0,U.jsx)(`span`,{children:t}),(0,U.jsx)(`strong`,{children:Ve===void 0?`Loading...`:`${e} ${e===1?`applicant`:`applicants`}`})]},t))}),(0,U.jsx)(`div`,{className:`admin-upload-actions`,children:(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:W,type:`button`,children:`Cancel`})})]})]}),p&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-applicant-year-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close applicant year selection`,className:`admin-modal-backdrop`,onClick:()=>{m(!1),Le(1)},type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--compact`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Receive Applicants`}),(0,U.jsx)(`h2`,{id:`admin-applicant-year-title`,children:`Choose Application Year`}),(0,U.jsx)(`p`,{children:`Select the year for the new applicant cycle. Counts and downloads will use this year.`})]}),(0,U.jsx)(`button`,{"aria-label":`Close applicant year selection`,className:`admin-modal-close`,onClick:()=>{m(!1),Le(1)},type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsx)(`div`,{className:`admin-year-options`,children:st.map(e=>(0,U.jsxs)(`button`,{className:`admin-year-option`,onClick:()=>or(e),type:`button`,children:[(0,U.jsx)(`span`,{children:e}),(0,U.jsxs)(`strong`,{children:[$e.filter(t=>Qn(t)===e).length,` `,`existing applicants`]})]},e))}),(0,U.jsxs)(`div`,{className:`admin-pagination admin-applicant-year-pagination`,children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:lt}),` to`,` `,(0,U.jsx)(`strong`,{children:ut}),` of`,` `,(0,U.jsx)(`strong`,{children:rt.length}),` years`]}),(0,U.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,U.jsx)(`button`,{"aria-label":`Previous application years page`,disabled:at===1||rt.length===0,onClick:()=>yn(at-1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),ct.map(e=>typeof e==`number`?(0,U.jsx)(`button`,{className:at===e?`admin-page-button--active`:void 0,disabled:rt.length===0,onClick:()=>yn(e),type:`button`,children:e},e):(0,U.jsx)(`span`,{className:`admin-pagination__ellipsis`,children:`...`},e)),(0,U.jsx)(`button`,{"aria-label":`Next application years page`,disabled:at===it||rt.length===0,onClick:()=>yn(at+1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,U.jsx)(`div`,{className:`admin-upload-actions`,children:(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:()=>{m(!1),Le(1)},type:`button`,children:`Cancel`})})]})]}),h&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-course-applicants-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close course applicants`,className:`admin-modal-backdrop`,onClick:xn,type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card admin-course-applicants-modal`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Course Applicants Information`}),(0,U.jsx)(`h2`,{id:`admin-course-applicants-title`,children:`Applicants Table`}),(0,U.jsxs)(`p`,{children:[h,` applicants for `,nt,`.`]})]}),(0,U.jsx)(`button`,{"aria-label":`Close course applicants`,className:`admin-modal-close`,onClick:xn,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsxs)(`div`,{className:`admin-course-applicants-toolbar`,children:[(0,U.jsxs)(`div`,{className:`admin-search-field admin-course-applicant-search`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`search`}),(0,U.jsx)(`input`,{"aria-label":`Search course applicants`,placeholder:`Search applicant name, ID, email, mobile, status...`,type:`search`,value:Me,onChange:Sn})]}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--primary`,disabled:Ve===void 0||mt.length===0,onClick:()=>Kn(h),type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`download`}),`Download All Applicants Info`]})]}),(0,U.jsxs)(`div`,{className:`admin-course-applicants-summary`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{children:`Total Course Applicants`}),(0,U.jsx)(`strong`,{children:mt.length})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{children:`Filtered Results`}),(0,U.jsx)(`strong`,{children:ht.length})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{children:`Rows Per Page`}),(0,U.jsx)(`strong`,{children:Rn})]})]}),(0,U.jsx)(`div`,{className:`admin-course-applicants-table-wrap`,children:(0,U.jsxs)(`table`,{className:`admin-course-applicants-table`,children:[(0,U.jsx)(`thead`,{children:(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`th`,{children:`No.`}),(0,U.jsx)(`th`,{children:`Student ID`}),(0,U.jsx)(`th`,{children:`Applicant Name`}),(0,U.jsx)(`th`,{children:`Gender`}),(0,U.jsx)(`th`,{children:`Birth Date`}),(0,U.jsx)(`th`,{children:`Year`}),(0,U.jsx)(`th`,{children:`Mobile No.`}),(0,U.jsx)(`th`,{children:`Email Address`}),(0,U.jsx)(`th`,{children:`Address`}),(0,U.jsx)(`th`,{children:`PSA`}),(0,U.jsx)(`th`,{children:`School ID`}),(0,U.jsx)(`th`,{children:`PWD ID PDF`}),(0,U.jsx)(`th`,{children:`4Ps ID PDF`}),(0,U.jsx)(`th`,{children:`Status`}),(0,U.jsx)(`th`,{children:`Submitted`})]})}),(0,U.jsxs)(`tbody`,{children:[Ve===void 0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`admin-empty-state`,colSpan:15,children:`Loading applicants...`})}),Ve!==void 0&&ht.length===0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`admin-empty-state`,colSpan:15,children:`No applicants found for this course.`})}),vt.map((e,t)=>{let n=[e.firstName,e.middleName,e.lastName,e.extensionName].filter(Boolean).join(` `)||`No name`;return(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`td`,{"data-label":`No.`,children:B+t+1}),(0,U.jsx)(`td`,{"data-label":`Student ID`,children:e.studentId}),(0,U.jsx)(`td`,{className:`admin-applicant-name`,"data-label":`Applicant Name`,children:n}),(0,U.jsx)(`td`,{"data-label":`Gender`,children:e.gender}),(0,U.jsx)(`td`,{"data-label":`Birth Date`,children:e.birthDate}),(0,U.jsx)(`td`,{"data-label":`Year`,children:e.year}),(0,U.jsx)(`td`,{"data-label":`Mobile No.`,children:e.mobileNumber}),(0,U.jsx)(`td`,{className:`admin-applicant-email`,"data-label":`Email Address`,children:e.emailAddress}),(0,U.jsx)(`td`,{className:`admin-applicant-address`,"data-label":`Address`,children:e.address}),(0,U.jsx)(`td`,{"data-label":`PSA`,children:e.psaFileUrl?(0,U.jsxs)(`a`,{className:`admin-applicant-file-link`,href:e.psaFileUrl,rel:`noreferrer`,target:`_blank`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`picture_as_pdf`}),`View PSA`]}):(0,U.jsx)(`span`,{className:`admin-applicant-file-missing`,children:`No file`})}),(0,U.jsx)(`td`,{"data-label":`School ID`,children:e.schoolIdFileUrl?(0,U.jsxs)(`a`,{className:`admin-applicant-file-link`,href:e.schoolIdFileUrl,rel:`noreferrer`,target:`_blank`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`badge`}),`View School ID`]}):(0,U.jsx)(`span`,{className:`admin-applicant-file-missing`,children:`No file`})}),(0,U.jsx)(`td`,{"data-label":`PWD ID PDF`,children:e.pwdIdFileUrl?(0,U.jsxs)(`a`,{className:`admin-applicant-file-link`,href:e.pwdIdFileUrl,rel:`noreferrer`,target:`_blank`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`accessible`}),`View PWD ID`]}):(0,U.jsx)(`span`,{className:`admin-applicant-file-missing`,children:`Optional`})}),(0,U.jsx)(`td`,{"data-label":`4Ps ID PDF`,children:e.fourPsFileUrl?(0,U.jsxs)(`a`,{className:`admin-applicant-file-link`,href:e.fourPsFileUrl,rel:`noreferrer`,target:`_blank`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`family_restroom`}),`View 4Ps ID`]}):(0,U.jsx)(`span`,{className:`admin-applicant-file-missing`,children:`Optional`})}),(0,U.jsx)(`td`,{"data-label":`Status`,children:(0,U.jsx)(Un,{status:e.status,tone:Wn(e.status)})}),(0,U.jsx)(`td`,{"data-label":`Submitted`,children:Gn(e.submittedAt)})]},e._id)})]})]})}),(0,U.jsxs)(`div`,{className:`admin-pagination admin-course-applicants-pagination`,children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:bt}),` to`,` `,(0,U.jsx)(`strong`,{children:xt}),` of`,` `,(0,U.jsx)(`strong`,{children:ht.length}),` applicants`]}),(0,U.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,U.jsx)(`button`,{"aria-label":`Previous course applicants page`,disabled:_t===1||ht.length===0,onClick:()=>vn(_t-1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),yt.map(e=>typeof e==`number`?(0,U.jsx)(`button`,{className:_t===e?`admin-page-button--active`:void 0,disabled:ht.length===0,onClick:()=>vn(e),type:`button`,children:e},e):(0,U.jsx)(`span`,{className:`admin-pagination__ellipsis`,children:`...`},e)),(0,U.jsx)(`button`,{"aria-label":`Next course applicants page`,disabled:_t===gt||ht.length===0,onClick:()=>vn(_t+1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,U.jsx)(`div`,{className:`admin-upload-actions`,children:(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,onClick:xn,type:`button`,children:`Close`})})]})]}),C&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-school-id-download-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close School ID download modal`,className:`admin-modal-backdrop`,onClick:wn,type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`School ID Files`}),(0,U.jsx)(`h2`,{id:`admin-school-id-download-title`,children:`Choose School Year`}),(0,U.jsx)(`p`,{children:`Download all uploaded School ID files for a specific School Year.`})]}),(0,U.jsx)(`button`,{"aria-label":`Close School ID download`,className:`admin-modal-close`,disabled:E,onClick:wn,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsx)(`div`,{className:`admin-school-year-downloads`,children:en.map(({fileCount:e,schoolYear:t})=>(0,U.jsxs)(`button`,{className:`admin-school-year-button`,disabled:E,onClick:()=>Cn(t),type:`button`,children:[(0,U.jsx)(`span`,{children:t}),(0,U.jsx)(`strong`,{children:E?`Preparing...`:`${e} ${e===1?`file`:`files`}`})]},t))}),(0,U.jsxs)(`div`,{className:`admin-pagination admin-school-id-pagination`,children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:tn}),`-`,(0,U.jsx)(`strong`,{children:nn}),` of`,` `,(0,U.jsx)(`strong`,{children:At.length}),` school years`]}),(0,U.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,U.jsx)(`button`,{"aria-label":`Previous School ID page`,disabled:Qt===1||E,onClick:()=>gn(Qt-1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:Zt},(e,t)=>{let n=t+1;return(0,U.jsx)(`button`,{"aria-current":Qt===n?`page`:void 0,className:Qt===n?`admin-page-button--active`:void 0,disabled:E,onClick:()=>gn(n),type:`button`,children:n},n)}),(0,U.jsx)(`button`,{"aria-label":`Next School ID page`,disabled:Qt===Zt||E,onClick:()=>gn(Qt+1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,U.jsx)(`div`,{className:`admin-upload-actions`,children:(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:E,onClick:wn,type:`button`,children:`Cancel`})})]})]}),ee&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-school-id-batch-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close School ID batch modal`,className:`admin-modal-backdrop`,onClick:()=>{E||T(``)},type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`School ID Files`}),(0,U.jsx)(`h2`,{id:`admin-school-id-batch-title`,children:`Choose Batch`}),(0,U.jsxs)(`p`,{children:[`Download uploaded School ID files for `,ee,` by batch. File names include Student ID, last name, first name, middle name, and batch no.`]})]}),(0,U.jsx)(`button`,{"aria-label":`Close School ID batch download`,className:`admin-modal-close`,disabled:E,onClick:()=>T(``),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsxs)(`div`,{className:`admin-school-year-downloads`,children:[sn.map(({batchId:e,fileCount:t})=>(0,U.jsxs)(`button`,{className:`admin-school-year-button`,disabled:E,onClick:()=>On(ee,e),type:`button`,children:[(0,U.jsx)(`span`,{children:e}),(0,U.jsx)(`strong`,{children:E?`Preparing...`:`${t} ${t===1?`file`:`files`}`})]},e)),jt.length===0&&(0,U.jsx)(`div`,{className:`admin-modal-empty-state`,children:`No batches with uploaded School ID files were found for this School Year.`})]}),(0,U.jsxs)(`div`,{className:`admin-pagination admin-school-id-pagination`,children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:cn}),`-`,(0,U.jsx)(`strong`,{children:dn}),` of`,` `,(0,U.jsx)(`strong`,{children:jt.length}),` batches`]}),(0,U.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,U.jsx)(`button`,{"aria-label":`Previous School ID batch page`,disabled:an===1||E,onClick:()=>_n(an-1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:rn},(e,t)=>{let n=t+1;return(0,U.jsx)(`button`,{"aria-current":an===n?`page`:void 0,className:an===n?`admin-page-button--active`:void 0,disabled:E,onClick:()=>_n(n),type:`button`,children:n},n)}),(0,U.jsx)(`button`,{"aria-label":`Next School ID batch page`,disabled:an===rn||E,onClick:()=>_n(an+1),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]}),(0,U.jsx)(`div`,{className:`admin-upload-actions`,children:(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:E,onClick:()=>T(``),type:`button`,children:`Back`})})]})]}),pe&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-edit-record-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close edit record modal`,className:`admin-modal-backdrop`,onClick:hr,type:`button`}),(0,U.jsxs)(`form`,{className:`admin-modal-card admin-modal-card--edit`,onSubmit:vr,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header admin-modal-header--edit`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Edit Record`}),(0,U.jsx)(`h2`,{id:`admin-edit-record-title`,children:`Edit Grantee Information`}),(0,U.jsx)(`p`,{children:`Update the selected grantee record details.`})]}),(0,U.jsx)(`button`,{"aria-label":`Close edit record`,className:`admin-modal-close`,disabled:ye,onClick:hr,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsxs)(`div`,{className:`admin-edit-summary`,children:[(0,U.jsx)(`div`,{className:`admin-edit-summary__icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`person`})}),(0,U.jsxs)(`div`,{className:`admin-edit-summary__text`,children:[(0,U.jsx)(`span`,{children:`Selected Record`}),(0,U.jsx)(`strong`,{children:pe.studentId||`No Student ID`}),(0,U.jsx)(Un,{status:pe.status,tone:Wn(pe.status)})]})]}),(0,U.jsxs)(`div`,{className:`admin-record-details admin-record-details--responsive`,children:[(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`No.`}),(0,U.jsx)(`input`,{value:he?.no??``,onChange:_r(`no`)})]}),(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`TES Award Number`}),(0,U.jsx)(`input`,{value:he?.tesAwardNumber??``,onChange:_r(`tesAwardNumber`)})]}),(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`Student ID`}),(0,U.jsx)(`input`,{value:he?.studentId??``,onChange:_r(`studentId`)})]}),(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`Last Name`}),(0,U.jsx)(`input`,{value:he?.lastName??``,onChange:_r(`lastName`)})]}),(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`First Name`}),(0,U.jsx)(`input`,{value:he?.firstName??``,onChange:_r(`firstName`)})]}),(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`MI.`}),(0,U.jsx)(`input`,{value:he?.middleInitial??``,onChange:_r(`middleInitial`)})]}),(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`Batch No.`}),(0,U.jsx)(`input`,{value:he?.batchId??``,onChange:_r(`batchId`)})]}),(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`Status`}),(0,U.jsxs)(`select`,{value:he?.status??``,onChange:_r(`status`),children:[(0,U.jsx)(`option`,{value:``,children:`Select Status`}),(0,U.jsx)(`option`,{children:`Grantee`}),(0,U.jsx)(`option`,{children:`Validated`}),(0,U.jsx)(`option`,{children:`Pending`}),(0,U.jsx)(`option`,{children:`Rejected`})]})]}),(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`Semester`}),(0,U.jsx)(`input`,{value:he?.semester??``,onChange:_r(`semester`)})]}),(0,U.jsxs)(`label`,{children:[(0,U.jsx)(`span`,{children:`School Year`}),(0,U.jsx)(`input`,{value:he?.schoolYear??``,onChange:_r(`schoolYear`)})]})]}),_e&&(0,U.jsx)(`p`,{className:`admin-edit-message`,children:_e}),(0,U.jsxs)(`div`,{className:`admin-upload-actions admin-upload-actions--sticky`,children:[(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:ye,onClick:hr,type:`button`,children:`Cancel`}),(0,U.jsx)(`button`,{className:`admin-button admin-button--primary`,disabled:ye,type:`submit`,children:ye?`Saving...`:`Save Changes`})]})]})]}),_&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-add-record-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close add record modal`,className:`admin-modal-backdrop`,onClick:mr,type:`button`}),(0,U.jsxs)(`form`,{className:`admin-modal-card`,onSubmit:async e=>{if(e.preventDefault(),!ne){A(`Select a CSV file before uploading.`);return}if(!ne.name.toLowerCase().endsWith(`.csv`)){A(`Please upload the downloaded CSV template file.`);return}P(!0),A(`Reading file...`);try{let e=ur(await ne.text());if(e.length===0){A(`No valid rows found. Use the CSV template headers and add record values.`);return}let t=await z({records:e});A(`${t.inserted} record${t.inserted===1?``:`s`} saved to allinfo.`),re(null)}catch(e){A(e instanceof Error?e.message:`Unable to upload records.`)}finally{P(!1)}},children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Add New Record`}),(0,U.jsx)(`h2`,{id:`admin-add-record-title`,children:`Upload CSV File`}),(0,U.jsx)(`p`,{children:`Use the required template format before uploading grantee records.`})]}),(0,U.jsx)(`button`,{"aria-label":`Close add record`,className:`admin-modal-close`,disabled:N,onClick:mr,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsxs)(`div`,{className:`admin-upload-body`,children:[(0,U.jsxs)(`button`,{className:`admin-button admin-button--secondary`,onClick:Jn,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`download`}),`Download CSV Template`]}),(0,U.jsxs)(`label`,{className:`admin-upload-dropzone`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`upload_file`}),(0,U.jsx)(`strong`,{children:ne?ne.name:`Choose CSV file`}),(0,U.jsx)(`span`,{children:`Accepted format: downloaded CSV template`}),(0,U.jsx)(`input`,{accept:`.csv,text/csv`,disabled:N,onChange:e=>{let t=e.target.files?.[0]??null;re(t),A(t?`${t.name} is ready to upload.`:``)},type:`file`})]}),(0,U.jsx)(`div`,{className:`admin-template-preview`,"aria-label":`CSV template headers`,children:Hn.map(e=>(0,U.jsx)(`span`,{children:e},e))}),k&&(0,U.jsx)(`p`,{className:`admin-upload-message`,children:k})]}),(0,U.jsxs)(`div`,{className:`admin-upload-actions`,children:[(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:N,onClick:mr,type:`button`,children:`Cancel`}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--primary`,disabled:N,type:`submit`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`upload`}),N?`Uploading...`:`Upload`]})]})]})]}),a&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-quick-actions-title`,"aria-modal":`true`,className:`admin-modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close quick actions modal`,className:`admin-modal-backdrop`,onClick:()=>{s||o(!1)},type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card admin-modal-card--wide`,children:[(0,U.jsxs)(`div`,{className:`admin-modal-header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Quick Actions`}),(0,U.jsx)(`h2`,{id:`admin-quick-actions-title`,children:`Student Requests`}),(0,U.jsx)(`p`,{children:`Review submitted questions and requests from the student portal.`})]}),(0,U.jsx)(`button`,{"aria-label":`Close quick actions`,className:`admin-modal-close`,onClick:()=>{o(!1),c(!1)},type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsxs)(`div`,{className:`admin-quick-actions-summary`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{children:`Total Requests`}),(0,U.jsx)(`strong`,{children:Re?.length??0})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{children:`Source`}),(0,U.jsx)(`strong`,{children:`Student Portal`})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{children:`Status`}),(0,U.jsx)(`strong`,{children:`Live Data`})]})]}),(0,U.jsxs)(`div`,{className:`admin-quick-actions-toolbar`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{children:`Export Report`}),(0,U.jsx)(`strong`,{children:`Download all student responses with email accounts.`})]}),(0,U.jsxs)(`div`,{className:`admin-quick-actions-toolbar__actions`,children:[(0,U.jsxs)(`button`,{className:`admin-button admin-button--primary`,disabled:Re===void 0||Ze.length===0||L,onClick:er,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`download`}),`Export All Responses`]}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--danger`,disabled:Re===void 0||Ze.length===0||L,onClick:nr,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`delete_sweep`}),L?`Clearing...`:`Clear All Messages`]})]})]}),(0,U.jsx)(`div`,{className:`admin-quick-actions-table-wrap`,children:(0,U.jsxs)(`table`,{className:`admin-quick-actions-table`,children:[(0,U.jsx)(`thead`,{children:(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`th`,{children:`No.`}),(0,U.jsx)(`th`,{children:`Student Details`}),(0,U.jsx)(`th`,{children:`Email Account`}),(0,U.jsx)(`th`,{children:`Question`}),(0,U.jsx)(`th`,{children:`Source`}),(0,U.jsx)(`th`,{children:`Status`}),(0,U.jsx)(`th`,{children:`Submitted`})]})}),(0,U.jsxs)(`tbody`,{children:[Re===void 0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`admin-empty-state`,colSpan:7,children:`Loading quick actions...`})}),Re?.length===0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`admin-empty-state`,colSpan:7,children:`No quick action requests yet.`})}),Lt.map((e,t)=>(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`td`,{"data-label":`No.`,children:It+t+1}),(0,U.jsxs)(`td`,{className:`admin-request-student`,"data-label":`Student Details`,children:[(0,U.jsx)(`strong`,{children:Xn(e)||`Not provided`}),(0,U.jsx)(`span`,{children:e.studentId||`No Student ID`})]}),(0,U.jsx)(`td`,{className:`admin-request-email`,"data-label":`Email Account`,children:e.email}),(0,U.jsx)(`td`,{className:`admin-request-question`,"data-label":`Question`,children:e.question}),(0,U.jsx)(`td`,{"data-label":`Source`,children:e.source}),(0,U.jsx)(`td`,{"data-label":`Status`,children:(0,U.jsx)(Un,{status:e.status,tone:Wn(e.status)})}),(0,U.jsx)(`td`,{"data-label":`Submitted`,children:Gn(e.submittedAt)})]},e._id))]})]})}),(0,U.jsxs)(`div`,{className:`admin-pagination admin-quick-actions-pagination`,children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:Rt}),` to`,` `,(0,U.jsx)(`strong`,{children:zt}),` of`,` `,(0,U.jsx)(`strong`,{children:Ze.length}),` requests`]}),(0,U.jsxs)(`div`,{className:`admin-pagination__buttons`,children:[(0,U.jsx)(`button`,{type:`button`,disabled:Ft===1||Ze.length===0,"aria-label":`Previous quick actions page`,onClick:()=>pn(Ft-1),children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),Array.from({length:Pt},(e,t)=>{let n=t+1;return(0,U.jsx)(`button`,{className:Ft===n?`admin-page-button--active`:void 0,disabled:Ze.length===0,onClick:()=>pn(n),type:`button`,children:n},n)}),(0,U.jsx)(`button`,{type:`button`,disabled:Ft===Pt||Ze.length===0,"aria-label":`Next quick actions page`,onClick:()=>pn(Ft+1),children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]})]})]}),s&&(0,U.jsxs)(`div`,{"aria-describedby":`clear-quick-actions-description`,"aria-labelledby":`clear-quick-actions-title`,"aria-modal":`true`,className:`admin-modal-overlay admin-confirm-overlay`,role:`alertdialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Keep Quick Action messages`,className:`admin-modal-backdrop`,disabled:L,onClick:()=>c(!1),type:`button`}),(0,U.jsxs)(`section`,{className:`admin-modal-card admin-confirm-card`,children:[(0,U.jsx)(`div`,{className:`admin-confirm-card__icon`,"aria-hidden":`true`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`delete_sweep`})}),(0,U.jsxs)(`div`,{className:`admin-confirm-card__copy`,children:[(0,U.jsx)(`p`,{className:`admin-modal-kicker`,children:`Permanent Action`}),(0,U.jsx)(`h2`,{id:`clear-quick-actions-title`,children:`Clear all messages?`}),(0,U.jsxs)(`p`,{id:`clear-quick-actions-description`,children:[`You are about to permanently delete`,` `,(0,U.jsxs)(`strong`,{children:[Ze.length,` message`,Ze.length===1?``:`s`]}),`. This action cannot be undone.`]})]}),(0,U.jsxs)(`div`,{className:`admin-confirm-card__notice`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,"aria-hidden":`true`,children:`warning`}),`Export the responses first if you need to keep a copy.`]}),(0,U.jsxs)(`div`,{className:`admin-confirm-card__actions`,children:[(0,U.jsx)(`button`,{className:`admin-button admin-button--secondary`,disabled:L,onClick:()=>c(!1),type:`button`,children:`No, Keep Messages`}),(0,U.jsxs)(`button`,{className:`admin-button admin-button--danger`,disabled:L,onClick:rr,type:`button`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`delete_forever`}),L?`Clearing Messages...`:`Yes, Clear All`]})]})]})]}),(0,U.jsx)(`div`,{className:`admin-scroll-progress`,style:{"--admin-scroll":t}})]})}var fr=`
...
`,pr={quickActions:{table:`quickActions`,source:`all-grantee-information-header`,defaultStatus:`new`,fields:{email:{label:`Email account`,type:`email`,required:!0,placeholder:`name@example.com`},question:{label:`Question`,type:`textarea`,required:!0,placeholder:`Type your question or request here...`}}}};function mr(e){let t=(0,On.c)(4),{status:n,tone:r}=e,i=`status-badge status-badge--${r}`,a;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(a=(0,U.jsx)(`span`,{className:`status-badge__dot`}),t[0]=a):a=t[0];let o;return t[1]!==n||t[2]!==i?(o=(0,U.jsxs)(`span`,{className:i,children:[a,n]}),t[1]=n,t[2]=i,t[3]=o):o=t[3],o}function hr(e=``){let t=e.toLowerCase();return t.includes(`grantee`)||t.includes(`valid`)||t.includes(`complete`)||t.includes(`resolved`)||t.includes(`approved`)?`validated`:t.includes(`reject`)||t.includes(`decline`)?`rejected`:`pending`}function gr(e,t){let n=[];if(t<=5){for(let e=1;e<=t;e+=1)n.push(e);return n}n.push(1),e>3&&n.push(`left-ellipsis`);let r=Math.max(2,e-1),i=Math.min(t-1,e+1);for(let e=r;e<=i;e+=1)n.push(e);return e<t-2&&n.push(`right-ellipsis`),n.push(t),n}function _r(e){return/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/i.test(e)}function vr(e){return/^[A-Za-z0-9-]{4,30}$/.test(e)}function yr(e){return e.replace(/[\s-]/g,``).trim()}function br(e){return e.replace(/[^\d+]/g,``).replace(/(?!^)\+/g,``)}function xr(e){return e.replace(/[\r\n]+/g,` `).replace(/\s{2,}/g,` `)}function Sr(e){let t=yr(e);return/^09\d{9}$/.test(t)||/^\+639\d{9}$/.test(t)}var Cr=5*1024*1024,wr=`https://ideal-crane-292.convex.site`.replace(/\/+$/,``);function Tr(e){return e?e.type===`application/pdf`||/\.pdf$/i.test(e.name):!1}function Er(e){if(!e)return``;let t=e/(1024*1024);return`${t.toFixed(t>=10?0:1)} MB`}function Dr(e){return e.length>=6}function Or(e,t,n){let r,i=new Promise((e,i)=>{r=setTimeout(()=>i(Error(n)),t)});return Promise.race([e,i]).finally(()=>clearTimeout(r))}var kr=[{label:`Student ID`,name:`studentId`,autoComplete:`off`,required:!0},{label:`Last Name`,name:`lastName`,autoComplete:`family-name`,required:!0},{label:`First Name`,name:`firstName`,autoComplete:`given-name`,required:!0},{label:`Ext Name (JR)`,name:`extensionName`,autoComplete:`honorific-suffix`},{label:`Middle Name`,name:`middleName`,autoComplete:`additional-name`}],Ar=[{label:`Last Name`,name:`fatherLastName`,autoComplete:`family-name`},{label:`First Name`,name:`fatherFirstName`,autoComplete:`given-name`},{label:`Middle Name`,name:`fatherMiddleName`,autoComplete:`additional-name`}],jr=[{label:`Last Name`,name:`motherLastName`,autoComplete:`family-name`},{label:`First Name`,name:`motherFirstName`,autoComplete:`given-name`},{label:`Middle Name`,name:`motherMiddleName`,autoComplete:`additional-name`}],Mr=[`BACHELOR OF SCIENCE IN INFORMATION TECHNOLOGY`,`BACHELOR OF SCIENCE IN ENTREPRENEURSHIP`,`BACHELOR OF SCIENCE IN CRIMINOLOGY`,`BACHELOR OF ELEMENTARY EDUCATION`,`BACHELOR OF EARLY CHILDHOOD EDUCATION`,`BACHELOR OF SCIENCE IN HOSPITALITY MANAGEMENT`,`BACHELOR OF PUBLIC ADMINISTRATION`],Nr=[{label:`Address`,name:`address`,autoComplete:`street-address`,className:`portal-full-field`,required:!0},{label:`Zip Code`,name:`zipCode`,autoComplete:`postal-code`,inputMode:`numeric`},{label:`PWD ID`,name:`pwdId`,autoComplete:`off`},{label:`Mobile No.`,name:`mobileNumber`,autoComplete:`tel`,inputMode:`tel`,type:`tel`,pattern:`\\+?[0-9]*`,required:!0},{label:`Email Address`,name:`emailAddress`,autoComplete:`email`,inputMode:`email`,type:`email`,required:!0}];function Pr({onAdminLoginSuccess:e,onStudentRegistrationSuccess:t}){let n=(0,H.useRef)(null),[r,i]=(0,H.useState)(0),[a,o]=(0,H.useState)(!1),[s,c]=(0,H.useState)(!1),[l,u]=(0,H.useState)(!1),[d,f]=(0,H.useState)(!1),[p,m]=(0,H.useState)(!1),[h,g]=(0,H.useState)(!1),[_,v]=(0,H.useState)(!1),[y,b]=(0,H.useState)(!1),[x,S]=(0,H.useState)(``),[C,w]=(0,H.useState)(``),[ee,T]=(0,H.useState)(``),[E,D]=(0,H.useState)(``),[te,O]=(0,H.useState)(``),[ne,re]=(0,H.useState)(``),[k,A]=(0,H.useState)({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),[j,M]=(0,H.useState)(null),[N,P]=(0,H.useState)(!1),[F,I]=(0,H.useState)(!1),[L,ie]=(0,H.useState)(!1),[ae,oe]=(0,H.useState)(!1),[se,ce]=(0,H.useState)(1),[le,ue]=(0,H.useState)(``),[de,fe]=(0,H.useState)(``),[pe,me]=(0,H.useState)(``),[he,ge]=(0,H.useState)(``),[_e,ve]=(0,H.useState)(``),[ye,be]=(0,H.useState)(``),[xe,Se]=(0,H.useState)(``),[Ce,we]=(0,H.useState)(``),[Te,Ee]=(0,H.useState)(``),[De,R]=(0,H.useState)(``),[Oe,ke]=(0,H.useState)(``),[Ae,je]=(0,H.useState)(null),[Me,Ne]=(0,H.useState)(``),[Pe,Fe]=(0,H.useState)(``),[Ie,Le]=(0,H.useState)(``),[Re,ze]=(0,H.useState)(``),[Be,Ve]=(0,H.useState)(``),[He,Ue]=(0,H.useState)(``),[We,z]=(0,H.useState)(``),[Ge,Ke]=(0,H.useState)(``),[qe,Je]=(0,H.useState)(!1),[Ye,Xe]=(0,H.useState)(!1),[Ze,Qe]=(0,H.useState)(!1),$e=un(kn.applicants.create),et=un(kn.quickActions.create),tt=un(kn.adminAuth.login),nt=un(kn.adminAuth.register),rt=un(kn.adminAuth.requestPasswordResetOtp),it=un(kn.adminAuth.changePasswordWithOtp),at=ln(kn.allinfo.list),ot=ln(kn.applicantPortal.get),st=(0,H.useMemo)(()=>at??[],[at]),ct=le.trim().length>0,lt=ot===void 0,ut=ot?.isReceivingApplicants===!0,dt=(0,H.useMemo)(()=>{let e=le.trim().toLowerCase();return e?st.filter(t=>{let n=String(t.studentId??``).trim().toLowerCase(),r=String(t.batchId??``).trim().toLowerCase(),i=String(t.lastName??``).trim().toLowerCase(),a=String(t.firstName??``).trim().toLowerCase(),o=String(t.middleName??t.middleInitial??``).trim().toLowerCase(),s=[i,a,o].filter(Boolean).join(` `);return n===e||r===e||i.includes(e)||a.includes(e)||o.includes(e)||s.includes(e)}):[]},[st,le]),ft=dt.length,pt=Math.max(1,Math.ceil(ft/6)),mt=(se-1)*6,ht=Math.min(mt+6,ft),gt=(0,H.useMemo)(()=>dt.slice(mt,ht),[dt,mt,ht]),_t=(0,H.useMemo)(()=>gr(se,pt),[se,pt]),B=e=>{let t=e.trim().toLowerCase();return st.some(e=>String(e.studentId??``).trim().toLowerCase()===t)},vt=(0,H.useCallback)(()=>{ke(``),je(null),ve(``),be(``),we(``),Ee(``),typeof t==`function`&&t(Ae)},[t,Ae]);(0,H.useEffect)(()=>{let e=()=>{let e=document.documentElement.scrollTop||document.body.scrollTop,t=document.documentElement.scrollHeight-document.documentElement.clientHeight;i(t>0?e/t:0)};return e(),window.addEventListener(`scroll`,e,{passive:!0}),()=>window.removeEventListener(`scroll`,e)},[]),(0,H.useEffect)(()=>{if(!a&&!s&&!l&&!d&&!p&&!h&&!_&&!y&&!ne&&!Oe&&!ee)return;let e=e=>{if(e.key===`Escape`){if(L)return;if(_){v(!1);return}if(y){b(!1);return}o(!1),c(!1),D(``),O(``),M(null),A({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),u(!1),P(!1),f(!1),m(!1),g(!1),re(``),Oe&&vt(),T(``)}};return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),()=>{document.body.style.overflow=``,window.removeEventListener(`keydown`,e)}},[a,s,l,d,p,h,_,y,L,ne,Oe,ee,vt]);let yt=()=>{T(``),w(``),o(!0)},bt=()=>{o(!1),w(``)},xt=()=>{if(ot===void 0){re(`Please wait while the UNIFAST portal status is loading.`);return}if(!ot.isReceivingApplicants){re(`The UNIFAST portal is not receiving applicants right now. Please wait for the administrator to open applications.`);return}D(``),O(``),v(!1),b(!1),c(!0)},St=()=>{L||(c(!1),D(``),O(``),v(!1),A({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),M(null))},Ct=async(e,t,n)=>{let r=[n.lastName,n.firstName,n.middleName,n.extensionName].filter(Boolean).join(` `),i=new URLSearchParams({applicationYear:ot?.applicationYear||String(new Date().getFullYear()),documentType:t,fileName:e.name,fullName:r,studentId:n.studentId}),a;try{a=await fetch(`${wr}/google-drive/upload?${i.toString()}`,{body:e,headers:{"Content-Type":e.type||`application/pdf`},method:`POST`})}catch{throw Error(`Unable to connect to the PDF upload service. Deploy the Convex HTTP functions and check VITE_CONVEX_URL or VITE_CONVEX_SITE_URL.`)}if(!a.ok){let t=await a.json().catch(()=>null);throw Error(t?.message||`Unable to upload ${e.name} to Google Drive.`)}let{fileUrl:o}=await a.json();if(!o)throw Error(`Google Drive did not return a file link for ${e.name}.`);return o},wt=e=>{let{files:t,name:n}=e.target,r=t?.[0]??null;if(D(``),O(``),M(null),!r){A(e=>({...e,[n]:null}));return}if(!Tr(r)){e.target.value=``,A(e=>({...e,[n]:null})),D(`Please upload PDF files only for all document requirements.`);return}if(r.size>Cr){e.target.value=``,A(e=>({...e,[n]:null})),D(`Each uploaded PDF must be 5MB or smaller.`);return}A(e=>({...e,[n]:r}))},Tt=async e=>{e.preventDefault();let t=e.currentTarget,n=new FormData(t),r=yr(String(n.get(`mobileNumber`)||``)),i=String(n.get(`emailAddress`)||``).trim().toLowerCase(),a=n.get(`psaFile`),o=n.get(`schoolIdFile`),s=n.get(`pwdIdFile`),c=n.get(`fourPsFile`);if(D(``),O(``),!ot?.isReceivingApplicants){D(`The UNIFAST portal is closed for applicants right now.`);return}if(!Sr(r)){D(`Please enter a valid mobile number. Example: 09123456789 or +639123456789.`);return}if(!_r(i)){D(`Please enter a valid email address.`);return}if(!(a instanceof File)||!a.name||!Tr(a)){D(`Please upload your PSA as a PDF file.`);return}if(!(o instanceof File)||!o.name||!Tr(o)){D(`Please upload your colored School ID photocopy as a PDF file.`);return}if(a.size>Cr||o.size>Cr){D(`Each uploaded PDF must be 5MB or smaller.`);return}let l=[s,c].filter(e=>e instanceof File&&e.name);if(l.some(e=>!Tr(e))){D(`Optional PWD ID and 4Ps ID documents must be PDF files.`);return}if(l.some(e=>e.size>Cr)){D(`Each uploaded PDF must be 5MB or smaller.`);return}M({studentId:String(n.get(`studentId`)||``).trim(),lastName:String(n.get(`lastName`)||``).trim(),firstName:String(n.get(`firstName`)||``).trim(),extensionName:String(n.get(`extensionName`)||``).trim(),middleName:String(n.get(`middleName`)||``).trim(),gender:String(n.get(`gender`)||``),birthDate:String(n.get(`birthDate`)||``),course:String(n.get(`course`)||``),year:String(n.get(`year`)||``),fatherLastName:String(n.get(`fatherLastName`)||``).trim(),fatherFirstName:String(n.get(`fatherFirstName`)||``).trim(),fatherMiddleName:String(n.get(`fatherMiddleName`)||``).trim(),motherLastName:String(n.get(`motherLastName`)||``).trim(),motherFirstName:String(n.get(`motherFirstName`)||``).trim(),motherMiddleName:String(n.get(`motherMiddleName`)||``).trim(),address:String(n.get(`address`)||``).trim(),zipCode:String(n.get(`zipCode`)||``).trim(),pwdId:String(n.get(`pwdId`)||``).trim(),mobileNumber:r,emailAddress:i,psaFile:a,schoolIdFile:o,pwdIdFile:l.includes(s)?s:null,fourPsFile:l.includes(c)?c:null})},Et=()=>{D(``),O(``),v(!1),M(null)},Dt=()=>{if(j){if(D(``),O(``),!ot?.isReceivingApplicants){D(`The UNIFAST portal is closed for applicants right now.`);return}v(!0)}},Ot=async()=>{if(j){if(D(``),O(``),!ot?.isReceivingApplicants){D(`The UNIFAST portal is closed for applicants right now.`);return}ie(!0);try{let[e,t,r,i]=await Promise.all([Ct(j.psaFile,`PSA`,j),Ct(j.schoolIdFile,`School-ID`,j),j.pwdIdFile?Ct(j.pwdIdFile,`PWD-ID`,j):Promise.resolve(void 0),j.fourPsFile?Ct(j.fourPsFile,`4Ps-ID`,j):Promise.resolve(void 0)]),a={studentId:j.studentId,lastName:j.lastName,firstName:j.firstName,extensionName:j.extensionName,middleName:j.middleName,gender:j.gender,birthDate:j.birthDate,course:j.course,year:j.year,fatherLastName:j.fatherLastName,fatherFirstName:j.fatherFirstName,fatherMiddleName:j.fatherMiddleName,motherLastName:j.motherLastName,motherFirstName:j.motherFirstName,motherMiddleName:j.motherMiddleName,address:j.address,zipCode:j.zipCode,pwdId:j.pwdId,mobileNumber:j.mobileNumber,emailAddress:j.emailAddress,psaFileUrl:e,psaFileName:j.psaFile.name,schoolIdFileUrl:t,schoolIdFileName:j.schoolIdFile.name};r&&j.pwdIdFile&&(a.pwdIdFileUrl=r,a.pwdIdFileName=j.pwdIdFile.name),i&&j.fourPsFile&&(a.fourPsFileUrl=i,a.fourPsFileName=j.fourPsFile.name);let o=await $e(a);if(!o.success){v(!1),D(o.message||`Unable to submit applicant information.`);return}n.current?.reset(),A({psaFile:null,schoolIdFile:null,pwdIdFile:null,fourPsFile:null}),M(null),O(``),v(!1),c(!1),b(!0)}catch(e){v(!1),D(e instanceof Error?e.message:`Unable to submit applicant information right now.`)}finally{ie(!1)}}},kt=()=>{S(``),fe(``),me(``),ge(``),u(!0)},At=()=>{u(!1),P(!1),S(``),fe(``),me(``),ge(``)},jt=()=>{u(!1),m(!0),R(``),ke(``),ve(de),be(pe),we(``),Ee(``)},Mt=()=>{m(!1),R(``),ke(``),ve(``),be(``),Se(``),we(``),Ee(``)},Nt=()=>{m(!1),R(``),ke(``),je(null),fe(_e),me(ye),ge(``),u(!0)},Pt=()=>{g(!1),m(!0)},Ft=()=>{u(!1),f(!0),z(``),Ke(``),Je(!1),Ne(de),Fe(pe),Le(``),ze(``),Ve(``),Ue(``)},It=()=>{f(!1),z(``),Ke(``),Je(!1),Ne(``),Fe(``),Le(``),ze(``),Ve(``),Ue(``)},Lt=()=>{ce(e=>Math.max(e-1,1))},Rt=()=>{ce(e=>Math.min(e+1,pt))},zt=()=>{ue(``),ce(1)},Bt=e=>{ue(e.target.value),ce(1)},Vt=e=>{e.target.value=br(e.target.value)},Ht=()=>{Je(!1),Ke(``),ze(``),Ve(``),Ue(``)},Ut=e=>{let t=e.target.value;Ne(t),t.trim()&&Fe(``),Ht()},Wt=e=>{let t=e.target.value;Fe(t),t.trim()&&Ne(``),Ht()},Gt=e=>{Le(br(e.target.value)),Ht()},V=()=>{let e=Me.trim().toLowerCase(),t=Pe.trim(),n=yr(Ie);return!e&&!t?`Email address or School ID is required.`:e&&t?`Use either email address or School ID, not both.`:e&&!_r(e)?`Please enter a valid email address.`:t&&!vr(t)?`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`:n?Sr(n)?``:`Please enter a valid phone number. Example: 09123456789 or +639123456789.`:`Phone number is required.`};return(0,U.jsxs)(`div`,{className:`landing-page`,children:[(0,U.jsx)(`style`,{children:Fr}),(0,U.jsxs)(`header`,{className:`landing-header`,children:[(0,U.jsxs)(`div`,{className:`brand-lockup`,children:[(0,U.jsx)(`div`,{className:`brand-mark`,children:(0,U.jsx)(`img`,{alt:`IBACMI`,className:`brand-mark__image`,src:An})}),(0,U.jsx)(`div`,{className:`brand-copy`,children:(0,U.jsx)(`p`,{className:`brand-title`,children:`IBACMI - Scholarship Office`})})]}),(0,U.jsxs)(`div`,{className:`header-actions`,children:[(0,U.jsx)(`button`,{className:`button button--compact`,onClick:yt,type:`button`,children:`SUPPORT`}),(0,U.jsx)(`button`,{className:`button button--compact button--admin`,onClick:kt,type:`button`,children:`SIGN IN`})]})]}),(0,U.jsx)(`main`,{className:`landing-main`,children:(0,U.jsxs)(`div`,{className:`landing-container`,children:[(0,U.jsx)(`section`,{className:`page-heading`,children:(0,U.jsxs)(`div`,{className:`page-heading__copy`,children:[(0,U.jsx)(`span`,{className:`eyebrow`,children:`Grantee Records`}),(0,U.jsxs)(`h2`,{className:`landing-office-title`,children:[(0,U.jsx)(`span`,{className:`landing-office-title__school`,children:`IBACMI`}),(0,U.jsx)(`span`,{className:`landing-office-title__separator`,"aria-hidden":`true`,children:`—`}),(0,U.jsx)(`span`,{className:`landing-office-title__office`,children:`Scholarship Office`})]})]})}),(0,U.jsxs)(`section`,{className:`filter-panel`,"aria-label":`Grantee filters`,children:[(0,U.jsxs)(`div`,{className:`search-field`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`search`}),(0,U.jsx)(`input`,{placeholder:`Enter School ID, Either Batch No., or Last Name...`,type:`text`,value:le,onChange:Bt})]}),(0,U.jsxs)(`button`,{className:`icon-button filter-button`,type:`button`,"aria-label":`Clear search`,title:`Clear search`,onClick:zt,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`restart_alt`}),(0,U.jsx)(`span`,{className:`filter-button__text`,children:`Reset`})]})]}),!ct&&(0,U.jsxs)(`section`,{className:`scholarship-showcase`,"aria-labelledby":`scholarship-showcase-title`,children:[(0,U.jsxs)(`div`,{className:`scholarship-showcase__heading`,children:[(0,U.jsx)(`div`,{children:(0,U.jsx)(`span`,{className:`eyebrow`,children:`Scholarship Office`})}),(0,U.jsxs)(`span`,{className:`scholarship-showcase__status`,children:[(0,U.jsx)(`span`,{"aria-hidden":`true`}),`Official Information`]})]}),(0,U.jsxs)(`a`,{className:`scholarship-showcase__image-link`,href:`/IBACMI-Scholarship-Office/assets/desktop-Di8cTPxJ.png`,rel:`noreferrer`,target:`_blank`,title:`Open the Scholarship Office banner in full size`,children:[(0,U.jsx)(`img`,{alt:`IBACMI Scholarship Office banner featuring the scholarship coordinator and students assistant`,decoding:`async`,src:`/IBACMI-Scholarship-Office/assets/desktop-Di8cTPxJ.png`}),(0,U.jsxs)(`span`,{className:`scholarship-showcase__view`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,"aria-hidden":`true`,children:`open_in_full`}),`View full banner`]})]})]}),ct&&(0,U.jsxs)(`section`,{className:`table-card`,"aria-label":`Filtered grantee records`,children:[(0,U.jsx)(`div`,{className:`table-scroll`,children:(0,U.jsxs)(`table`,{children:[(0,U.jsx)(`thead`,{children:(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`th`,{children:`No.`}),(0,U.jsx)(`th`,{children:`TES Award Number`}),(0,U.jsx)(`th`,{children:`Student ID`}),(0,U.jsx)(`th`,{children:`Last Name`}),(0,U.jsx)(`th`,{children:`First Name`}),(0,U.jsx)(`th`,{children:`Middle Name`}),(0,U.jsx)(`th`,{children:`Batch No.`}),(0,U.jsx)(`th`,{children:`Status`}),(0,U.jsx)(`th`,{children:`Semester`}),(0,U.jsx)(`th`,{children:`School Year`})]})}),(0,U.jsxs)(`tbody`,{children:[at===void 0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`empty-state`,colSpan:10,children:`Searching grantee record...`})}),at&&dt.length===0&&(0,U.jsx)(`tr`,{children:(0,U.jsx)(`td`,{className:`empty-state`,colSpan:10,children:`No matching School ID, Batch No./ID, or name found.`})}),gt.map((e,t)=>(0,U.jsxs)(`tr`,{children:[(0,U.jsx)(`td`,{"data-label":`No.`,children:e.no||mt+t+1}),(0,U.jsx)(`td`,{className:`award-cell`,"data-label":`TES Award Number`,children:e.tesAwardNumber}),(0,U.jsx)(`td`,{"data-label":`Student ID`,children:e.studentId}),(0,U.jsx)(`td`,{"data-label":`Last Name`,children:e.lastName||`â€”`}),(0,U.jsx)(`td`,{"data-label":`First Name`,children:e.firstName||`â€”`}),(0,U.jsx)(`td`,{"data-label":`Middle Name`,children:e.middleName||e.middleInitial||`â€”`}),(0,U.jsx)(`td`,{className:`batch-cell`,"data-label":`Batch ID`,children:e.batchId}),(0,U.jsx)(`td`,{"data-label":`Status`,children:(0,U.jsx)(mr,{status:e.status,tone:hr(e.status)})}),(0,U.jsx)(`td`,{"data-label":`Semester`,children:e.semester||`—`}),(0,U.jsx)(`td`,{"data-label":`School Year`,children:e.schoolYear||`—`})]},e._id))]})]})}),(0,U.jsxs)(`div`,{className:`table-footer`,children:[(0,U.jsxs)(`p`,{children:[`Showing `,(0,U.jsx)(`strong`,{children:ft===0?0:mt+1}),` to`,` `,(0,U.jsx)(`strong`,{children:ht}),` of `,(0,U.jsx)(`strong`,{children:ft}),` result`,ft===1?``:`s`]}),(0,U.jsxs)(`div`,{className:`pagination`,children:[(0,U.jsx)(`button`,{className:`page-button`,disabled:se===1||ft===0,onClick:Lt,type:`button`,"aria-label":`Previous page`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_left`})}),_t.map(e=>typeof e==`string`?(0,U.jsx)(`span`,{className:`pagination__ellipsis`,children:`...`},e):(0,U.jsx)(`button`,{className:`page-button ${se===e?`page-button--active`:``}`,disabled:ft===0,onClick:()=>ce(e),type:`button`,children:e},e)),(0,U.jsx)(`button`,{className:`page-button`,disabled:se===pt||ft===0,onClick:Rt,type:`button`,"aria-label":`Next page`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`chevron_right`})})]})]})]}),(0,U.jsxs)(`section`,{className:`portal-cta`,"aria-labelledby":`portal-cta-title`,children:[(0,U.jsx)(`div`,{className:`portal-cta__icon`,"aria-hidden":`true`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`assignment`})}),(0,U.jsxs)(`div`,{className:`portal-cta__copy`,children:[(0,U.jsx)(`span`,{className:`eyebrow`,children:`Unified Student Financial Assistance System for Tertiary Education`}),(0,U.jsx)(`h3`,{id:`portal-cta-title`,children:`UNIFAST APPLICATION`}),(0,U.jsx)(`p`,{children:`Complete the student, parent, address, and contact information form for UNIFAST applicant processing.`})]}),(0,U.jsxs)(`button`,{"aria-label":lt?`Checking UNIFAST portal status`:ut?`UNIFAST portal is open. Open application form`:`UNIFAST portal is closed`,className:`button button--portal ${lt?`button--portal-loading`:ut?`button--portal-open`:`button--portal-closed`}`,disabled:lt,onClick:xt,type:`button`,children:[(0,U.jsx)(`span`,{className:`portal-status-dot`,"aria-hidden":`true`}),lt?`CHECKING PORTAL`:ut?`PORTAL OPEN`:`PORTAL IS CLOSED`]})]})]})}),(0,U.jsx)(`footer`,{className:`landing-footer`,children:(0,U.jsx)(`p`,{children:`Copyright 2026 | All Rights Reserved IBACMI - Scholarship Office | Developed By CINIFIX`})}),s&&(0,U.jsxs)(`div`,{"aria-labelledby":`unifast-portal-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close UNIFAST portal modal`,className:`modal-backdrop-button`,onClick:St,type:`button`}),(0,U.jsxs)(`form`,{className:`modal-card portal-modal-card`,ref:n,onSubmit:Tt,children:[(0,U.jsx)(`div`,{className:`modal-header portal-modal-header`,children:(0,U.jsxs)(`div`,{className:`modal-title-row`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`modal-kicker`,children:`UNIFAST Portal`}),(0,U.jsx)(`h3`,{id:`unifast-portal-title`,children:`Student Information Form`}),(0,U.jsxs)(`p`,{children:[`Complete the student, parent, and contact information fields below`,ot?.applicationYear?` for ${ot.applicationYear}.`:`.`]})]}),(0,U.jsx)(`button`,{"aria-label":`Close UNIFAST portal`,className:`icon-button modal-close`,onClick:St,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]})}),(0,U.jsxs)(`div`,{className:`modal-body portal-form${j?` portal-form--hidden`:``}`,children:[(0,U.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-student-heading`,children:[(0,U.jsx)(`h4`,{id:`portal-student-heading`,children:`Student Information`}),(0,U.jsxs)(`div`,{className:`portal-grid`,children:[kr.map(e=>(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:e.label}),(0,U.jsx)(`input`,{autoComplete:e.autoComplete,name:e.name,placeholder:`Enter ${e.label.toLowerCase()}`,required:e.required,type:`text`})]},e.name)),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Gender`}),(0,U.jsxs)(`select`,{name:`gender`,defaultValue:``,required:!0,children:[(0,U.jsx)(`option`,{value:``,disabled:!0,children:`Select gender`}),(0,U.jsx)(`option`,{value:`Female`,children:`Female`}),(0,U.jsx)(`option`,{value:`Male`,children:`Male`}),(0,U.jsx)(`option`,{value:`Prefer not to say`,children:`Prefer not to say`})]})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Birth Date`}),(0,U.jsx)(`input`,{name:`birthDate`,required:!0,type:`date`})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Year`}),(0,U.jsxs)(`select`,{name:`year`,defaultValue:``,required:!0,children:[(0,U.jsx)(`option`,{value:``,disabled:!0,children:`Select year`}),(0,U.jsx)(`option`,{value:`1st Year`,children:`1st Year`}),(0,U.jsx)(`option`,{value:`2nd Year`,children:`2nd Year`}),(0,U.jsx)(`option`,{value:`3rd Year`,children:`3rd Year`}),(0,U.jsx)(`option`,{value:`4th Year`,children:`4th Year`}),(0,U.jsx)(`option`,{value:`5th Year`,children:`5th Year`})]})]}),(0,U.jsxs)(`fieldset`,{className:`portal-course-list`,children:[(0,U.jsx)(`legend`,{children:`Course`}),Mr.map(e=>(0,U.jsxs)(`label`,{className:`portal-course-option`,children:[(0,U.jsx)(`input`,{name:`course`,required:!0,type:`radio`,value:e}),(0,U.jsx)(`span`,{children:e})]},e))]})]})]}),(0,U.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-parents-heading`,children:[(0,U.jsx)(`h4`,{id:`portal-parents-heading`,children:`Parents Information`}),(0,U.jsxs)(`div`,{className:`portal-parent-group`,children:[(0,U.jsx)(`p`,{children:`Father Information`}),(0,U.jsx)(`div`,{className:`portal-grid portal-grid--three`,children:Ar.map(e=>(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:e.label}),(0,U.jsx)(`input`,{autoComplete:e.autoComplete,name:e.name,placeholder:`Enter father's ${e.label.toLowerCase()}`,type:`text`})]},e.name))})]}),(0,U.jsxs)(`div`,{className:`portal-parent-group`,children:[(0,U.jsx)(`p`,{children:`Mother Information`}),(0,U.jsx)(`div`,{className:`portal-grid portal-grid--three`,children:jr.map(e=>(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:e.label}),(0,U.jsx)(`input`,{autoComplete:e.autoComplete,name:e.name,placeholder:`Enter mother's ${e.label.toLowerCase()}`,type:`text`})]},e.name))})]})]}),(0,U.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-contact-heading`,children:[(0,U.jsx)(`h4`,{id:`portal-contact-heading`,children:`Address and Contact Information`}),(0,U.jsx)(`div`,{className:`portal-grid`,children:Nr.map(e=>(0,U.jsxs)(`label`,{className:`form-field ${e.className??``}`.trim(),children:[(0,U.jsx)(`span`,{children:e.label}),(0,U.jsx)(`input`,{autoComplete:e.autoComplete,inputMode:e.inputMode,name:e.name,onInput:e.name===`mobileNumber`?Vt:void 0,pattern:e.pattern,placeholder:`Enter ${e.label.toLowerCase()}`,required:e.required,type:e.type??`text`})]},e.name))})]}),(0,U.jsxs)(`section`,{className:`portal-section`,"aria-labelledby":`portal-documents-heading`,children:[(0,U.jsxs)(`div`,{className:`portal-section-heading`,children:[(0,U.jsx)(`h4`,{id:`portal-documents-heading`,children:`Document Requirements`}),(0,U.jsx)(`p`,{children:`Upload clear PDF copies up to 5MB each. Required and optional documents are labeled below.`})]}),(0,U.jsxs)(`div`,{className:`portal-document-grid`,children:[(0,U.jsxs)(`label`,{className:`portal-document-upload${k.psaFile?` portal-document-upload--selected`:``}`,children:[(0,U.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`psaFile`,onChange:wt,required:!0,type:`file`}),(0,U.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`picture_as_pdf`})}),(0,U.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,U.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,U.jsx)(`strong`,{children:`PSA Birth Certificate`}),(0,U.jsx)(`span`,{className:`portal-document-badge portal-document-badge--required`,children:`Required`})]}),(0,U.jsx)(`span`,{children:k.psaFile?`${k.psaFile.name} (${Er(k.psaFile.size)})`:`Select PSA PDF file`})]})]}),(0,U.jsxs)(`label`,{className:`portal-document-upload${k.schoolIdFile?` portal-document-upload--selected`:``}`,children:[(0,U.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`schoolIdFile`,onChange:wt,required:!0,type:`file`}),(0,U.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`badge`})}),(0,U.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,U.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,U.jsx)(`strong`,{children:`Colored School ID Photocopy`}),(0,U.jsx)(`span`,{className:`portal-document-badge portal-document-badge--required`,children:`Required`})]}),(0,U.jsx)(`span`,{children:k.schoolIdFile?`${k.schoolIdFile.name} (${Er(k.schoolIdFile.size)})`:`Select colored School ID photocopy PDF`})]})]}),(0,U.jsxs)(`label`,{className:`portal-document-upload portal-document-upload--optional${k.pwdIdFile?` portal-document-upload--selected`:``}`,children:[(0,U.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`pwdIdFile`,onChange:wt,type:`file`}),(0,U.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`accessible`})}),(0,U.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,U.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,U.jsx)(`strong`,{children:`PWD ID`}),(0,U.jsx)(`span`,{className:`portal-document-badge`,children:`Optional`})]}),(0,U.jsx)(`span`,{children:k.pwdIdFile?`${k.pwdIdFile.name} (${Er(k.pwdIdFile.size)})`:`Attach a clear PWD ID PDF, if applicable`})]})]}),(0,U.jsxs)(`label`,{className:`portal-document-upload portal-document-upload--optional${k.fourPsFile?` portal-document-upload--selected`:``}`,children:[(0,U.jsx)(`input`,{accept:`application/pdf,.pdf`,name:`fourPsFile`,onChange:wt,type:`file`}),(0,U.jsx)(`span`,{className:`portal-document-upload__icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`family_restroom`})}),(0,U.jsxs)(`span`,{className:`portal-document-upload__copy`,children:[(0,U.jsxs)(`span`,{className:`portal-document-upload__title`,children:[(0,U.jsx)(`strong`,{children:`4Ps ID`}),(0,U.jsx)(`span`,{className:`portal-document-badge`,children:`Optional`})]}),(0,U.jsx)(`span`,{children:k.fourPsFile?`${k.fourPsFile.name} (${Er(k.fourPsFile.size)})`:`Attach a clear 4Ps ID PDF, if applicable`})]})]})]})]})]}),j&&(0,U.jsx)(`div`,{className:`modal-body portal-review`,children:(0,U.jsxs)(`section`,{className:`portal-review-card`,"aria-labelledby":`portal-review-heading`,children:[(0,U.jsxs)(`div`,{className:`portal-section-heading`,children:[(0,U.jsx)(`h4`,{id:`portal-review-heading`,children:`Review Information`}),(0,U.jsx)(`p`,{children:`Please check every detail before final submission.`})]}),(0,U.jsxs)(`div`,{className:`portal-review-grid`,children:[(0,U.jsxs)(`div`,{className:`portal-review-group`,children:[(0,U.jsx)(`h5`,{children:`Student Information`}),(0,U.jsxs)(`dl`,{children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Student ID`}),(0,U.jsx)(`dd`,{children:j.studentId})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Full Name`}),(0,U.jsx)(`dd`,{children:[j.firstName,j.middleName,j.lastName,j.extensionName].filter(Boolean).join(` `)})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Gender`}),(0,U.jsx)(`dd`,{children:j.gender})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Birth Date`}),(0,U.jsx)(`dd`,{children:j.birthDate})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Year`}),(0,U.jsx)(`dd`,{children:j.year})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Course`}),(0,U.jsx)(`dd`,{children:j.course})]})]})]}),(0,U.jsxs)(`div`,{className:`portal-review-group`,children:[(0,U.jsx)(`h5`,{children:`Parents Information`}),(0,U.jsxs)(`dl`,{children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Father`}),(0,U.jsx)(`dd`,{children:[j.fatherFirstName,j.fatherMiddleName,j.fatherLastName].filter(Boolean).join(` `)||`Not provided`})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Mother`}),(0,U.jsx)(`dd`,{children:[j.motherFirstName,j.motherMiddleName,j.motherLastName].filter(Boolean).join(` `)||`Not provided`})]})]})]}),(0,U.jsxs)(`div`,{className:`portal-review-group`,children:[(0,U.jsx)(`h5`,{children:`Address and Contact`}),(0,U.jsxs)(`dl`,{children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Address`}),(0,U.jsx)(`dd`,{children:j.address})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Zip Code`}),(0,U.jsx)(`dd`,{children:j.zipCode||`Not provided`})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`PWD ID`}),(0,U.jsx)(`dd`,{children:j.pwdId||`Not provided`})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Mobile No.`}),(0,U.jsx)(`dd`,{children:j.mobileNumber})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`Email Address`}),(0,U.jsx)(`dd`,{children:j.emailAddress})]})]})]}),(0,U.jsxs)(`div`,{className:`portal-review-group`,children:[(0,U.jsx)(`h5`,{children:`Documents`}),(0,U.jsxs)(`dl`,{children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`PSA Birth Certificate`}),(0,U.jsxs)(`dd`,{children:[j.psaFile.name,` (`,Er(j.psaFile.size),`)`]})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`School ID Photocopy`}),(0,U.jsxs)(`dd`,{children:[j.schoolIdFile.name,` (`,Er(j.schoolIdFile.size),`)`]})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`PWD ID (Optional)`}),(0,U.jsx)(`dd`,{children:j.pwdIdFile?`${j.pwdIdFile.name} (${Er(j.pwdIdFile.size)})`:`Not provided`})]}),(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`dt`,{children:`4Ps ID (Optional)`}),(0,U.jsx)(`dd`,{children:j.fourPsFile?`${j.fourPsFile.name} (${Er(j.fourPsFile.size)})`:`Not provided`})]})]})]})]})]})}),(E||te)&&(0,U.jsxs)(`div`,{className:`portal-message-row`,children:[E&&(0,U.jsx)(`p`,{className:`form-error`,children:E}),te&&(0,U.jsx)(`p`,{className:`form-success`,children:te})]}),(0,U.jsx)(`div`,{className:`modal-actions portal-actions`,children:j?(0,U.jsxs)(U.Fragment,{children:[(0,U.jsx)(`button`,{className:`button button--secondary`,disabled:L,onClick:Et,type:`button`,children:`Edit Information`}),(0,U.jsx)(`button`,{className:`button`,disabled:L,onClick:Dt,type:`button`,children:`Submit Information`})]}):(0,U.jsxs)(U.Fragment,{children:[(0,U.jsx)(`button`,{className:`button button--secondary`,disabled:L,onClick:St,type:`button`,children:`Cancel`}),(0,U.jsx)(`button`,{className:`button`,disabled:L,type:`submit`,children:`Review Information`})]})})]})]}),_&&(0,U.jsxs)(`div`,{"aria-labelledby":`portal-privacy-title`,"aria-modal":`true`,className:`modal-overlay portal-confirmation-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Return to application review`,className:`modal-backdrop-button`,disabled:L,onClick:()=>v(!1),type:`button`}),(0,U.jsxs)(`section`,{className:`modal-card portal-privacy-card`,children:[(0,U.jsxs)(`div`,{className:`success-modal-body`,children:[(0,U.jsx)(`div`,{className:`portal-privacy-icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`privacy_tip`})}),(0,U.jsx)(`p`,{className:`modal-kicker`,children:`Data Privacy Notice`}),(0,U.jsx)(`h3`,{id:`portal-privacy-title`,children:`Your Privacy Matters`}),(0,U.jsx)(`p`,{children:`I understand that the personal information I provide will be collected, stored, and processed by the Scholarship Office solely for scholarship administration, verification, monitoring, and related educational purposes. I am informed that my data will be kept confidential and protected in accordance with the Data Privacy Act of 2012 (Republic Act No. 10173), and will only be accessed by authorized personnel when necessary.`})]}),(0,U.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,U.jsx)(`button`,{className:`button`,disabled:L,onClick:Ot,type:`button`,children:L?`Submitting...`:`I UNDERSTAND`})})]})]}),y&&(0,U.jsxs)(`div`,{"aria-labelledby":`portal-submission-success-title`,"aria-modal":`true`,className:`modal-overlay portal-confirmation-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close application success modal`,className:`modal-backdrop-button`,onClick:()=>b(!1),type:`button`}),(0,U.jsxs)(`section`,{className:`modal-card modal-card--success`,children:[(0,U.jsxs)(`div`,{className:`success-modal-body`,children:[(0,U.jsx)(`div`,{className:`success-icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`check_circle`})}),(0,U.jsx)(`h3`,{id:`portal-submission-success-title`,children:`Application Submitted Successfully`}),(0,U.jsxs)(`p`,{children:[`Please wait for the UNIFAST results. You will be notified through the Facebook page, `,(0,U.jsx)(`strong`,{children:`Iba College of Mindanao Inc. - Scholarship Office`}),`.`]})]}),(0,U.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,U.jsx)(`button`,{className:`button`,onClick:()=>b(!1),type:`button`,children:`Done`})})]})]}),ne&&(0,U.jsxs)(`div`,{"aria-labelledby":`portal-status-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close portal status modal`,className:`modal-backdrop-button`,onClick:()=>re(``),type:`button`}),(0,U.jsxs)(`section`,{className:`modal-card portal-status-card`,children:[(0,U.jsx)(`div`,{className:`modal-header portal-modal-header`,children:(0,U.jsxs)(`div`,{className:`modal-title-row`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`h3`,{id:`portal-status-title`,children:`Portal Status`}),(0,U.jsx)(`p`,{children:ne})]}),(0,U.jsx)(`button`,{"aria-label":`Close portal status`,className:`icon-button modal-close`,onClick:()=>re(``),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]})}),(0,U.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,U.jsx)(`button`,{className:`button`,onClick:()=>re(``),type:`button`,children:`OK`})})]})]}),a&&(0,U.jsxs)(`div`,{"aria-labelledby":`quick-actions-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close quick actions modal`,className:`modal-backdrop-button`,onClick:bt,type:`button`}),(0,U.jsxs)(`form`,{className:`modal-card modal-card--wide auth-modal-card`,onSubmit:async e=>{e.preventDefault();let t=e.currentTarget,n=new FormData(t),r=String(n.get(`email`)||``).trim().toLowerCase(),i=String(n.get(`studentId`)||``).trim(),a=String(n.get(`lastName`)||``).trim(),s=String(n.get(`firstName`)||``).trim(),c=String(n.get(`middleInitial`)||``).trim(),l=xr(String(n.get(`question`)||``)).trim();w(``),T(``),I(!0);try{if(!_r(r))throw Error(`Please enter a valid email account.`);if(!vr(i))throw Error(`Please enter a valid Student ID.`);if(!a||!s)throw Error(`Last name and first name are required.`);if(c&&!/^[A-Za-z. -]{1,10}$/.test(c))throw Error(`Please enter a valid middle initial.`);if(!l)throw Error(`Please enter your question or request.`);if(l.length>500)throw Error(`Your question must be 500 characters or fewer.`);await et({email:r,studentId:i,lastName:a,firstName:s,middleInitial:c,question:l,source:pr.quickActions.source,status:pr.quickActions.defaultStatus}),t.reset(),o(!1),T(`Your request has been submitted.`)}catch(e){w(e instanceof Error?e.message:`Unable to submit your request right now.`)}finally{I(!1)}},children:[(0,U.jsxs)(`div`,{className:`modal-header`,children:[(0,U.jsxs)(`div`,{className:`modal-title-row`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`p`,{className:`modal-kicker`,children:`Quick Actions`}),(0,U.jsx)(`h3`,{id:`quick-actions-title`,children:`Submit a Request`})]}),(0,U.jsx)(`button`,{"aria-label":`Close modal`,className:`icon-button modal-close`,onClick:bt,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})]}),(0,U.jsx)(`p`,{children:`Send a question or request to the scholarship office for review.`})]}),(0,U.jsxs)(`div`,{className:`modal-body quick-action-form-grid`,children:[(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Student ID`}),(0,U.jsx)(`input`,{autoComplete:`off`,name:`studentId`,placeholder:`Enter Student ID`,required:!0})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Email account`}),(0,U.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`email`,placeholder:pr.quickActions.fields.email.placeholder,required:!0,type:`email`})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Last name`}),(0,U.jsx)(`input`,{autoComplete:`family-name`,name:`lastName`,placeholder:`Enter last name`,required:!0})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`First name`}),(0,U.jsx)(`input`,{autoComplete:`given-name`,name:`firstName`,placeholder:`Enter first name`,required:!0})]}),(0,U.jsxs)(`label`,{className:`form-field quick-action-mi-field`,children:[(0,U.jsx)(`span`,{children:`MI`}),(0,U.jsx)(`input`,{autoComplete:`additional-name`,maxLength:10,name:`middleInitial`,placeholder:`M`})]}),(0,U.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,U.jsx)(`span`,{children:`Question`}),(0,U.jsx)(`textarea`,{"aria-describedby":`quick-action-question-help`,maxLength:500,name:`question`,onInput:e=>{e.currentTarget.value=xr(e.currentTarget.value)},placeholder:pr.quickActions.fields.question.placeholder,required:!0,rows:4}),(0,U.jsx)(`small`,{className:`form-field__help`,id:`quick-action-question-help`,children:`One paragraph only, up to 500 characters.`})]}),C&&(0,U.jsx)(`p`,{className:`form-error auth-full-field`,children:C})]}),(0,U.jsxs)(`div`,{className:`modal-actions`,children:[(0,U.jsx)(`button`,{className:`button button--secondary`,disabled:F,onClick:bt,type:`button`,children:`Cancel`}),(0,U.jsx)(`button`,{className:`button`,disabled:F,type:`submit`,children:F?`Submitting...`:`Submit`})]})]})]}),l&&(0,U.jsxs)(`div`,{"aria-labelledby":`admin-login-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close admin login modal`,className:`modal-backdrop-button`,onClick:At,type:`button`}),(0,U.jsxs)(`form`,{className:`modal-card modal-card--admin auth-modal-card`,onSubmit:async t=>{t.preventDefault();let n=de.trim().toLowerCase(),r=pe.trim(),i=he,a=n.length>0,o=r.length>0;if(S(``),!a&&!o){S(`Enter either your valid email address or your School ID.`);return}if(a&&!_r(n)){S(`Please enter a valid email address.`);return}if(o&&!vr(r)){S(`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`);return}if(!i){S(`Password is required.`);return}if(!Dr(i)){S(`Password must be at least 6 characters.`);return}let s={password:i,...a?{email:n}:{},...o?{schoolId:r}:{}};P(!0);try{let t=await Or(tt(s),15e3,`Login is taking too long. Please check your internet connection is running, then try again.`);if(!t.success){S(t.message||`Invalid admin credentials.`);return}u(!1),typeof e==`function`&&e(t.admin)}catch(e){S(e instanceof Error?e.message:`Unable to login right now.`)}finally{P(!1)}},children:[(0,U.jsxs)(`div`,{className:`admin-login-hero auth-modal-hero`,children:[(0,U.jsx)(`div`,{className:`admin-login-brand`,children:(0,U.jsx)(`img`,{alt:`IBACMI`,src:`/IBACMI-Scholarship-Office/assets/IBACMI-DvrUkuyb.png`})}),(0,U.jsx)(`button`,{"aria-label":`Close admin login`,className:`icon-button modal-close admin-login-close`,onClick:At,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})}),(0,U.jsx)(`p`,{className:`modal-kicker`,children:`UNIFAST Portal`}),(0,U.jsx)(`h3`,{id:`admin-login-title`,children:`Sign in `})]}),(0,U.jsxs)(`div`,{className:`modal-body admin-login-body auth-form-grid`,children:[(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Valid Email address`}),(0,U.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`adminEmail`,placeholder:`Enter email address`,type:`email`,disabled:pe.trim().length>0,value:de,onChange:e=>fe(e.target.value)})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`School ID`}),(0,U.jsx)(`input`,{autoComplete:`off`,name:`adminSchoolId`,placeholder:`Enter School ID`,type:`text`,minLength:4,maxLength:30,pattern:`[A-Za-z0-9-]{4,30}`,title:`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`,disabled:de.trim().length>0,value:pe,onChange:e=>me(e.target.value)})]}),(0,U.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,U.jsx)(`span`,{children:`Password`}),(0,U.jsx)(`input`,{autoComplete:`current-password`,name:`adminPassword`,placeholder:`Enter password`,required:!0,type:`password`,minLength:6,value:he,onChange:e=>ge(e.target.value)})]}),(0,U.jsxs)(`div`,{className:`auth-note-box auth-full-field`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`info`}),(0,U.jsx)(`p`,{children:`You may sign in using either your registered email address or your School ID. Password is still required.`})]}),(0,U.jsxs)(`div`,{className:`auth-link-row auth-full-field`,children:[(0,U.jsx)(`button`,{className:`auth-text-button`,disabled:N,onClick:Ft,type:`button`,children:`Forgot Password?`}),(0,U.jsx)(`button`,{className:`auth-text-button auth-text-button--strong`,disabled:N,onClick:jt,type:`button`,children:`Create Account`})]}),x&&(0,U.jsx)(`p`,{className:`form-error auth-full-field`,children:x})]}),(0,U.jsxs)(`div`,{className:`modal-actions admin-login-actions auth-actions`,children:[(0,U.jsx)(`button`,{className:`button button--secondary`,disabled:N,onClick:At,type:`button`,children:`Cancel`}),(0,U.jsx)(`button`,{className:`button`,disabled:N,type:`submit`,children:N?`Logging in...`:`Login`})]})]})]}),p&&(0,U.jsxs)(`div`,{"aria-labelledby":`sign-up-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close sign up modal`,className:`modal-backdrop-button`,onClick:Mt,type:`button`}),(0,U.jsxs)(`form`,{className:`modal-card modal-card--admin auth-modal-card auth-modal-card--large`,onSubmit:async e=>{e.preventDefault();let t=_e.trim().toLowerCase(),n=ye.trim(),r=yr(xe),i=Ce,a=Te;if(R(``),ke(``),!t){R(`Email account is required.`);return}if(!_r(t)){R(`Please enter a valid email account.`);return}if(!n){R(`School ID is required.`);return}if(!vr(n)){R(`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`);return}if(at===void 0){R(`Please wait while we verify the School ID.`);return}if(!B(n)){m(!1),g(!0);return}if(!r){R(`Phone number is required.`);return}if(!Sr(r)){R(`Please enter a valid phone number. Example: 09123456789 or +639123456789.`);return}if(!i){R(`Password is required.`);return}if(!Dr(i)){R(`Password must be at least 6 characters.`);return}if(!a){R(`Confirm password is required.`);return}if(i!==a){R(`Password and confirm password do not match.`);return}oe(!0);try{let e=await nt({email:t,schoolId:n,phoneNumber:r,password:i});if(!e.success){if(e.reason===`schoolIdNotFound`){m(!1),g(!0);return}R(e.message||`Unable to register account.`);return}m(!1),je(e.admin??{email:t,schoolId:n,role:`student`}),ke(`Your account has been registered successfully.`),fe(t),me(n),ge(``),Se(``),we(``),Ee(``)}catch(e){R(e instanceof Error?e.message:`Unable to register account.`)}finally{oe(!1)}},children:[(0,U.jsxs)(`div`,{className:`admin-login-hero auth-modal-hero`,children:[(0,U.jsx)(`div`,{className:`admin-login-brand`,children:(0,U.jsx)(`img`,{alt:`IBACMI`,src:`/IBACMI-Scholarship-Office/assets/IBACMI-DvrUkuyb.png`})}),(0,U.jsx)(`button`,{"aria-label":`Close sign up`,className:`icon-button modal-close admin-login-close`,onClick:Mt,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})}),(0,U.jsx)(`p`,{className:`modal-kicker`,children:`Account Registration`}),(0,U.jsx)(`h3`,{id:`sign-up-title`,children:`Create Account`}),(0,U.jsx)(`p`,{children:`Registration is only available for verified School IDs listed in the IBACMI Scholarship Office records.`})]}),(0,U.jsxs)(`div`,{className:`modal-body admin-login-body auth-form-grid`,children:[(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Email account`}),(0,U.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`signUpEmail`,placeholder:`Enter email account`,required:!0,type:`email`,value:_e,onChange:e=>ve(e.target.value)})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`School ID`}),(0,U.jsx)(`input`,{autoComplete:`off`,name:`signUpSchoolId`,placeholder:`Enter School ID`,required:!0,type:`text`,minLength:4,maxLength:30,pattern:`[A-Za-z0-9-]{4,30}`,value:ye,onChange:e=>be(e.target.value)})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Phone Number`}),(0,U.jsx)(`input`,{autoComplete:`tel`,inputMode:`tel`,name:`signUpPhoneNumber`,pattern:`\\+?[0-9]*`,placeholder:`e.g. 09123456789`,required:!0,type:`tel`,value:xe,onChange:e=>Se(br(e.target.value))})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Password`}),(0,U.jsx)(`input`,{autoComplete:`new-password`,name:`signUpPassword`,placeholder:`Create password`,required:!0,type:`password`,minLength:6,value:Ce,onChange:e=>we(e.target.value)})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Confirm Password`}),(0,U.jsx)(`input`,{autoComplete:`new-password`,name:`signUpConfirmPassword`,placeholder:`Confirm password`,required:!0,type:`password`,minLength:6,value:Te,onChange:e=>Ee(e.target.value)})]}),(0,U.jsxs)(`div`,{className:`auth-note-box auth-full-field`,children:[(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`verified_user`}),(0,U.jsx)(`p`,{children:`Your School ID will be checked against the official grantee information record before account creation.`})]}),De&&(0,U.jsx)(`p`,{className:`form-error auth-full-field`,children:De}),Oe&&(0,U.jsx)(`p`,{className:`form-success auth-full-field`,children:Oe})]}),(0,U.jsxs)(`div`,{className:`modal-actions admin-login-actions auth-actions`,children:[(0,U.jsx)(`button`,{className:`button button--secondary`,disabled:ae,onClick:Nt,type:`button`,children:`Back to Login`}),(0,U.jsx)(`button`,{className:`button`,disabled:ae,type:`submit`,children:ae?`Registering...`:`Register Now`})]})]})]}),h&&(0,U.jsxs)(`div`,{"aria-labelledby":`sign-up-denied-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close sign up denied modal`,className:`modal-backdrop-button`,onClick:Pt,type:`button`}),(0,U.jsxs)(`section`,{className:`modal-card modal-card--success auth-modal-card auth-denied-card`,children:[(0,U.jsxs)(`div`,{className:`success-modal-body auth-denied-body`,children:[(0,U.jsx)(`div`,{className:`auth-denied-icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`error`})}),(0,U.jsx)(`h3`,{id:`sign-up-denied-title`,children:`Account Registration Not Approved`}),(0,U.jsx)(`p`,{children:`Sorry, you cannot proceed. Your School ID was not found in the official records. Please contact the IBACMI | Scholarship Office for assistance.`})]}),(0,U.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,U.jsx)(`button`,{className:`button`,onClick:Pt,type:`button`,children:`Back to Sign Up`})})]})]}),Oe&&(0,U.jsxs)(`div`,{"aria-labelledby":`sign-up-success-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Continue to student page`,className:`modal-backdrop-button`,onClick:vt,type:`button`}),(0,U.jsxs)(`section`,{className:`modal-card modal-card--success auth-modal-card`,children:[(0,U.jsxs)(`div`,{className:`success-modal-body`,children:[(0,U.jsx)(`div`,{className:`success-icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`check_circle`})}),(0,U.jsx)(`h3`,{id:`sign-up-success-title`,children:`Successfully Registered`}),(0,U.jsxs)(`p`,{children:[Oe,` You can now continue to the student information page.`]})]}),(0,U.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,U.jsx)(`button`,{className:`button`,onClick:vt,type:`button`,children:`Continue`})})]})]}),d&&(0,U.jsxs)(`div`,{"aria-labelledby":`forgot-password-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close forgot password modal`,className:`modal-backdrop-button`,onClick:It,type:`button`}),(0,U.jsxs)(`form`,{className:`modal-card modal-card--admin auth-modal-card auth-modal-card--large`,onSubmit:async e=>{e.preventDefault();let t=V(),n=Me.trim().toLowerCase(),r=Pe.trim(),i=yr(Ie),a=Re.trim(),o=Be,s=He;if(z(``),Ke(``),t){z(t);return}if(!qe){z(`Please request an OTP first.`);return}if(!a){z(`OTP is required.`);return}if(!/^\d{4,8}$/.test(a)){z(`OTP must be 4 to 8 digits.`);return}if(!o){z(`New password is required.`);return}if(!Dr(o)){z(`New password must be at least 6 characters.`);return}if(!s){z(`Confirm password is required.`);return}if(o!==s){z(`New password and confirm password do not match.`);return}Qe(!0);try{let e=await it({email:n||void 0,schoolId:r||void 0,phoneNumber:i,otp:a,newPassword:o});if(!e.success){z(e.message||`Unable to change password.`);return}Ke(e.message||`Password changed successfully.`),ze(``),Ve(``),Ue(``),Je(!1),fe(n),me(r),ge(``)}catch(e){z(e instanceof Error?e.message:`Unable to change password right now.`)}finally{Qe(!1)}},children:[(0,U.jsxs)(`div`,{className:`admin-login-hero auth-modal-hero`,children:[(0,U.jsx)(`div`,{className:`admin-login-brand`,children:(0,U.jsx)(`img`,{alt:`IBACMI`,src:`/IBACMI-Scholarship-Office/assets/IBACMI-DvrUkuyb.png`})}),(0,U.jsx)(`button`,{"aria-label":`Close forgot password`,className:`icon-button modal-close admin-login-close`,onClick:It,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})}),(0,U.jsx)(`p`,{className:`modal-kicker`,children:`Account Recovery`}),(0,U.jsx)(`h3`,{id:`forgot-password-title`,children:`Forgot Password`}),(0,U.jsx)(`p`,{children:`Verify your email or School ID with your registered phone number before changing your password.`})]}),(0,U.jsxs)(`div`,{className:`modal-body admin-login-body auth-form-grid`,children:[(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`Email address`}),(0,U.jsx)(`input`,{autoComplete:`email`,inputMode:`email`,name:`forgotEmail`,placeholder:`Enter valid email address`,required:!Pe.trim(),type:`email`,disabled:Pe.trim().length>0||Ye||Ze,value:Me,onChange:Ut})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`School ID`}),(0,U.jsx)(`input`,{autoComplete:`off`,name:`forgotSchoolId`,placeholder:`Enter School ID`,required:!0,type:`text`,minLength:4,maxLength:30,pattern:`[A-Za-z0-9-]{4,30}`,title:`School ID must be 4 to 30 characters and may only contain letters, numbers, and hyphens.`,required:!Me.trim(),disabled:Me.trim().length>0||Ye||Ze,value:Pe,onChange:Wt})]}),(0,U.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,U.jsx)(`span`,{children:`Phone number`}),(0,U.jsx)(`input`,{autoComplete:`tel`,inputMode:`tel`,name:`forgotPhoneNumber`,pattern:`\\+?[0-9]*`,placeholder:`09123456789 or +639123456789`,required:!0,type:`tel`,disabled:Ye||Ze,value:Ie,onChange:Gt})]}),(0,U.jsx)(`button`,{className:`button button--secondary auth-full-field`,disabled:Ye||Ze,onClick:async()=>{let e=V();if(z(``),Ke(``),e){z(e);return}let t=Me.trim().toLowerCase(),n=Pe.trim(),r=yr(Ie);Xe(!0);try{let e=await rt({email:t||void 0,schoolId:n||void 0,phoneNumber:r});if(!e.success){z(e.message||`Unable to send OTP.`);return}Je(!0),Ke(e.message||`OTP generated successfully. Enter it below to change your password.`)}catch(e){z(e instanceof Error?e.message:`Unable to request OTP right now.`)}finally{Xe(!1)}},type:`button`,children:Ye?`Sending OTP...`:qe?`Resend OTP`:`Send OTP`}),qe&&(0,U.jsxs)(U.Fragment,{children:[(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`OTP Code`}),(0,U.jsx)(`input`,{autoComplete:`one-time-code`,inputMode:`numeric`,name:`forgotOtp`,placeholder:`Enter OTP`,required:!0,type:`text`,maxLength:8,value:Re,onChange:e=>ze(e.target.value.replace(/\D/g,``))})]}),(0,U.jsxs)(`label`,{className:`form-field`,children:[(0,U.jsx)(`span`,{children:`New Password`}),(0,U.jsx)(`input`,{autoComplete:`new-password`,name:`forgotNewPassword`,placeholder:`Enter new password`,required:!0,type:`password`,minLength:6,value:Be,onChange:e=>Ve(e.target.value)})]}),(0,U.jsxs)(`label`,{className:`form-field auth-full-field`,children:[(0,U.jsx)(`span`,{children:`Confirm New Password`}),(0,U.jsx)(`input`,{autoComplete:`new-password`,name:`forgotConfirmPassword`,placeholder:`Confirm new password`,required:!0,type:`password`,minLength:6,value:He,onChange:e=>Ue(e.target.value)})]})]}),We&&(0,U.jsx)(`p`,{className:`form-error auth-full-field`,children:We}),Ge&&(0,U.jsx)(`p`,{className:`form-success auth-full-field`,children:Ge})]}),(0,U.jsxs)(`div`,{className:`modal-actions admin-login-actions auth-actions`,children:[(0,U.jsx)(`button`,{className:`button button--secondary`,disabled:Ye||Ze,onClick:It,type:`button`,children:`Cancel`}),(0,U.jsx)(`button`,{className:`button`,disabled:!qe||Ye||Ze,type:`submit`,children:Ze?`Changing Password...`:`Change Password`})]})]})]}),ee&&(0,U.jsxs)(`div`,{"aria-labelledby":`quick-action-success-title`,"aria-modal":`true`,className:`modal-overlay`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close success modal`,className:`modal-backdrop-button`,onClick:()=>T(``),type:`button`}),(0,U.jsxs)(`div`,{className:`modal-card modal-card--success`,children:[(0,U.jsxs)(`div`,{className:`success-modal-body`,children:[(0,U.jsx)(`div`,{className:`success-icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`check_circle`})}),(0,U.jsx)(`h3`,{id:`quick-action-success-title`,children:`Submitted Successfully`}),(0,U.jsxs)(`p`,{children:[ee,` The scholarship office can now review your request. Please always check your valid email. The TECH Scholarship Office will notify you when your account is updated.`]})]}),(0,U.jsx)(`div`,{className:`modal-actions modal-actions--single`,children:(0,U.jsx)(`button`,{className:`button`,onClick:()=>T(``),type:`button`,children:`Done`})})]})]}),(0,U.jsx)(`div`,{className:`scroll-progress`,style:{"--scroll-progress":r}})]})}var Fr=`
.auth-modal-card {
  width: min(100%, 520px);
...
`,Ir=`/IBACMI-Scholarship-Office/assets/samp-wIlKUzMl.jpg`,Lr=`modulepreload`,Rr=function(e){return`/IBACMI-Scholarship-Office/`+e},zr={},Br=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Rr(t,n),t in zr)return;zr[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:Lr,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Vr=`https://ideal-crane-292.convex.site`.replace(/\/+$/,``),Hr={tesAwardNo:``,studentId:``,batchNo:``,status:``,semester:``,schoolYear:``};function Ur(e){return[...new Set(e.filter(Boolean))]}function Wr(e){let t=String(e??``).match(/\d{4}/);return t?Number(t[0]):0}function Gr(){let e=new Date,t=e.getFullYear(),n=e.getMonth()>=5?t:t-1;return`${n}-${n+1}`}function Kr(e){return e.replace(/[\s-]/g,``).trim()}function qr(e){return e.replace(/[^\d+]/g,``).replace(/(?!^)\+/g,``)}function Jr(e){let t=Kr(e);return/^09\d{9}$/.test(t)||/^\+639\d{9}$/.test(t)}function Yr(e){let t=Gr();return e.find(e=>e.schoolYear===t)||[...e].sort((e,t)=>{let n=Wr(t.schoolYear)-Wr(e.schoolYear);return n===0?(t.uploadedAt??0)-(e.uploadedAt??0):n})[0]}function Xr({url:e}){let t=(0,H.useRef)(null),[n,r]=(0,H.useState)(0),[i,a]=(0,H.useState)(``),[o,s]=(0,H.useState)(0);return(0,H.useEffect)(()=>{let e=t.current;if(!e)return;let n=()=>r(Math.floor(e.clientWidth));if(n(),typeof ResizeObserver>`u`)return window.addEventListener(`resize`,n),()=>window.removeEventListener(`resize`,n);let i=new ResizeObserver(n);return i.observe(e),()=>i.disconnect()},[]),(0,H.useEffect)(()=>{let r=t.current;if(!r||!e||!n)return;let i=!1,o,s;return(async()=>{a(``),r.replaceChildren(),r.setAttribute(`aria-busy`,`true`);try{let[{getDocument:t,GlobalWorkerOptions:a},{default:c}]=await Promise.all([Br(()=>import(`./pdf-DRpiIDKK.js`),[]),Br(()=>import(`./pdf.worker.min-D7EoebCV.js`),[])]);if(i)return;a.workerSrc=c;let l=await fetch(e,{mode:`cors`});if(!l.ok)throw Error(`Unable to download PDF (${l.status}).`);let u=new Uint8Array(await l.arrayBuffer());if(i)return;if(!u.length)throw Error(`The uploaded PDF is empty.`);o=t({data:u,disableAutoFetch:!0,disableRange:!0,disableStream:!0});let d=await o.promise;for(let e=1;e<=d.numPages;e+=1){if(i)return;let t=await d.getPage(e),a=n/t.getViewport({scale:1}).width,o=t.getViewport({scale:a}),c=Math.min(window.devicePixelRatio||1,2),l=document.createElement(`canvas`);l.className=`student-id-preview__page`,l.setAttribute(`aria-label`,`Uploaded School ID page ${e}`),l.width=Math.floor(o.width*c),l.height=Math.floor(o.height*c),l.style.width=`${Math.floor(o.width)}px`,l.style.height=`${Math.floor(o.height)}px`,r.appendChild(l),s=t.render({canvas:l,transform:c===1?null:[c,0,0,c,0,0],viewport:o}),await s.promise}}catch(e){!i&&e?.name!==`RenderingCancelledException`&&(console.error(`Unable to render uploaded School ID PDF:`,e),r.replaceChildren(),a(`The PDF preview could not load.`))}finally{i||r.removeAttribute(`aria-busy`)}})(),()=>{i=!0,s?.cancel(),o?.destroy()}},[n,o,e]),(0,U.jsxs)(U.Fragment,{children:[(0,U.jsx)(`div`,{className:`student-id-preview__pages`,ref:t,children:(0,U.jsx)(`span`,{className:`student-id-preview__loading`,children:`Loading PDF preview...`})}),i&&(0,U.jsxs)(`div`,{className:`student-id-preview__error`,children:[(0,U.jsx)(`span`,{children:i}),(0,U.jsx)(`button`,{onClick:()=>s(e=>e+1),type:`button`,children:`Retry preview`})]})]})}function Zr({studentSession:e,onLogout:t,onStudentSessionUpdate:n}){let r=ln(kn.allinfo.list),i=un(kn.allinfo.saveStudentIdUploads),a=un(kn.adminAuth.updateStudentPhoneNumber),[o,s]=(0,H.useState)(null),[c,l]=(0,H.useState)(``),[u,d]=(0,H.useState)(``),[f,p]=(0,H.useState)(!1),m=(0,H.useRef)(null),[h,g]=(0,H.useState)(e?.phoneNumber??``),[_,v]=(0,H.useState)(``),[y,b]=(0,H.useState)(``),[x,S]=(0,H.useState)(!1),C=un(kn.adminAuth.updateStudentCurrentAddress),[w,ee]=(0,H.useState)(e?.currentAddress??``),[T,E]=(0,H.useState)(``),[D,te]=(0,H.useState)(``),[O,ne]=(0,H.useState)(!1),re=String(e?.schoolId??``).trim().toLowerCase(),k=e?.phoneNumber??``,A=Kr(h)!==Kr(k),j=e?.currentAddress??``,M=w.trim()!==j.trim(),N=(0,H.useMemo)(()=>!re||!r?null:Yr(r.filter(e=>String(e.studentId??``).trim().toLowerCase()===re))??null,[r,re]),P=N?{tesAwardNo:N.tesAwardNumber??``,studentId:N.studentId??``,lastName:N.lastName??``,firstName:N.firstName??``,middleInitial:N.middleInitial??``,batchNo:N.batchId??``,status:N.status??``,semester:N.semester??``,schoolYear:N.schoolYear??``}:Hr,F=r===void 0,I=!!re,L=!F&&I&&!N,ie=Ur([P.status,`Validated`,`Pending`,`Rejected`]),ae=Ur([P.semester,`1st Semester`,`2nd Semester`]),oe=Ur([P.schoolYear,`2023-2024`,`2024-2025`]),se=!!(N?.frontIdUrl||N?.frontIdStorageId),ce=N?.frontIdUrl??``;(0,H.useEffect)(()=>{if(!u)return;let e=e=>{e.key===`Escape`&&d(``)},t=document.body.style.overflow;return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),m.current?.focus(),()=>{document.body.style.overflow=t,window.removeEventListener(`keydown`,e)}},[u]);let le=()=>{typeof t==`function`&&t()},ue=e=>{g(qr(e.target.value)),v(``),b(``)},de=e=>{ee(e.target.value),E(``),te(``)},fe=async()=>{let t=Kr(h);if(v(``),b(``),!re){v(`Please sign in before updating your phone number.`);return}if(!t){v(`Phone number is required.`);return}if(!Jr(t)){v(`Please enter a valid phone number. Example: 09123456789 or +639123456789.`);return}if(!A){b(`Phone number is already up to date.`);return}S(!0);try{let r=await a({schoolId:e.schoolId,phoneNumber:t});if(!r.success){v(r.message||`Unable to update phone number.`);return}g(r.admin?.phoneNumber??t),b(r.message||`Phone number updated successfully.`),typeof n==`function`&&n(r.admin)}catch(e){v(e instanceof Error?e.message:`Unable to update phone number.`)}finally{S(!1)}},pe=async()=>{let t=w.trim();if(E(``),te(``),!re){E(`Please sign in before updating your current address.`);return}if(!t){E(`Current address is required.`);return}if(t.length<8){E(`Current address must be at least 8 characters.`);return}if(!M){te(`Current address is already up to date.`);return}ne(!0);try{let r=await C({schoolId:e.schoolId,currentAddress:t});if(!r.success){E(r.message||`Unable to update current address.`);return}ee(r.admin?.currentAddress??t),te(r.message||`Current address updated successfully.`),typeof n==`function`&&n(r.admin)}catch(e){E(e instanceof Error?e.message:`Unable to update current address.`)}finally{ne(!1)}},me=e=>t=>{let n=t.target.files?.[0]??null;if(l(``),d(``),n&&n.type!==`application/pdf`&&!/\.pdf$/i.test(n.name)){l(`Only PDF files are allowed.`),t.target.value=``,e(null);return}if(n&&n.size>5*1024*1024){l(`Each file must be 5MB or smaller.`),t.target.value=``,e(null);return}e(n)},he=async e=>{let t=[N.lastName,N.firstName,N.middleInitial].filter(Boolean).join(` `),n=new URLSearchParams({batchNo:N.batchId||`no-batch`,documentType:`School-ID`,fileName:e.name,fullName:t,studentId:N.studentId}),r;try{r=await fetch(`${Vr}/google-drive/student-upload?${n.toString()}`,{method:`POST`,headers:{"Content-Type":e.type||`application/pdf`},body:e})}catch{throw Error(`Unable to connect to the PDF upload service. Deploy the Convex HTTP functions and check VITE_CONVEX_URL or VITE_CONVEX_SITE_URL.`)}if(!r.ok){let t=await r.json().catch(()=>null);throw Error(t?.message||`Unable to upload ${e.name} to Google Drive.`)}let{fileUrl:i}=await r.json();if(!i)throw Error(`Google Drive did not return a file link for ${e.name}.`);return i};return(0,U.jsxs)(`div`,{className:`student-page`,children:[(0,U.jsxs)(`header`,{className:`student-topbar`,children:[(0,U.jsx)(`button`,{"aria-label":`Log out and return to landing page`,className:`student-icon-button`,onClick:le,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`arrow_back`})}),(0,U.jsx)(`h1`,{children:`Student Information`})]}),(0,U.jsxs)(`main`,{className:`student-main`,children:[(0,U.jsxs)(`section`,{className:`student-hero`,"aria-labelledby":`student-title`,children:[(0,U.jsx)(`div`,{className:`student-badge`,children:`Academic Year Update`}),(0,U.jsx)(`h2`,{id:`student-title`,children:`Unifast Portal`}),(0,U.jsx)(`p`,{children:`Please ensure all details match your official documents for successful validation.`})]}),!I&&(0,U.jsx)(`div`,{className:`student-state-box`,children:`Please sign in with a student account to view your grantee information.`}),F&&(0,U.jsx)(`div`,{className:`student-state-box`,children:`Loading your grantee information...`}),L&&(0,U.jsxs)(`div`,{className:`student-state-box student-state-box--warning`,children:[`No allinfo record was found for Student ID `,e?.schoolId,`.`]}),(0,U.jsxs)(`form`,{className:`student-form`,id:`student-information-form`,children:[(0,U.jsxs)(`div`,{className:`student-field`,children:[(0,U.jsx)(`label`,{htmlFor:`tes-award-no`,children:`TES Award No.`}),(0,U.jsx)(`input`,{id:`tes-award-no`,placeholder:`e.g. TES-2024-XXXX`,readOnly:!0,type:`text`,value:P.tesAwardNo})]}),(0,U.jsxs)(`div`,{className:`student-field`,children:[(0,U.jsx)(`label`,{htmlFor:`student-id`,children:`Student ID`}),(0,U.jsx)(`input`,{id:`student-id`,placeholder:`Enter your University ID`,readOnly:!0,type:`text`,value:P.studentId})]}),(0,U.jsxs)(`div`,{className:`student-field student-field--with-action`,children:[(0,U.jsx)(`label`,{htmlFor:`phone-number`,children:`Phone No.`}),(0,U.jsxs)(`div`,{className:`student-inline-control`,children:[(0,U.jsx)(`input`,{id:`phone-number`,inputMode:`tel`,pattern:`\\+?[0-9]*`,placeholder:`09123456789 or +639123456789`,type:`tel`,value:h,onChange:ue}),(0,U.jsx)(`button`,{className:`student-inline-button`,disabled:!I||!A||x,onClick:fe,type:`button`,children:x?`Saving...`:`Save`})]}),_&&(0,U.jsx)(`p`,{className:`student-upload-message student-upload-message--error`,children:_}),y&&(0,U.jsx)(`p`,{className:`student-upload-message student-upload-message--success`,children:y})]}),(0,U.jsxs)(`div`,{className:`student-field student-field--with-action student-field--full`,children:[(0,U.jsx)(`label`,{htmlFor:`current-address`,children:`Current Address`}),(0,U.jsx)(`textarea`,{id:`current-address`,placeholder:`Enter your current address`,rows:3,value:w,onChange:de}),(0,U.jsx)(`button`,{className:`student-inline-button student-inline-button--wide`,disabled:!I||!M||O,onClick:pe,type:`button`,children:O?`Saving Address...`:`Save Current Address`}),T&&(0,U.jsx)(`p`,{className:`student-upload-message student-upload-message--error`,children:T}),D&&(0,U.jsx)(`p`,{className:`student-upload-message student-upload-message--success`,children:D})]}),(0,U.jsxs)(`div`,{className:`student-field`,children:[(0,U.jsx)(`label`,{htmlFor:`last-name`,children:`Last Name`}),(0,U.jsx)(`input`,{id:`last-name`,placeholder:`Last Name`,readOnly:!0,type:`text`,value:P.lastName})]}),(0,U.jsxs)(`div`,{className:`student-field`,children:[(0,U.jsx)(`label`,{htmlFor:`first-name`,children:`First Name`}),(0,U.jsx)(`input`,{id:`first-name`,placeholder:`First Name`,readOnly:!0,type:`text`,value:P.firstName})]}),(0,U.jsxs)(`div`,{className:`student-field`,children:[(0,U.jsx)(`label`,{htmlFor:`middle-initial`,children:`MI.`}),(0,U.jsx)(`input`,{id:`middle-initial`,placeholder:`MI.`,readOnly:!0,type:`text`,value:P.middleInitial})]}),(0,U.jsxs)(`div`,{className:`student-field`,children:[(0,U.jsx)(`label`,{htmlFor:`batch-no`,children:`Batch No.`}),(0,U.jsx)(`input`,{id:`batch-no`,placeholder:`e.g. Batch 7`,readOnly:!0,type:`text`,value:P.batchNo})]}),(0,U.jsxs)(`div`,{className:`student-select-grid`,children:[(0,U.jsxs)(`div`,{className:`student-field`,children:[(0,U.jsx)(`label`,{htmlFor:`status`,children:`Status`}),(0,U.jsxs)(`div`,{className:`student-select-wrap`,children:[(0,U.jsxs)(`select`,{disabled:!0,id:`status`,value:P.status,children:[(0,U.jsx)(`option`,{disabled:!0,value:``,children:`Select Status`}),ie.map(e=>(0,U.jsx)(`option`,{children:e},e))]}),(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`expand_more`})]})]}),(0,U.jsxs)(`div`,{className:`student-field`,children:[(0,U.jsx)(`label`,{htmlFor:`semester`,children:`Semester`}),(0,U.jsxs)(`div`,{className:`student-select-wrap`,children:[(0,U.jsxs)(`select`,{disabled:!0,id:`semester`,value:P.semester,children:[(0,U.jsx)(`option`,{disabled:!0,value:``,children:`Select Semester`}),ae.map(e=>(0,U.jsx)(`option`,{children:e},e))]}),(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`expand_more`})]})]}),(0,U.jsxs)(`div`,{className:`student-field`,children:[(0,U.jsx)(`label`,{htmlFor:`school-year`,children:`School Year`}),(0,U.jsxs)(`div`,{className:`student-select-wrap`,children:[(0,U.jsxs)(`select`,{disabled:!0,id:`school-year`,value:P.schoolYear,children:[(0,U.jsx)(`option`,{disabled:!0,value:``,children:`Select School Year`}),oe.map(e=>(0,U.jsx)(`option`,{children:e},e))]}),(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`expand_more`})]})]})]}),(0,U.jsxs)(`section`,{className:`student-upload-section`,"aria-labelledby":`student-upload-title`,children:[(0,U.jsxs)(`div`,{className:`student-upload-copy`,children:[(0,U.jsx)(`h3`,{id:`student-upload-title`,children:`Upload colored copy of School ID with 3 signatures and Batch No.`}),(0,U.jsxs)(`p`,{children:[`Files will be saved to your `,P.schoolYear||`current`,` allinfo record. If you have records from other years, the portal automatically uses the current or latest School Year.`]})]}),(0,U.jsxs)(`aside`,{className:`student-sample-card`,"aria-label":`Sample School ID upload format`,children:[(0,U.jsxs)(`div`,{className:`student-sample-card__header`,children:[(0,U.jsxs)(`div`,{children:[(0,U.jsx)(`span`,{className:`student-sample-card__eyebrow`,children:`Sample Format`}),(0,U.jsx)(`h4`,{children:`Scan layout guide`})]}),(0,U.jsx)(`span`,{className:`student-sample-card__badge`,children:`Required`})]}),(0,U.jsxs)(`div`,{className:`student-sample-card__body`,children:[(0,U.jsx)(`a`,{className:`student-sample-card__image-link`,href:Ir,rel:`noreferrer`,target:`_blank`,title:`Open sample format`,children:(0,U.jsx)(`img`,{alt:`Sample scan format showing front and back School ID, three signatures, and Batch No.`,src:Ir})}),(0,U.jsxs)(`div`,{className:`student-sample-card__checklist`,children:[(0,U.jsx)(`p`,{children:`Before converting to PDF, make sure your scan includes:`}),(0,U.jsxs)(`ul`,{children:[(0,U.jsx)(`li`,{children:`Colored front and back copy of your School ID`}),(0,U.jsx)(`li`,{children:`Three clear signatures below the ID copies`}),(0,U.jsx)(`li`,{children:`Readable Batch No. written on the same page`})]}),(0,U.jsx)(`span`,{children:`Upload the final file as PDF only, maximum 5MB.`})]})]})]}),(0,U.jsxs)(`div`,{className:`student-upload-field`,children:[(0,U.jsx)(`span`,{className:`student-upload-label`,children:`Upload File`}),(0,U.jsxs)(`label`,{className:`student-upload-card${o||se?` student-upload-card--selected`:``}`,htmlFor:`file-front`,children:[(0,U.jsx)(`input`,{accept:`application/pdf,.pdf`,disabled:!N||f,id:`file-front`,type:`file`,onChange:me(s)}),(0,U.jsx)(`span`,{className:`student-upload-icon`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`id_card`})}),(0,U.jsx)(`span`,{className:`student-upload-title`,children:o?.name||(se?`File already uploaded`:`Tap to upload File`)}),(0,U.jsx)(`span`,{className:`student-upload-note`,children:`PDF only up to 5MB`})]})]}),ce&&(0,U.jsxs)(`div`,{className:`student-id-preview`,children:[(0,U.jsxs)(`div`,{className:`student-id-preview__header`,children:[(0,U.jsx)(`span`,{children:`Uploaded School ID`}),(0,U.jsx)(`a`,{href:ce,rel:`noreferrer`,target:`_blank`,children:`View full file`})]}),(0,U.jsx)(Xr,{url:ce}),(0,U.jsx)(`noscript`,{children:(0,U.jsxs)(`a`,{className:`student-id-preview__file`,href:ce,rel:`noreferrer`,target:`_blank`,children:[(0,U.jsx)(`span`,{className:`student-id-preview__file-icon`,"aria-hidden":`true`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`picture_as_pdf`})}),(0,U.jsx)(`span`,{children:`Open uploaded PDF`})]})})]}),c&&(0,U.jsx)(`p`,{className:`student-upload-message student-upload-message--error`,children:c}),(0,U.jsxs)(`button`,{className:`student-save-button`,disabled:!N||f,onClick:async()=>{if(l(``),d(``),!N){l(`No allinfo record is available for your Student ID.`);return}if(!o){l(`Choose a PDF file before saving.`);return}p(!0);try{let e=await he(o),t=await i({studentId:N.studentId,schoolYear:N.schoolYear,frontIdUrl:e});s(null),d(`ID file saved for School Year ${t.schoolYear||P.schoolYear}.`)}catch(e){l(e instanceof Error?e.message:`Unable to save uploaded files.`)}finally{p(!1)}},type:`button`,children:[(0,U.jsx)(`span`,{children:f?`Saving Uploads...`:`Save Uploaded ID`}),(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`check_circle`})]})]})]})]}),u?(0,U.jsxs)(`div`,{"aria-describedby":`student-upload-success-description`,"aria-labelledby":`student-upload-success-title`,"aria-modal":`true`,className:`student-success-modal`,role:`dialog`,children:[(0,U.jsx)(`button`,{"aria-label":`Close upload success message`,className:`student-success-modal__backdrop`,onClick:()=>d(``),type:`button`}),(0,U.jsxs)(`section`,{className:`student-success-modal__card`,children:[(0,U.jsx)(`button`,{"aria-label":`Close`,className:`student-success-modal__close`,onClick:()=>d(``),type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,"aria-hidden":`true`,children:`close`})}),(0,U.jsx)(`div`,{className:`student-success-modal__icon`,"aria-hidden":`true`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`check`})}),(0,U.jsx)(`span`,{className:`student-success-modal__eyebrow`,children:`Upload complete`}),(0,U.jsx)(`h2`,{id:`student-upload-success-title`,children:`Successfully submitted`}),(0,U.jsxs)(`p`,{id:`student-upload-success-description`,children:[u,` Your document is now available for review.`]}),(0,U.jsx)(`button`,{className:`student-success-modal__action`,onClick:()=>d(``),ref:m,type:`button`,children:`Done`})]})]}):null]})}var Qr=class extends H.Component{constructor(e){super(e),this.state={hasError:!1,error:null}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,t){console.error(`ErrorBoundary caught`,e,t)}render(){if(this.state.hasError){let e=this.state.error?.message||`An unexpected error occurred.`;return(0,U.jsx)(`div`,{style:{minHeight:`100vh`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:24,boxSizing:`border-box`,background:`#fbfaf8`,color:`#1c1b1b`,fontFamily:`'Hanken Grotesk', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif`},children:(0,U.jsxs)(`div`,{style:{maxWidth:720},children:[(0,U.jsx)(`h2`,{style:{marginTop:0},children:`Something went wrong`}),(0,U.jsx)(`p`,{style:{color:`#584237`,fontWeight:700},children:e}),(0,U.jsx)(`p`,{style:{color:`#584237`},children:'If the message mentions Convex functions (for example "Could not find public function"), make sure the Convex dev server is running (`npx convex dev`) or that `VITE_CONVEX_URL` points to a deployed Convex app.'}),(0,U.jsxs)(`div`,{style:{display:`flex`,gap:8,marginTop:18},children:[(0,U.jsx)(`button`,{type:`button`,onClick:()=>window.location.reload(),style:{background:`#ea580c`,color:`#fff`,border:0,padding:`10px 14px`,borderRadius:8,fontWeight:800,cursor:`pointer`},children:`Reload`}),(0,U.jsx)(`button`,{type:`button`,onClick:()=>alert("Run `npx convex dev` in the project root or set VITE_CONVEX_URL."),style:{background:`#fff`,color:`#1c1b1b`,border:`1px solid rgba(150,116,101,0.6)`,padding:`10px 14px`,borderRadius:8,fontWeight:700,cursor:`pointer`},children:`Help`})]})]})})}return this.props.children}},$r=`unifast.adminSession`,ei=`unifast.studentViewOpen`,ti=`unifast.studentSession`;function ni(){try{let e=window.localStorage.getItem($r);return e?JSON.parse(e):null}catch{return null}}function ri(){try{return window.localStorage.getItem(ei)===`true`}catch{return!1}}function ii(){try{let e=window.localStorage.getItem(ti);return e?JSON.parse(e):null}catch{return null}}function ai(){let e=(0,On.c)(21),[t,n]=(0,H.useState)(ni),[r,i]=(0,H.useState)(ii),[a,o]=(0,H.useState)(ri),s;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(s=()=>{n(null)},e[0]=s):s=e[0];let c=s,l;e[1]===Symbol.for(`react.memo_cache_sentinel`)?(l=()=>{i(null),o(!1)},e[1]=l):l=e[1];let u=l,d;e[2]===Symbol.for(`react.memo_cache_sentinel`)?(d=e=>{if(e?.role===`student`){n(null),i(e),o(!0);return}i(null),o(!1),n(e)},e[2]=d):d=e[2];let f=d,p;e[3]===Symbol.for(`react.memo_cache_sentinel`)?(p=e=>{n(null),i(e??null),o(!0)},e[3]=p):p=e[3];let m=p,h;e[4]===Symbol.for(`react.memo_cache_sentinel`)?(h=e=>{i(t=>({...t??{},...e??{}}))},e[4]=h):h=e[4];let g=h,_,v;e[5]===t?(_=e[6],v=e[7]):(_=()=>{if(!t)return;let e=window.location.href,n={...window.history.state??{},unifastAdminGuard:!0};window.history.pushState(n,``,e);let r=()=>{window.history.pushState(n,``,e)};return window.addEventListener(`popstate`,r),()=>window.removeEventListener(`popstate`,r)},v=[t],e[5]=t,e[6]=_,e[7]=v),(0,H.useEffect)(_,v);let y,b;e[8]===t?(y=e[9],b=e[10]):(y=()=>{try{if(t){window.localStorage.setItem($r,JSON.stringify(t)),window.localStorage.removeItem(ei),window.localStorage.removeItem(ti);return}window.localStorage.removeItem($r)}catch{}},b=[t],e[8]=t,e[9]=y,e[10]=b),(0,H.useEffect)(y,b);let x,S;if(e[11]!==a||e[12]!==r?(S=()=>{try{if(a){window.localStorage.setItem(ei,`true`),window.localStorage.removeItem($r),r&&window.localStorage.setItem(ti,JSON.stringify(r));return}window.localStorage.removeItem(ei),window.localStorage.removeItem(ti)}catch{}},x=[a,r],e[11]=a,e[12]=r,e[13]=x,e[14]=S):(x=e[13],S=e[14]),(0,H.useEffect)(S,x),t){let n;return e[15]===t?n=e[16]:(n=(0,U.jsx)(Qr,{children:(0,U.jsx)(dr,{adminSession:t,onLogout:c})}),e[15]=t,e[16]=n),n}if(a){let t=r?.schoolId??`student`,n;return e[17]!==r||e[18]!==t?(n=(0,U.jsx)(Qr,{children:(0,U.jsx)(Zr,{studentSession:r,onLogout:u,onStudentSessionUpdate:g},t)}),e[17]=r,e[18]=t,e[19]=n):n=e[19],n}let C;return e[20]===Symbol.for(`react.memo_cache_sentinel`)?(C=(0,U.jsx)(Qr,{children:(0,U.jsx)(Pr,{onAdminLoginSuccess:f,onStudentRegistrationSuccess:m})}),e[20]=C):C=e[20],C}var oi=`https://ideal-crane-292.convex.cloud`,si=(0,Cn.createRoot)(document.getElementById(`root`));{let e=new an(oi);si.render((0,U.jsx)(H.StrictMode,{children:(0,U.jsx)(cn,{client:e,children:(0,U.jsx)(ai,{})})}))}export{Br as t};